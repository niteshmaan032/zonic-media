...
export const STATE_CONTENT: Record<string, StateContent> = {
  georgia: {
    name: "Georgia",
    slug: "georgia",
    metaTitle: "Georgia Home Inspector Marketing | Atlanta & Statewide SEO",
    metaDescription:
  ...
  texas: {
    name: "Texas",
    slug: "texas",
    metaTitle: "Texas Home Inspector Marketing | Local SEO & Lead Generation",
    metaDescription:
  ...
  florida: {
    name: "Florida",
    slug: "florida",
    metaTitle: "Florida Home Inspector Marketing | Wind Mitigation & 4-Point SEO",
    metaDescription:
  ...
  "north-carolina": {
    ...
    slug: "north-carolina",
    metaTitle:
      "North Carolina Home Inspector Marketing | Charlotte, Raleigh & Triangle SEO",
    metaDescription:
