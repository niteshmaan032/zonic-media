...
import "@/app/style/servicetwo.css";
...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "/servicetwo" },
  openGraph: {
    title:
      "Digital Marketing Services | SEO, PPC & Web Design | Zonic Media",
    description:
        ...
        <div className="st2-hero-grid">
          ...
          <div className="st2-hero-left">
            ...
            <div className="st2-hero-ctas">
              ...
              <Link href="#st2-services" className="buttons st2-btn-ghost">
                Explore Services <BtnArrow />
              </Link>
            </div>
      ...
      <section className="st2-contact-section">
        <div className="st2-container">
          <div className="st2-contact-inner">
            ...
            <div className="st2-contact-form" id="servicetwo-contact-form">
              <LeadContactForm
