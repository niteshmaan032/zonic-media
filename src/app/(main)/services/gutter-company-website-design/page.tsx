...
const breadcrumbJsonLd = buildBreadcrumbJsonLd([
  ...
  { name: "Gutter Company Website Design", url: PAGE_PATH },
]);
...
const serviceJsonLd = {
  ...
  serviceType: "Gutter Company Website Design",
  url: `${SITE_URL}${PAGE_PATH}`,
  description:
    "Custom gutter company website design with instant quote request flows, seamless gutter and gutter guard landing pages, before-and-after galleries, and service-area pages built to book installs.",
  provider: {
    "@type": "Organization",
  ...
  hasOfferCatalog: {
    "@type": "OfferCatalog",
    name: "Gutter Company Website Design Services",
    itemListElement: [
      {
        "@type": "Offer",
        itemOffered: {
          "@type": "Service",
          name: "New Gutter Company Websites",
        },
      },
      {
        "@type": "Offer",
      ...
      },
      {
        ...
        itemOffered: {
          "@type": "Service",
          name: "Installation & Guard Landing Pages",
        },
      },
      {
        "@type": "Offer",
...
const gutterWebFaqJsonLd = {
  "@context": "https://schema.org",
  "@type": "FAQPage",
  url: `${SITE_URL}${PAGE_PATH}`,
  mainEntity: GutterWebFaqs.map((faq) => ({
    "@type": "Question",
    name: faq.question,
    acceptedAnswer: {
      "@type": "Answer",
...
const ServiceCards = [
  {
    ...
    title: "New Gutter Company Websites",
    desc: (
      <>
  ...
  },
  {
    ...
    title: "Gutter Website Redesigns",
  ...
  },
  {
    ...
    title: "Installation & Guard Landing Pages",
    desc: "Dedicated pages for seamless gutters, gutter guards, repairs, and cleaning — each built around one service and one action: request an estimate.",
  },
  {
    icon: <LuCalendarCheck2 aria-hidden="true" />,
    title: "Quote & Estimate Flows",
    desc: "Jobber, JobNimbus, or a clean estimate request flow routed to your office — homeowners request a quote in a few taps, day or night.",
  },
  {
    icon: <FiDollarSign aria-hidden="true" />,
    title: "Financing & Pricing Pages",
    desc: "Gutter guards and full replacements are real investments. Clear financing and price-range guidance answer objections before homeowners ever call.",
  },
  {
...
const BandStats = [
  ...
  { num: "6+", label: "Gutter services designed for" },
...
const GrowCards = [
  ...
  },
  {
    ...
    desc: "Most gutter jobs start in the map pack. We optimize your profile so that company is you.",
...
const formVariant = {
  formType: "gutter-company-website-design",
  headline: "Get Your Free Homepage Mockup",
  subcopy:
    "See what your gutter company's new website could look like before you spend a dollar — delivered within about a week.",
  namePlaceholder: "Paul Hansen",
  companyLabel: "Company name",
  companyPlaceholder: "SeamlessPro Gutters",
  cityPlaceholder: "Dover, DE",
  emailPlaceholder: "paul@seamlessprogutters.com",
  messagePlaceholder:
    "Tell us about your company, your current website, or the work you want more of — seamless gutters, guards, repairs...",
};
    ...
    <>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify(gutterWebFaqJsonLd),
        }}
      />

      <div className="hiw-page hiw-theme-gutter">
        <main>
          {/* 1. Hero */}
            ...
            <div className="hiw-container">
              <div className="hiw-hero-grid">
                <div className="hiw-hero-copy">
                  ...
                  <p className="hiw-hero-sub">
                    ...
                    lead system — instant quote flows, seamless gutter and guard
                    pages, before-and-after galleries, and design that books the
                    job. Our{" "}
              ...
              <div className="hiw-strip-inner">
                <div className="hiw-strip-cell hiw-strip-cell-main">
                  ...
                  <p>
                    <span>Planning a new gutter website?</span>
              ...
              <div className="hiw-about-grid">
                ...
                <div className="hiw-about-copy">
                  ...
                  <p className="hiw-lead">
                    ...
                    judged your company — on their phone, in about five seconds.
                    They scanned your reviews, looked for photos of your work, and
                    tried to figure out roughly what new gutters cost. If any of
                    that was slow, confusing, or missing, they tapped the next
                    company on the list.
                  </p>
                  <p className="hiw-lead">
                    Great gutter website design closes that gap: it answers the
                    three questions every homeowner has — can I trust your work,
                    what will this cost, and how do I start — and then makes
            ...
            <div className="hiw-band-grid">
              <div className="hiw-band-content">
                ...
                <p className="hiw-lead">
                  ...
                  downspouts, and cleaning — plus commercial work — we design
            ...
            <div className="hiw-container">
              <div className="hiw-sec-head-center">
                ...
                <p className="hiw-lead">
                  ...
                  a list of services, a contact form nobody fills out. We design
                  every site as a working system, where each page has one job —
                  moving a homeowner closer to a booked estimate.
                </p>
              </div>
              ...
              <div className="hiw-why-cards">
                ...
                <article className="hiw-why-card">
                  ...
                  <p>
                    ...
                    storm sends water pouring over the edge.
                  </p>
                </article>
                <article className="hiw-why-card">
                  <span className="hiw-why-card-icon">
          ...
          <section className="hiw-banner">
            <div className="hiw-banner-grid">
              ...
              <div className="hiw-banner-media">
                <ServiceSiteMockup
                  prefix="hiw"
                  brand="SeamlessPro Gutters"
                  url="seamlessprogutters.com"
                  headline="Seamless gutters, done right."
                  primaryCta="Get Free Estimate"
                  chips={["Seamless", "Guards", "Repairs"]}
            ...
            <div className="hiw-container">
              <div className="hiw-sec-head-center">
                ...
                <p className="hiw-lead">
                  ...
                  Zonic Media designs gutter websites for businesses in every
          ...
          <div className="hiw-container">
            <div className="hiw-footer-grid">
              <div className="hiw-footer-brand">
                ...
                <p>
                  Zonic Media is a digital growth agency helping gutter companies
                  turn website visitors into booked installs.
                </p>
