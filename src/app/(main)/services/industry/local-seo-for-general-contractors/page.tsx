/*
 * LOCAL SEO FOR GENERAL CONTRACTORS — built on the approved local SEO template
 ...
 * general-contractor / home-remodeler specific. Form leads submit as service
 * "Local SEO" (on the API whitelist).
 */
...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    title: "Local SEO for General Contractors That Wins Jobs | Zonic Media",
    description:
      "Local SEO for general contractors that wins the Google map pack — profile optimization, citations, reviews, and service-area pages that turn 'general contractor near me' searches into booked estimates.",
    url: PAGE_PATH,
    type: "website",
  },
};
...
const breadcrumbJsonLd = buildBreadcrumbJsonLd([
  ...
  { name: "Local SEO for General Contractors", url: PAGE_PATH },
]);
...
const serviceJsonLd = {
  ...
  "@type": "Service",
  name: "Local SEO for General Contractors",
  serviceType: "Local Search Engine Optimization for Construction & Remodeling Contractors",
  url: `${SITE_URL}${PAGE_PATH}`,
  description:
    "Local SEO for general contractors and home remodelers covering Google Business Profile optimization, citation building, review growth, on-page SEO, and service-area content — built to rank construction and remodeling businesses in the Google map pack and win more booked estimates.",
  provider: {
    "@type": "Organization",
  ...
  audience: {
    ...
    name: "General contractors, home remodelers, home addition and design-build contractors, construction companies",
  },
  hasOfferCatalog: {
    "@type": "OfferCatalog",
    name: "General Contractor Local SEO Services",
    itemListElement: [
      {
        "@type": "Offer",
        itemOffered: {
      ...
      },
      {
        ...
        itemOffered: {
          "@type": "Service",
          name: "Contractor Keyword & Competitor Research",
        },
      },
      {
        "@type": "Offer",
...
const ContractorSeoFaqs = [
  {
    question: "What's Included in Your Local SEO Services for General Contractors?",
    answer:
      "Every contractor campaign covers the full local ranking system: Google Business Profile optimization, citation building and cleanup, review growth, on-page SEO for your remodeling, additions, and service-area pages, local content, and a monthly report that shows rankings, calls, and booked estimates — not vanity metrics.",
  },
  {
    question: "How Long Does Contractor SEO Take to Show Results?",
    answer:
      "Most general contractors see measurable movement within 60 to 90 days — better map pack visibility, more profile actions, and more calls for searches like 'general contractor near me' and 'home remodeling contractor.' Competitive markets take longer to fully dominate, but the trajectory is visible from the first monthly report, and momentum compounds through every building season.",
  },
  {
    question: "How Much Does Local SEO for General Contractors Cost?",
    answer:
      "Pricing depends on how many locations or service areas you cover, how competitive your market is, and how aggressively you want to grow across remodels, additions, and new builds. After a free audit we quote a flat monthly price — no long-term contracts and no surprise line items.",
  },
  {
    question: "Do You Guarantee First-Page Google Rankings for Contractor Keywords?",
    answer:
      "Our track record speaks for itself — most contractor clients reach top-three map pack positions for their core keywords, and every campaign is built on the exact signals Google rewards. Because Google's results change daily, no agency can honestly promise a fixed position, so we guarantee what matters: full transparency. You see exactly where you rank, what improved, and what we did each month — and with no long-term contracts, we earn your business with results.",
  },
  {
    question: "Do General Contractors Really Need Google Business Profile Optimization?",
    answer:
      "Yes — it is the single biggest lever in contractor local SEO. Your Google Business Profile decides whether you show up in the local map pack when a homeowner searches for a remodeler or builder, and it drives your call volume, direction requests, and review visibility. We optimize every field, category, project photo, and post so Google trusts your profile and homeowners choose it.",
  },
  {
    question: "Can You Help Multi-Location or Service-Area Contractors?",
    answer:
      "Absolutely. We build local SEO systems for single-crew builders and multi-location construction brands alike — service-area targeting, individual location pages, and map visibility for every city and neighborhood you work in, all reported in one clear dashboard.",
  },
  {
...
const contractorSeoFaqJsonLd = {
  "@context": "https://schema.org",
  "@type": "FAQPage",
  url: `${SITE_URL}${PAGE_PATH}`,
  mainEntity: ContractorSeoFaqs.map((faq) => ({
    "@type": "Question",
    name: faq.question,
    acceptedAnswer: {
      "@type": "Answer",
...
const BannerChecks = [
  "Your contractor map pack growth plan",
...
const ServiceCards = [
  {
    ...
    desc: (
      <>
        ...
        field, contractor category, project photo, and post — the same system
        behind our{" "}
  ...
  },
  {
    ...
    title: "Contractor Keyword & Competitor Research",
    desc: "We map every search your customers actually type — general contractor near me, home remodeling contractor, home addition contractor, design-build — city by city, and build the exact strategy that wins those searches for you.",
  },
  {
    icon: <FiLink2 aria-hidden="true" />,
    title: "Citations & Listing Management",
    desc: "Consistent name, address, and phone across every directory that matters — including the construction and contractor listings Google checks. We fix the wrong ones, build the missing ones, and keep them synced.",
  },
  {
    icon: <FiStar aria-hidden="true" />,
    title: "Review Growth & Reputation",
    desc: "A steady stream of real reviews from real homeowners, with responses that show Google — and the next homeowner comparing contractors — that somebody is home and the workmanship is trusted.",
  },
  {
    ...
    desc: (
      <>
        Service and city pages built around real contractor searches, with
...
const ResultCards = [
  {
    ...
    industry: "Design-Build Firm",
    metric: "+212%",
    label: "Calls from Google Business Profile",
    desc: "From page-two invisibility to top-three map pack rankings for 'general contractor near me' across every service city within one building season.",
  },
  {
    icon: <RiSearchLine aria-hidden="true" />,
    industry: "Home Additions",
    metric: "Top 3",
    label: "Map pack for every core keyword",
    desc: "A profile rebuild, citation cleanup, and review growth took the company from #13 to the top three before peak remodeling season.",
  },
  {
    icon: <FiTrendingUp aria-hidden="true" />,
    industry: "Whole-Home Remodeler",
    metric: "3.2×",
    label: "More booked estimates from local search",
    desc: "Service-area and city pages turned seasonal remodel and addition demand into a steady, year-round project pipeline.",
  },
];
...
const RankRows = [
  { kw: "general contractor near me", pos: "#1", delta: "▲ 5" },
  { kw: "home addition contractor [city]", pos: "#2", delta: "▲ 7" },
  { kw: "home remodeling contractor", pos: "#1", delta: "▲ 4" },
  { kw: "construction company near me", pos: "#3", delta: "▲ 8" },
];
...
const CompareUs = [
  "Profile worked weekly — posts, project photos, Q&A, contractor categories",
  "Reporting tied to calls, direction requests, and booked estimates",
  "Hand-built citations and local links that compound",
  "A dedicated strategist who knows your construction market",
...
const WhyCards = [
  {
    ...
    desc: "We are not a generalist agency dabbling in maps. Local rankings, local calls, and booked estimates for general contractors and home-service businesses is the entire practice.",
  },
  {
    icon: <FiZap aria-hidden="true" />,
    title: "Fast, Compounding Execution",
    desc: "Foundation fixes ship in the first weeks, not the first quarter — so you are stronger heading into peak remodeling and addition demand. Every month of work stacks on the last.",
  },
  {
    icon: <MdOutlineVerifiedUser aria-hidden="true" />,
...
const GrowCards = [
  {
    ...
    icon: <MdOutlineVerifiedUser aria-hidden="true" />,
    title: "Google Business Profile Optimization",
    desc: "Most homeowners pick a contractor straight from the map pack. We optimize your profile so that contractor is you.",
  ...
  },
  {
    ...
    desc: "Ready to grow beyond local SEO? A conversion-first contractor website — fast, trustworthy, and built to turn visitors into booked estimates.",
  ...
  },
  {
    ...
    desc: "Pair organic rankings with paid coverage and own the whole results page during peak remodeling and addition demand.",
    cta: "See Google Ads",
  },
];
    ...
    <>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify(contractorSeoFaqJsonLd),
        }}
      />
            ...
            <div className="tseo-container">
              <div className="tseo-hero-grid">
                <div className="tseo-hero-copy">
                  <p className="tseo-eyebrow">Local SEO for General Contractors</p>
                  <h1 className="tseo-hero-h1">
                    Local SEO for General Contractors That{" "}
                  ...
                  <p className="tseo-hero-sub">
                    ...
                    service-area content — so when homeowners search
                    &ldquo;general contractor near me,&rdquo; they find you
                    first.
                  </p>
                ...
                <div className="tseo-hero-visual">
                  ...
                  <div className="tseo-hero-dash" aria-hidden="true">
                    <div className="tseo-dash-head">
                      <div className="tseo-dash-title">Contractor Local SEO Performance</div>
                    </div>
                        ...
                        <div className="tseo-dash-body">
                          <div className="tseo-dash-list">
                            <p className="tseo-dash-sub">
                              Map pack · &ldquo;general contractor near me&rdquo;
                            </p>
                            <div className="tseo-dash-li tseo-dash-li--you">
                              <FiMapPin />
                              <span>Your Contracting Company</span>
                              <em>#1</em>
                            </div>
                            <div className="tseo-dash-li">
                              <FiMapPin />
                              <span>Competitor Builders &amp; Remodeling</span>
                              <em>#2</em>
                            </div>
                            <div className="tseo-dash-li">
                              <FiMapPin />
                              <span>Competitor Construction</span>
                              <em>#3</em>
                            </div>
                      ...
                      <div className="tseo-ba-panel tseo-ba-panel--before">
                        <div className="tseo-dash-body">
                          <div className="tseo-dash-list">
                            ...
                            <div className="tseo-dash-li">
                              <FiMapPin />
                              <span>Competitor Home Builders</span>
                              <em>#3</em>
                            </div>
                  ...
                  <div className="tseo-hero-floats">
                    <div className="tseo-float-card">
                      ...
                      <p>
                        ...
                        &ldquo;general contractor near me&rdquo;
                      </p>
                    </div>
                    <div className="tseo-float-card">
              ...
              <div className="tseo-problem-grid">
                <div className="tseo-gbp-wrap" aria-hidden="true">
                  <div className="tseo-gbp">
                    ...
                    <p className="tseo-gbp-meta">
                      General contractor · <em>Open now</em> · Free project
                      estimates
                    </p>
                ...
                <div>
                  ...
                  <h2 className="tseo-h2">
                    Homeowners are Searching for a Contractor.{" "}
                    <span className="tseo-hl-text">
                      We Make Sure They Find You.
                    </span>
                  </h2>
                  <p className="tseo-lead">
                    When a homeowner is ready to build an addition, finish a
                    basement, or remodel a whole home, the first thing they do is
                    search &ldquo;general contractor near me&rdquo; and call one
                    of the top three companies on the map. That is an enormous,
                    high-intent growth channel sitting right in front of your
                    business — and it is exactly the channel we have spent years
                    mastering for contractors and remodelers.
                  </p>
                  <p className="tseo-lead">
                    ...
                    calls, booked estimates, and revenue that compounds project
                    after project.
                  </p>
            ...
            <div className="tseo-container">
              <div className="tseo-sec-head">
                <div>
                  ...
                  <h2 className="tseo-h2">
                    Everything Your Contractor Rankings Need, in One System
                  </h2>
                </div>
          ...
          <section className="tseo-band">
            <div className="tseo-band-grid">
              <div className="tseo-band-content">
                ...
                <h2 className="tseo-h2">
                  We Put Your Contracting Company in the Top Three — And Keep It
                  There
                </h2>
                <p className="tseo-lead">
                  ...
                  top spots for the construction and remodeling services and
                  cities that pay you best, then strengthening them month after
                  month.
                </p>
                <p className="tseo-lead">
                  We work the signals Google actually rewards: proximity,
                  relevance, and prominence. A fully built-out profile tells
                  Google exactly which remodeling and construction services you
                  offer, consistent citations confirm you are who you say you
                  are, and a steady flow of reviews and local content proves
                  homeowners love working with you. And if a listing ever gets
                  suspended, our{" "}
                  <Link
                ...
                <div className="tseo-mappack-list">
                  ...
                  <div className="tseo-mappack-row tseo-mappack-row--you">
                    ...
                    <span className="tseo-mappack-info">
                      <strong>Your Contracting Company</strong>
                      <span className="tseo-mappack-stars">
                        <FaStar />
                        4.9 (176) · General contractor ·{" "}
                  ...
                  <div className="tseo-mappack-row">
                    ...
                    <span className="tseo-mappack-info">
                      <strong>Competitor Builders &amp; Remodeling</strong>
                      <span className="tseo-mappack-stars">
                        <FaStar />
                        4.6 (98) · General contractor
                      </span>
                    </span>
                  </div>
                  <div className="tseo-mappack-row">
                    ...
                    <span className="tseo-mappack-info">
                      <strong>Competitor Construction Co.</strong>
                      <span className="tseo-mappack-stars">
                        <FaStar />
                        4.4 (61) · General contractor
                      </span>
                    </span>
                  </div>
                </div>
            ...
            <div className="tseo-container">
              ...
              <div className="tseo-bento">
                ...
                <article className="tseo-bento-card tseo-bento-card--s1">
                  ...
                  <h3>Free Contractor Visibility Audit</h3>
                  <p>
                    We audit your rankings, profile, citations, reviews, and
                    competitors — and show you exactly where the remodel and
                    addition calls you are missing are going instead.
                  </p>
                  <div className="tseo-bento-visual" aria-hidden="true">
                    <p className="tseo-bento-visual-title">
                      Where contractor clients typically land after 90 days
                    </p>
                    {[
                ...
                <article className="tseo-bento-card tseo-bento-card--s3">
                  ...
                  <p>
                    ...
                    keep you there through every building season.
                  </p>
                ...
                <article className="tseo-bento-card tseo-bento-card--s4">
                  <div className="tseo-bento-s4-copy">
                    ...
                    <p>
                      ...
                      contracting services and more cities.
                    </p>
                  </div>
          ...
          <section className="tseo-results">
            <div className="tseo-container">
              <div className="tseo-sec-head-center">
                ...
                <h2 className="tseo-h2">
                  What Happens When Contractor Local SEO is Done Properly
                </h2>
                <p className="tseo-lead">
          ...
          <section className="tseo-compare">
            <div className="tseo-container">
              <div className="tseo-sec-head-center">
                ...
                <h2 className="tseo-h2">
                  What You Get with Zonic Vs. A Typical Contractor SEO Agency
                </h2>
                <p className="tseo-lead">
              ...
              <div className="tseo-compare-grid">
                <div className="tseo-compare-col tseo-compare-col--them">
                  ...
                  <p className="tseo-compare-sub">
                    Why most contractor campaigns quietly stall
                  </p>
                  <ul>
                ...
                <div className="tseo-compare-col tseo-compare-col--us">
                  <h3>Contractor Local SEO with Zonic Media</h3>
                  <p className="tseo-compare-sub">
                ...
                >
                  ...
                  <p className="tseo-compare-sub">
                    A typical contractor client&apos;s first six months
                  </p>
          ...
          <section className="tseo-why">
            <div className="tseo-container">
              <div className="tseo-sec-head-center">
                ...
                <h2 className="tseo-h2">
                  A Contractor Local SEO Partner, Not a Monthly Invoice
                </h2>
                <p className="tseo-lead">
              ...
              <div className="tseo-why-banner">
                <div className="tseo-why-banner-text">
                  <p className="tseo-eyebrow">Free Contractor SEO Audit</p>
                  <h3>See Exactly How We&apos;ll Grow Your Contractor Rankings</h3>
                  <p>
                    We&apos;ll map your profile, citations, reviews, and
                    rankings — and show you the clear path to the top three for
                    the contractor searches in your market. Free, and yours to
                    keep either way.
                  </p>
                ...
                <div className="tseo-audit-card" aria-hidden="true">
                  ...
                  <div className="tseo-audit-ring-wrap">
                    ...
                    <div className="tseo-audit-ring-info">
                      ...
                      <small>
                        Where our contractor campaigns typically land after six
          ...
          <section className="tseo-nationwide">
            <div className="tseo-container">
              <div className="tseo-sec-head-center">
                ...
                <h2 className="tseo-h2">
                  Local SEO for General Contractors in Every Market in the US
                </h2>
                <p className="tseo-lead">
                  From single-crew builders to multi-location construction
          ...
          <section className="tseo-faqs" id="tseo-faqs">
            <div className="tseo-container">
              <div className="tseo-split-grid">
                ...
                <div>
                  <GmbFaqs items={ContractorSeoFaqs} />
                </div>
              </div>
            </div>
          </section>
            ...
            <div className="tseo-container">
              <div className="tseo-form-grid">
                <aside className="tseo-form-aside">
                  ...
                  <h2 className="tseo-h2">
                    Claim Your Free Contractor Local SEO Audit
                  </h2>
                  <p className="tseo-lead">
                    Tell us about your contracting business and we will send a
                ...
                <div className="tseo-form-main">
                  <ServiceLeadForm
                    formType="local-seo"
                    badge="Free Audit"
                    title="Get Your Free Contractor SEO Audit"
                    subtitle="No contracts, no pressure — just a clear picture of where your contracting company stands and what it takes to win your market."
                    submitText="Send My Free Audit"
                    messageLabel="Tell us about your contracting business"
      ...
      <RelatedServices current="/services/industry/local-seo-for-general-contractors" />
      <Footer />
    </>
  );
}
