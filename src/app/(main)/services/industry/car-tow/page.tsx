...
export default function CarTowPage() {
    ...
    <main className="car-tow-page">
            ...
            <Row>
              <Col lg={9} className="car-tow-hero-copy">
                ...
                <div className="car-tow-hero-actions">
                  <a href="#car-tow-final-cta" className="buttons">
      ...
      <section className="car-tow-section">
        <div className="car-tow-container">
          ...
          <div className="car-tow-faq">
            {faqs.map((faq, index) => {
              const isOpen = openFaq === index;

              return (
                <article
                  className={`car-tow-faq-item ${isOpen ? "is-open" : ""}`}
                  key={faq.question}
                >
                  <button
                    type="button"
                    className="car-tow-faq-button"
                    onClick={() => setOpenFaq(isOpen ? -1 : index)}
                    aria-expanded={isOpen}
                    aria-controls={`car-tow-faq-panel-${index}`}
                  >
                    <span>{faq.question}</span>
                    <FaArrowRight />
                  </button>
                  <div
                    id={`car-tow-faq-panel-${index}`}
                    className="car-tow-faq-panel"
                  >
                    <div className="car-tow-faq-panel-inner">
                      <p>{faq.answer}</p>
                    </div>
                  </div>
                </article>
        ...
        <div className="car-tow-container">
          <div className="car-tow-final-cta">
            ...
            <div className="car-tow-hero-actions car-tow-final-actions">
              <a href="tel:+13027269736" className="buttons">
                Get Free Towing SEO Audit
                <ArrowIcon />
              </a>
              <a
                href="mailto:contact@zonicllc.com"
                className="buttons car-tow-button-secondary"
              >
