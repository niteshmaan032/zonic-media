...
function Page() {
  return (
    <>
                ...
                <div className="tseo-hero-visual">
                  ...
                  <div className="tseo-hero-dash" aria-hidden="true">
                    <div className="tseo-dash-head">
                      <div className="tseo-dash-title">Commercial Cleaning Local SEO Performance</div>
                    </div>
      ...
      <RelatedServices current="/services/industry/local-seo-for-commercial-cleaning" />
      <Footer />
    </>
  );
}
