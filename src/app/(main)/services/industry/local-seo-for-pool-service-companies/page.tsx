/*
 * LOCAL SEO FOR POOL SERVICE COMPANIES — built on the approved local SEO
 ...
 * schema are pool-service-specific. Form leads submit as service "Local SEO"
...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    title: "Local SEO for Pool Service Companies | Zonic Media",
    description:
      "Local SEO for pool service companies that wins the Google map pack — profile optimization, citations, reviews, and service-area pages that turn 'pool service near me' searches into booked clients.",
    url: PAGE_PATH,
    type: "website",
  },
};
...
const breadcrumbJsonLd = buildBreadcrumbJsonLd([
  ...
  { name: "Local SEO for Pool Service Companies", url: PAGE_PATH },
]);
...
const serviceJsonLd = {
  ...
  "@type": "Service",
  name: "Local SEO for Pool Service Companies",
  serviceType: "Local Search Engine Optimization for Pool Service Companies",
  url: `${SITE_URL}${PAGE_PATH}`,
  description:
    "Local SEO for pool service companies covering Google Business Profile optimization, citation building, review growth, on-page SEO, and service-area content — built to rank pool cleaning, repair, and maintenance businesses in the Google map pack and grow booked, recurring clients.",
  provider: {
    "@type": "Organization",
  ...
  audience: {
    ...
    name: "Pool service companies, pool cleaning businesses, pool maintenance and repair contractors",
  },
  hasOfferCatalog: {
    "@type": "OfferCatalog",
    name: "Pool Service Local SEO Services",
    itemListElement: [
      {
        "@type": "Offer",
        itemOffered: {
          "@type": "Service",
          name: "Google Business Profile Optimization for Pool Service",
        },
      },
      {
        "@type": "Offer",
        itemOffered: {
          "@type": "Service",
          name: "Pool Service Keyword & Competitor Research",
        },
      },
      {
        "@type": "Offer",
...
const PoolSeoFaqs = [
  {
    question: "What's Included in Your Pool Service Local SEO?",
    answer:
      "Every pool service campaign covers the full local ranking system: Google Business Profile optimization, citation building and cleanup, review growth, on-page SEO for your pool cleaning, repair, and maintenance pages, local content, and a monthly report that shows rankings, calls, and booked clients — not vanity metrics.",
  },
  {
    question: "How Long Does Pool Service SEO Take to Show Results?",
    answer:
      "Most pool service companies see measurable movement within 60 to 90 days — better map pack visibility, more profile actions, and more calls for searches like 'pool service near me' and 'pool cleaning near me.' Competitive markets take longer to fully dominate, but the trajectory is visible from the first monthly report, and momentum compounds ahead of every pool season.",
  },
  {
    question: "How Much Does Local SEO for Pool Service Companies Cost?",
    answer:
      "Pricing depends on how many areas you serve, how competitive your market is, and how aggressively you want to grow across the pool season. After a free audit we quote a flat monthly price — no long-term contracts and no surprise line items.",
  },
  {
    question: "Do You Guarantee First-Page Google Rankings for Pool Keywords?",
    answer:
      "Our track record speaks for itself — most pool service clients reach top-three map pack positions for their core keywords, and every campaign is built on the exact signals Google rewards. Because Google's results change daily, no agency can honestly promise a fixed position, so we guarantee what matters: full transparency. You see exactly where you rank, what improved, and what we did each month — and with no long-term contracts, we earn your business with results.",
  },
  {
    question: "Do Pool Service Companies Really Need Google Business Profile Optimization?",
    answer:
      "Yes — it is the single biggest lever in pool service local SEO. Your Google Business Profile decides whether you show up in the local map pack when a homeowner searches for pool cleaning or repair, and it drives your call volume, direction requests, and review visibility. We optimize every field, category, photo, and post so Google trusts your profile and customers choose it.",
  },
  {
    question: "Can You Help Seasonal, Multi-Location, or Service-Area Pool Companies?",
    answer:
      "Absolutely. We build local SEO systems for single-truck operators and multi-location pool brands alike — service-area targeting, individual location pages, and map visibility for every city and neighborhood you cover, all reported in one clear dashboard. We also plan around your season so you peak right when demand does.",
  },
  {
...
const poolSeoFaqJsonLd = {
  "@context": "https://schema.org",
  "@type": "FAQPage",
  url: `${SITE_URL}${PAGE_PATH}`,
  mainEntity: PoolSeoFaqs.map((faq) => ({
    "@type": "Question",
    name: faq.question,
    acceptedAnswer: {
      "@type": "Answer",
...
const BannerChecks = [
  "Your pool service map pack growth plan",
...
const ServiceCards = [
  {
    ...
    desc: (
      <>
        ...
        field, pool service category, photo, and post — the same system behind
        our{" "}
  ...
  },
  {
    ...
    title: "Pool Service Keyword & Competitor Research",
    desc: "We map every search your customers actually type — pool cleaning, pool repair, pool maintenance, green pool recovery, leak detection — city by city, and build the exact strategy that wins those searches for you.",
  },
  {
    icon: <FiLink2 aria-hidden="true" />,
    title: "Citations & Listing Management",
    desc: "Consistent name, address, and phone across every directory that matters — including the pool service and contractor listings Google checks. We fix the wrong ones, build the missing ones, and keep them synced.",
  },
  {
    icon: <FiStar aria-hidden="true" />,
    title: "Review Growth & Reputation",
    desc: "A steady stream of real reviews from real homeowners, with responses that show Google — and the next customer comparing pool companies — that somebody is home.",
  },
  {
    ...
    desc: (
      <>
        Service and city pages built around real pool service searches, with
  ...
  },
  {
    ...
    desc: "Rankings, calls, direction requests, and booked-client leads in one plain-English report. You always know what we did, what moved, and what is next.",
  },
];
...
const ResultCards = [
  {
    ...
    industry: "Pool Cleaning Co.",
    metric: "+212%",
    label: "Calls from Google Business Profile",
    desc: "From page-two invisibility to top-three map pack rankings for 'pool service near me' across every service city within one pool season.",
  },
  {
    icon: <RiSearchLine aria-hidden="true" />,
    industry: "Pool Repair & Equipment",
    metric: "Top 3",
    label: "Map pack for every core keyword",
    desc: "A profile rebuild, citation cleanup, and review growth took the company from #11 to the top three before peak swim season.",
  },
  {
    icon: <FiTrendingUp aria-hidden="true" />,
    industry: "Commercial Pool Service",
    metric: "3.2×",
    label: "More booked, recurring clients from local search",
    desc: "Service-area and city pages turned seasonal cleaning spikes into a steady, year-round recurring-maintenance pipeline.",
  },
];
...
const RankRows = [
  { kw: "pool service near me", pos: "#1", delta: "▲ 5" },
  { kw: "pool cleaning [city]", pos: "#2", delta: "▲ 7" },
  { kw: "pool repair near me", pos: "#1", delta: "▲ 4" },
  { kw: "pool maintenance near me", pos: "#3", delta: "▲ 8" },
];
...
const CompareUs = [
  "Profile worked weekly — posts, photos, Q&A, pool service categories",
  "Reporting tied to calls, direction requests, and booked clients",
  "Hand-built citations and local links that compound",
  "A dedicated strategist who knows your pool service market",
...
const WhyCards = [
  {
    ...
    desc: "We are not a generalist agency dabbling in maps. Local rankings, local calls, and booked clients for pool service and home-service contractors is the entire practice.",
  },
  {
    icon: <FiZap aria-hidden="true" />,
    title: "Fast, Compounding Execution",
    desc: "Foundation fixes ship in the first weeks, not the first quarter — so you are stronger heading into peak pool demand. Every month of work stacks on the last.",
  },
  {
    icon: <MdOutlineVerifiedUser aria-hidden="true" />,
...
const MarqueeItems = [
  "Pool Service Local SEO",
  "Pool Cleaning Rankings",
...
const GrowCards = [
  {
    ...
    icon: <MdOutlineVerifiedUser aria-hidden="true" />,
    title: "Google Business Profile Optimization",
    desc: "Most homeowners pick a pool service company straight from the map pack. We optimize your profile so that company is you.",
  ...
  },
  {
    ...
    desc: "Ready to grow beyond local SEO? Conversion-first pool service websites built to turn visitors into booked, recurring clients.",
  ...
  },
  {
    ...
    desc: "Pair organic rankings with paid coverage and own the whole results page during peak pool season.",
    cta: "See Google Ads",
  },
];
    ...
    <>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify(poolSeoFaqJsonLd),
        }}
      />
              ...
              <div className="tseo-hero-grid">
                <div className="tseo-hero-copy">
                  ...
                  <h1 className="tseo-hero-h1">
                    Local SEO for Pool Service That{" "}
                    <span className="tseo-hl">Wins Clients</span>
                  </h1>
                  <p className="tseo-hero-sub">
                    Zonic Media provides local SEO for pool service companies:
                    Google Business Profile optimization, citations, reviews,
                    and service-area pages that put you in the map pack for
                    &ldquo;pool service near me&rdquo; and &ldquo;pool cleaning
                    near me.&rdquo; As of September 2026 we have moved 50+ local
                    and home-service businesses into <Link href="/services/local-seo-for-home-services" className="tseo-inline-link">the Google map pack</Link> and
                    optimized 1,500+ Google Business Profiles — so when
                    homeowners search, they find you first.
                  </p>
                  ...
                  <div className="tseo-hero-ctas">
                    <HashScrollLink
                      ...
                      offset={120}
                    >
                      Get Your Free Pool Service SEO Audit
                ...
                <div className="tseo-hero-visual">
                  ...
                  <div className="tseo-hero-dash" aria-hidden="true">
                    <div className="tseo-dash-head">
                      <div className="tseo-dash-title">Pool Service Local SEO Performance</div>
                    </div>
                        ...
                        <div className="tseo-dash-body">
                          <div className="tseo-dash-list">
                            <p className="tseo-dash-sub">
                              Map pack · &ldquo;pool service near me&rdquo;
                            </p>
                            <div className="tseo-dash-li tseo-dash-li--you">
                              <FiMapPin />
                              <span>Your Pool Service Company</span>
                              <em>#1</em>
                            </div>
                            <div className="tseo-dash-li">
                              <FiMapPin />
                              <span>Competitor Pool &amp; Spa</span>
                              <em>#2</em>
                            </div>
                            <div className="tseo-dash-li">
                              <FiMapPin />
                              <span>Competitor Pool Care</span>
                              <em>#3</em>
                            </div>
                  ...
                  <div className="tseo-hero-floats">
                    <div className="tseo-float-card">
                      ...
                      <p>
                        ...
                        &ldquo;pool service near me&rdquo;
                      </p>
                    </div>
                    <div className="tseo-float-card">
              ...
              <div className="tseo-problem-grid">
                <div className="tseo-gbp-wrap" aria-hidden="true">
                  <div className="tseo-gbp">
                    ...
                    <p className="tseo-gbp-meta">
                      Pool service · <em>Open now</em> · Free pool quotes
                    </p>
                ...
                <div>
                  ...
                  <h2 className="tseo-h2">
                    Homeowners are Searching for Pool Help.{" "}
                    <span className="tseo-hl-text">
                      We Make Sure They Find You.
                    </span>
                  </h2>
                  <p className="tseo-lead">
                    When a pool turns green or a pump fails in the middle of
                    summer, the first thing homeowners do is search &ldquo;pool
                    cleaning near me&rdquo; and call one of the top three
                    companies on the map. That is an enormous, high-intent growth
                    channel sitting right in front of your business — and it is
                    exactly the channel we have spent years mastering for pool
                    service companies.
                  </p>
                  <p className="tseo-lead">
                    ...
                    calls, booked jobs, and recurring maintenance revenue that
            ...
            <div className="tseo-container">
              <div className="tseo-sec-head">
                <div>
                  ...
                  <h2 className="tseo-h2">
                    Everything Your Pool Service Rankings Need, in One System
                  </h2>
                </div>
          ...
          <section className="tseo-band">
            <div className="tseo-band-grid">
              <div className="tseo-band-content">
                ...
                <h2 className="tseo-h2">
                  We Put Your Pool Service Company in the Top Three — And Keep It
                  There
                </h2>
                <p className="tseo-lead">
                  ...
                  top spots for the pool services and cities that pay you best,
                ...
                <p className="tseo-lead">
                  ...
                  Google exactly which pool cleaning, repair, and maintenance
                  services you offer, consistent citations confirm you are who
                  you say you are, and a steady flow of reviews and local content
                  proves homeowners love working with you. And if a listing ever
                  gets suspended, our{" "}
                  <Link
                ...
                <div className="tseo-mappack-list">
                  ...
                  <div className="tseo-mappack-row tseo-mappack-row--you">
                    ...
                    <span className="tseo-mappack-info">
                      <strong>Your Pool Service Company</strong>
                      <span className="tseo-mappack-stars">
                        <FaStar />
                        4.9 (187) · Pool service ·{" "}
                  ...
                  <div className="tseo-mappack-row">
                    ...
                    <span className="tseo-mappack-info">
                      <strong>Competitor Pool &amp; Spa</strong>
                      <span className="tseo-mappack-stars">
                        <FaStar />
                        4.6 (98) · Pool service
                      </span>
                  ...
                  <div className="tseo-mappack-row">
                    ...
                    <span className="tseo-mappack-info">
                      <strong>Competitor Pool Care Co.</strong>
                      <span className="tseo-mappack-stars">
                        <FaStar />
                        4.4 (61) · Pool service
                      </span>
            ...
            <div className="tseo-container">
              ...
              <div className="tseo-bento">
                ...
                <article className="tseo-bento-card tseo-bento-card--s1">
                  ...
                  <h3>Free Pool Service Visibility Audit</h3>
                  <p>
                    We audit your rankings, profile, citations, reviews, and
                    competitors — and show you exactly where the pool cleaning
                    and repair calls you are missing are going instead.
                  </p>
                  <div className="tseo-bento-visual" aria-hidden="true">
                    <p className="tseo-bento-visual-title">
                      Where pool service clients typically land after 90 days
                    </p>
                    {[
                ...
                <article className="tseo-bento-card tseo-bento-card--s2">
                  ...
                  <p>
                    A keyword-mapped plan for your pool services and cities, then
                    the foundation work: <Link href="/services/gmb-verification-help" className="tseo-inline-link">Google Business Profile verification help</Link> when a listing is unverified, profile optimization, citation cleanup,
                    and on-page fixes.
                  </p>
                </article>
                ...
                <article className="tseo-bento-card tseo-bento-card--s4">
                  <div className="tseo-bento-s4-copy">
                    ...
                    <p>
                      Monthly reporting tied to calls and booked clients, not
                      vanity metrics. As rankings lock in, we expand to more pool
          ...
          <section className="tseo-results">
            <div className="tseo-container">
              <div className="tseo-sec-head-center">
                ...
                <h2 className="tseo-h2">
                  What Happens When Pool Service Local SEO is Done Properly
                </h2>
                <p className="tseo-lead">
                  Different markets, different seasons — the same system,
                  executed month after month, often paired with a <Link href="/services/pool-service-website-design" className="tseo-inline-link">pool service website design</Link> that turns the extra traffic into booked service visits.
                </p>
              </div>
          ...
          <section className="tseo-compare">
            <div className="tseo-container">
              <div className="tseo-sec-head-center">
                ...
                <h2 className="tseo-h2">
                  What You Get with Zonic Vs. A Typical Pool Service SEO Agency
                </h2>
                <p className="tseo-lead">
                  Local SEO for home-service businesses is all we do, and it
                  shows. Here is exactly what working with a dedicated <Link href="/services/pool-service-marketing-agency" className="tseo-inline-link">pool service marketing agency</Link>
                  looks like.
                </p>
              </div>
              <div className="tseo-compare-grid">
                <div className="tseo-compare-col tseo-compare-col--them">
                  ...
                  <p className="tseo-compare-sub">
                    Why most pool service campaigns quietly stall
                  </p>
                  <ul>
                ...
                <div className="tseo-compare-col tseo-compare-col--us">
                  <h3>Pool Service Local SEO with Zonic Media</h3>
                  <p className="tseo-compare-sub">
                ...
                >
                  ...
                  <p className="tseo-compare-sub">
                    A typical pool service client&apos;s first six months
                  </p>
            ...
            <div className="tseo-container">
              <div className="tseo-tracking-grid">
                <div>
                  ...
                  <h2 className="tseo-h2">
                    Watch Your Pool Service Rankings and Reviews Climb,{" "}
                    <span className="tseo-hl-text">Month over Month</span>
                  </h2>
                  <p className="tseo-lead">
                    No black box. Every campaign comes with live rank tracking
                    for the pool service keywords that pay you, review growth
          ...
          <section className="tseo-why">
            <div className="tseo-container">
              <div className="tseo-sec-head-center">
                ...
                <h2 className="tseo-h2">
                  A Pool Service Local SEO Partner, Not a Monthly Invoice
                </h2>
                <p className="tseo-lead">
              ...
              <div className="tseo-why-banner">
                <div className="tseo-why-banner-text">
                  <p className="tseo-eyebrow">Free Pool Service SEO Audit</p>
                  <h3>
                    See Exactly How We&apos;ll Grow Your Pool Service Rankings
                  </h3>
                  <p>
                    We&apos;ll map your profile, citations, reviews, and
                    rankings — and show you the clear path to the top three for
                    the pool service searches in your market. Free, and yours to
                    keep either way.
                  </p>
                ...
                <div className="tseo-audit-card" aria-hidden="true">
                  ...
                  <div className="tseo-audit-ring-wrap">
                    ...
                    <div className="tseo-audit-ring-info">
                      ...
                      <small>
                        Where our pool service campaigns typically land after
                        six months of compounding local SEO work
                      </small>
                    </div>
                  </div>
                  {AuditRows.map((row) => (
          ...
          <section className="tseo-nationwide">
            <div className="tseo-container">
              <div className="tseo-sec-head-center">
                ...
                <h2 className="tseo-h2">
                  Local SEO for Pool Service Companies in Every Market in the US
                </h2>
                <p className="tseo-lead">
                  From single-truck operators to multi-location pool brands, we
            ...
            <div className="tseo-container">
              <div className="tseo-split-grid">
                <div>
                  ...
                  <h2 className="tseo-h2">
                    Straight Answers About Pool Service Local SEO
                  </h2>
                  <p className="tseo-lead">
                    Pricing, timelines, guarantees, how SEO stacks up against <Link href="/services/google-ads" className="tseo-inline-link">Google Ads for pool companies</Link>, and what actually moves pool
                    service rankings. If your question is not here, send it
            ...
            <div className="tseo-container">
              <div className="tseo-form-grid">
                <aside className="tseo-form-aside">
                  ...
                  <h2 className="tseo-h2">
                    Claim Your Free Pool Service Local SEO Audit
                  </h2>
                  <p className="tseo-lead">
                    Tell us about your pool service business and we will send a
                ...
                <div className="tseo-form-main">
                  <ServiceLeadForm
                    formType="local-seo"
                    badge="Free Audit"
                    title="Get Your Free Pool Service SEO Audit"
                    subtitle="No contracts, no pressure — just a clear picture of where your pool service company stands and what it takes to win your market."
                    submitText="Send My Free Audit"
                    messageLabel="Tell us about your pool service business"
      ...
      <RelatedServices current="/services/industry/local-seo-for-pool-service-companies" />
      <Footer />
    </>
  );
}
