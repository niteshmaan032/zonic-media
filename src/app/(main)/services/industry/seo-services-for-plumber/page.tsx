  ...
  return (
    <>
      ...
      <div className="iaf-section">
        <InlineAuditForm
          heading="Get Your Free Plumbing Company SEO Audit"
          description="Share your business details and we will review your local search rankings, Google Business Profile, and call conversion gaps at no cost."
        />
      </div>
