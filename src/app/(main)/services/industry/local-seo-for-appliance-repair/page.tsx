...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    title: "Local SEO for Appliance Repair Companies | Zonic Media",
    description:
      "Local SEO for appliance repair companies that wins the Google map pack — profile optimization, citations, reviews, and service-area pages that turn 'appliance repair near me' searches into booked service calls.",
    url: PAGE_PATH,
    type: "website",
  },
};
...
const breadcrumbJsonLd = buildBreadcrumbJsonLd([
  ...
  { name: "Local SEO for Appliance Repair", url: PAGE_PATH },
]);
...
const serviceJsonLd = {
  ...
  "@type": "Service",
  name: "Local SEO for Appliance Repair",
  serviceType: "Local Search Engine Optimization for Appliance Repair Companies",
  url: `${SITE_URL}${PAGE_PATH}`,
  description:
    "Local SEO for appliance repair companies covering Google Business Profile optimization, citation building, review growth, on-page SEO, and service-area content — built to rank appliance repair businesses in the Google map pack and grow booked service calls.",
  provider: {
    "@type": "Organization",
  ...
  audience: {
    ...
    name: "Appliance repair companies, appliance repair technicians, home appliance service businesses",
  },
  hasOfferCatalog: {
    "@type": "OfferCatalog",
    name: "Appliance Repair Local SEO Services",
    itemListElement: [
      {
        "@type": "Offer",
        itemOffered: {
          "@type": "Service",
          name: "Google Business Profile Optimization for Appliance Repair",
        },
      },
      {
        "@type": "Offer",
        itemOffered: {
          "@type": "Service",
          name: "Appliance Repair Keyword & Competitor Research",
        },
      },
      {
        "@type": "Offer",
...
const applianceSeoFaqJsonLd = {
  "@context": "https://schema.org",
  "@type": "FAQPage",
  url: `${SITE_URL}${PAGE_PATH}`,
  mainEntity: ApplianceSeoFaqs.map((faq) => ({
    "@type": "Question",
    name: faq.question,
    acceptedAnswer: {
      "@type": "Answer",
...
const BannerChecks = [
  "Your appliance repair map pack growth plan",
...
const ServiceCards = [
  {
    ...
    desc: (
      <>
        ...
        field, appliance repair category, photo, and post — the same system
        behind our{" "}
  ...
  },
  {
    ...
    title: "Appliance Repair Keyword & Competitor Research",
    desc: "We map every search your customers actually type — refrigerator repair, washer repair, dryer repair, dishwasher repair, oven repair, same-day service — city by city, and build the exact strategy that wins those searches for you.",
  },
  {
    icon: <FiLink2 aria-hidden="true" />,
    title: "Citations & Listing Management",
    desc: "Consistent name, address, and phone across every directory that matters — including the appliance repair and home-service listings Google checks. We fix the wrong ones, build the missing ones, and keep them synced.",
  },
  {
    icon: <FiStar aria-hidden="true" />,
    title: "Review Growth & Reputation",
    desc: "A steady stream of real reviews from real homeowners, with responses that show Google — and the next customer comparing appliance repair companies — that somebody is home.",
  },
  {
    ...
    desc: (
      <>
        Service and city pages built around real appliance repair searches, with
  ...
  },
  {
    ...
    desc: "Rankings, calls, direction requests, and booked-repair leads in one plain-English report. You always know what we did, what moved, and what is next.",
  },
];
...
const ResultCards = [
  {
    ...
    industry: "Same-Day Appliance Repair",
    metric: "+212%",
    label: "Calls from Google Business Profile",
    desc: "From page-two invisibility to top-three map pack rankings for 'appliance repair near me' across every service city within a few months.",
  },
  {
    icon: <RiSearchLine aria-hidden="true" />,
    industry: "Refrigeration Specialists",
    metric: "Top 3",
    label: "Map pack for every core keyword",
    desc: "A profile rebuild, citation cleanup, and review growth took the company from #13 to the top three for refrigerator and freezer repair searches.",
  },
  {
    icon: <FiTrendingUp aria-hidden="true" />,
    industry: "Commercial Appliance Repair",
    metric: "3.2×",
    label: "More booked service calls from local search",
    desc: "Service-area and city pages turned scattered washer, dryer, and dishwasher searches into a steady, year-round appliance repair pipeline.",
  },
];
...
const RankRows = [
  { kw: "appliance repair near me", pos: "#1", delta: "▲ 5" },
  { kw: "refrigerator repair [city]", pos: "#2", delta: "▲ 7" },
  { kw: "washer repair", pos: "#1", delta: "▲ 4" },
  { kw: "dryer repair near me", pos: "#3", delta: "▲ 8" },
];
...
const CompareUs = [
  "Profile worked weekly — posts, photos, Q&A, appliance repair categories",
  "Reporting tied to calls, direction requests, and booked service calls",
  "Hand-built citations and local links that compound",
  "A dedicated strategist who knows your appliance repair market",
...
const MarqueeItems = [
  "Appliance Repair SEO",
  "Refrigerator Repair Rankings",
  "Google Business Profile",
  "Map Pack Rankings",
  "Washer & Dryer Repair Leads",
  "Review Growth",
  "Service-Area Pages",
];
...
const GrowCards = [
  {
    ...
    icon: <MdOutlineVerifiedUser aria-hidden="true" />,
    title: "Google Business Profile Optimization",
    desc: "Most homeowners pick an appliance repair company straight from the map pack. We optimize your profile so that company is you.",
  ...
  },
  {
    ...
    desc: "Ready to grow beyond local SEO? A conversion-first website that turns appliance repair searches into booked service calls.",
  ...
  },
  {
    ...
    desc: "Pair organic rankings with paid coverage and own the whole results page for high-intent appliance repair searches.",
    cta: "See Google Ads",
  },
];
    ...
    <>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify(applianceSeoFaqJsonLd),
        }}
      />
              ...
              <div className="tseo-hero-grid">
                <div className="tseo-hero-copy">
                  ...
                  <p className="tseo-hero-sub">
                    ...
                    content — so when homeowners search &ldquo;appliance repair
                  ...
                  <div className="tseo-hero-ctas">
                    <HashScrollLink
                      ...
                      offset={120}
                    >
                      Get Your Free Appliance Repair SEO Audit
                ...
                <div className="tseo-hero-visual">
                  ...
                  <div className="tseo-hero-dash" aria-hidden="true">
                    <div className="tseo-dash-head">
                      <div className="tseo-dash-title">Appliance Repair Local SEO Performance</div>
                    </div>
                        ...
                        <div className="tseo-dash-body">
                          <div className="tseo-dash-list">
                            <p className="tseo-dash-sub">
                              Map pack · &ldquo;appliance repair near me&rdquo;
                            </p>
                            <div className="tseo-dash-li tseo-dash-li--you">
                              <FiMapPin />
                              <span>Your Appliance Repair Co.</span>
                              <em>#1</em>
                            </div>
                            <div className="tseo-dash-li">
                              <FiMapPin />
                              <span>Competitor Appliance Repair</span>
                              <em>#2</em>
                            </div>
                            <div className="tseo-dash-li">
                              <FiMapPin />
                              <span>Competitor Fix-It Pros</span>
                              <em>#3</em>
                            </div>
                      ...
                      <div className="tseo-ba-panel tseo-ba-panel--before">
                        <div className="tseo-dash-body">
                          <div className="tseo-dash-list">
                            ...
                            <div className="tseo-dash-li">
                              <FiMapPin />
                              <span>Competitor Home Appliance Co.</span>
                              <em>#3</em>
                            </div>
                  ...
                  <div className="tseo-hero-floats">
                    <div className="tseo-float-card">
                      ...
                      <p>
                        ...
                        &ldquo;appliance repair near me&rdquo;
                      </p>
                    </div>
                    <div className="tseo-float-card">
              ...
              <div className="tseo-problem-grid">
                <div className="tseo-gbp-wrap" aria-hidden="true">
                  <div className="tseo-gbp">
                    ...
                    <p className="tseo-gbp-meta">
                      Appliance repair · <em>Open now</em> · Same-day service
                    </p>
                ...
                <div>
                  ...
                  <p className="tseo-lead">
                    When a fridge stops cooling or a washer floods the laundry
                    room, the first thing homeowners do is search
                    &ldquo;appliance repair near me&rdquo; and call one of the
                    ...
                    mastering for appliance repair companies.
                  </p>
                  <p className="tseo-lead">
                    ...
                    service calls, and revenue that compounds month after month.
                  </p>
            ...
            <div className="tseo-band-grid">
              <div className="tseo-band-content">
                ...
                <p className="tseo-lead">
                  ...
                  top spots for the appliance repair services and cities that pay
                ...
                <p className="tseo-lead">
                  ...
                  Google exactly which appliances you fix, consistent citations
                  confirm you are who you say you are, and a steady flow of
                  reviews and local content proves homeowners love working with
                ...
                <div className="tseo-mappack-list">
                  ...
                  <div className="tseo-mappack-row tseo-mappack-row--you">
                    ...
                    <span className="tseo-mappack-info">
                      <strong>Your Appliance Repair Co.</strong>
                      <span className="tseo-mappack-stars">
                        <FaStar />
                        4.9 (176) · Appliance repair ·{" "}
                  ...
                  <div className="tseo-mappack-row">
                    ...
                    <span className="tseo-mappack-info">
                      <strong>Competitor Appliance Repair</strong>
                      <span className="tseo-mappack-stars">
                        <FaStar />
                        4.6 (98) · Appliance repair
                      </span>
                    </span>
                  </div>
                  <div className="tseo-mappack-row">
                    ...
                    <span className="tseo-mappack-info">
                      <strong>Competitor Fix-It Pros</strong>
                      <span className="tseo-mappack-stars">
                        <FaStar />
                        4.4 (61) · Appliance repair
                      </span>
                    </span>
                  </div>
                </div>
              ...
              <div className="tseo-bento">
                ...
                <article className="tseo-bento-card tseo-bento-card--s1">
                  ...
                  <p>
                    ...
                    washer, and dryer repair calls you are missing are going
                    instead.
                  </p>
                  <div className="tseo-bento-visual" aria-hidden="true">
                    <p className="tseo-bento-visual-title">
                      Where appliance repair clients typically land after 90 days
                    </p>
                    {[
                ...
                <article className="tseo-bento-card tseo-bento-card--s4">
                  <div className="tseo-bento-s4-copy">
                    ...
                    <p>
                      ...
                      appliance repair services and more cities.
                    </p>
                  </div>
            ...
            <div className="tseo-container">
              ...
              <div className="tseo-compare-grid">
                ...
                <div className="tseo-compare-col tseo-compare-col--us">
                  <h3>Appliance Repair Local SEO with Zonic Media</h3>
                  <p className="tseo-compare-sub">
                ...
                >
                  ...
                  <p className="tseo-compare-sub">
                    A typical appliance repair client&apos;s first six months
                  </p>
              ...
              <div className="tseo-tracking-grid">
                <div>
                  ...
                  <p className="tseo-lead">
                    ...
                    for the appliance repair keywords that pay you, review growth
              ...
              <div className="tseo-why-banner">
                <div className="tseo-why-banner-text">
                  ...
                  <p>
                    ...
                    the appliance repair searches in your market. Free, and yours
                    to keep either way.
                  </p>
                ...
                <div className="tseo-audit-card" aria-hidden="true">
                  ...
                  <div className="tseo-audit-ring-wrap">
                    ...
                    <div className="tseo-audit-ring-info">
                      ...
                      <small>
                        Where our appliance repair campaigns typically land after
          ...
          <section className="tseo-nationwide">
            <div className="tseo-container">
              <div className="tseo-sec-head-center">
                ...
                <p className="tseo-lead">
                  From single-technician operators to multi-location appliance
                  repair brands, we run local SEO campaigns in every state.
                  Everything happens remotely — audits, strategy calls, reporting
                  — so you get the same process whether you are in Delaware,
                  Texas, or California.
                </p>
              </div>
          ...
          <section className="tseo-faqs" id="tseo-faqs">
            <div className="tseo-container">
              <div className="tseo-split-grid">
                ...
                <div>
                  <GmbFaqs items={ApplianceSeoFaqs} />
                </div>
              </div>
            </div>
          </section>
              ...
              <div className="tseo-form-grid">
                <aside className="tseo-form-aside">
                  ...
                  <p className="tseo-lead">
                    ...
                    a full local visibility audit — rankings, profile, citations,
                    reviews — plus a flat-price growth plan to take you to the top
                    of your market.
                  </p>
      ...
      <RelatedServices current="/services/industry/local-seo-for-appliance-repair" />
      <Footer />
    </>
  );
}
