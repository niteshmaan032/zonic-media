/*
 * SEO SERVICES FOR CAR TOWING — revamped July 2026 onto the approved local SEO
 ...
 * schema are towing / roadside-assistance specific. Form leads submit as
 * service "Local SEO" (on the API whitelist).
 *
 * ==========================================================================
 * OLD IMPLEMENTATION — kept commented for reference during the revamp.
 * The prior page rendered a separate "use client" CarTowSeoPage component.
 * ==========================================================================
 *
 * import CarTowSeoPage from "./CarTowSeoPage";
 * import { buildBreadcrumbJsonLd } from "@/shared/seoSchemas";
 * // CarTowSeoPage imports (client component, framer-motion animated process):
 ...
 * import { FaArrowRight, FaBolt, FaCarBurst, FaChartLine, FaClock, FaComments,
 *   FaMapLocationDot, FaPhoneVolume, FaRankingStar, FaRegCircleCheck, FaRoute,
 *   FaStar, FaTrafficLight, FaTruckFast } from "react-icons/fa6";
 * import { FiArrowUpRight, FiSearch, FiPhoneCall } from "react-icons/fi";
 ...
 *
 * const faqs = [
 *   { question: "How can SEO help my towing business?", answer: "SEO helps your towing business appear when people search for urgent services such as tow truck near me, roadside assistance, flatbed towing, and 24 hour towing. Strong local SEO improves your Google Maps visibility, strengthens trust signals, and increases the chances that nearby drivers call your company instead of a competitor." },
 *   { question: "How long does towing SEO take?", answer: "Some improvements, especially Google Business Profile updates and call-focused website fixes, can help within the first few weeks. More competitive growth, including stronger map rankings across several service terms and areas, usually takes a few months of consistent optimization." },
 *   { question: "What keywords should towing companies target?", answer: "Towing companies should prioritize high-intent terms tied to emergencies and local service demand, including tow truck near me, emergency towing service, roadside assistance, 24 hour towing, flatbed towing, accident towing, jump start service, and local towing company plus city and area modifiers." },
 *   { question: "Is Google Business Profile important for towing companies?", answer: "Yes. For most towing businesses, Google Business Profile is one of the strongest lead channels because urgent searchers often call directly from the map results. Category alignment, review quality, service areas, photos, and profile completeness all influence visibility and trust." },
 *   { question: "Do towing companies need a website?", answer: "Yes. A website supports rankings beyond the map listing, gives Google stronger location and service relevance, and helps customers confirm that you handle their exact towing need." },
 *   { question: "Why choose Zonic Media for towing SEO?", answer: "Zonic Media approaches towing SEO as a call-generation system, not a generic content package. The focus is on urgent local search behavior, Google Maps performance, mobile conversion flow, and messaging that helps more drivers choose your company quickly." },
 * ];
 *
 * (Full previous hero/marquee/process/case-study/table/testimonial JSX and
 *  the trustStats, marqueeTerms, problemCards, searchJourney, keywordCards,
 *  serviceCards, reasonCards, insightCards, caseStudyStats, comparisonRows,
 *  benefitCards, processSteps, carTowFormHead arrays are preserved in git
 *  history. Replaced wholesale by the template layout below.)
 */
...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    title: "SEO for Towing Companies That Win Local Calls | Zonic Media",
    description:
      "SEO for towing companies that wins the map pack — rank for 'tow truck near me,' optimize your Google Business Profile, and turn stranded drivers into dispatched calls.",
    url: PAGE_PATH,
    type: "website",
  },
};
...
const breadcrumbJsonLd = buildBreadcrumbJsonLd([
  ...
  { name: "SEO for Car Towing", url: PAGE_PATH },
]);
...
const serviceJsonLd = {
  ...
  "@type": "Service",
  name: "SEO for Towing Companies",
  serviceType: "Local Search Engine Optimization for Towing & Roadside Assistance Companies",
  url: `${SITE_URL}${PAGE_PATH}`,
  description:
    "SEO for towing companies covering Google Business Profile optimization, citation building, review growth, on-page SEO, and service-area content — built to rank tow truck and roadside assistance businesses in the Google map pack and grow dispatched calls.",
  provider: {
    "@type": "Organization",
  ...
  audience: {
    ...
    name: "Towing companies, tow truck operators, roadside assistance businesses",
  },
  hasOfferCatalog: {
    "@type": "OfferCatalog",
    name: "Towing Local SEO Services",
    itemListElement: [
      {
        "@type": "Offer",
        itemOffered: {
          "@type": "Service",
          name: "Google Business Profile Optimization for Towing",
        },
      },
      {
        "@type": "Offer",
        itemOffered: {
          "@type": "Service",
          name: "Towing Keyword & Competitor Research",
        },
      },
      {
        "@type": "Offer",
...
const TowingSeoFaqs = [
  {
    question: "What's Included in Your SEO Services for Towing Companies?",
    answer:
      "Every towing campaign covers the full local ranking system: Google Business Profile optimization, citation building and cleanup, review growth, on-page SEO for your emergency towing and service-area pages, local content, and a monthly report that shows rankings, calls, and dispatched jobs — not vanity metrics.",
  },
  {
    question: "How Long Does Towing SEO Take to Show Results?",
    answer:
      "Most towing companies see measurable movement within 60 to 90 days — better map pack visibility for searches like 'tow truck near me,' more profile actions, and more inbound dispatch calls. Competitive markets take longer to fully dominate, but the trajectory is visible from the first monthly report, and momentum compounds every month.",
  },
  {
    question: "How Much Do SEO Services for Towing Companies Cost?",
    answer:
      "Pricing depends on how many trucks and locations you run, how competitive your market is, and how aggressively you want to grow. After a free audit we quote a flat monthly price — no long-term contracts and no surprise line items.",
  },
  {
    question: "Do You Guarantee First-Page Google Rankings for Towing Keywords?",
    answer:
      "Our track record speaks for itself — most towing clients reach top-three map pack positions for their core keywords, and every campaign is built on the exact signals Google rewards. Because Google's results change daily, no agency can honestly promise a fixed position, so we guarantee what matters: full transparency. You see exactly where you rank, what improved, and what we did each month — and with no long-term contracts, we earn your business with results.",
  },
  {
    question: "Do Towing Companies Really Need Google Business Profile Optimization?",
    answer:
      "Yes — it is the single biggest lever in towing SEO. When a stranded driver searches 'tow truck near me,' the top three map pack results get almost all the calls. Your Google Business Profile decides whether you show up there, and it drives your call volume, direction requests, and review visibility. We optimize every field, towing category, photo, and post so Google trusts your profile and drivers call you first.",
  },
  {
    question: "Can You Help 24/7 Dispatch and Multi-Truck Towing Operations?",
    answer:
      "Absolutely. We build local SEO systems for single-truck operators and multi-truck, 24-hour towing fleets alike — service-area targeting, individual location pages, and map visibility for every city, highway, and neighborhood you cover, all reported in one clear dashboard so your dispatch stays busy around the clock.",
  },
  {
...
const towingSeoFaqJsonLd = {
  "@context": "https://schema.org",
  "@type": "FAQPage",
  url: `${SITE_URL}${PAGE_PATH}`,
  mainEntity: TowingSeoFaqs.map((faq) => ({
    "@type": "Question",
    name: faq.question,
    acceptedAnswer: {
      "@type": "Answer",
...
const BannerChecks = [
  "Your towing map pack growth plan",
...
const ServiceCards = [
  {
    ...
    desc: (
      <>
        ...
        field, towing category, photo, and post — the same system behind our{" "}
        <Link href="/local-seo-google-business-optimization" className="tseo-inline-link">
          GBP optimization service
        </Link>{" "}
        — so Google trusts it and stranded drivers choose you.
      </>
    ),
  },
  {
    icon: <FiSearch aria-hidden="true" />,
    title: "Towing Keyword & Competitor Research",
    desc: "We map every search your customers actually type — tow truck near me, emergency towing, 24 hour towing, roadside assistance, flatbed and heavy-duty — city by city, and build the exact strategy that wins those searches for you.",
  },
  {
    icon: <FiLink2 aria-hidden="true" />,
    title: "Citations & Listing Management",
    desc: "Consistent name, address, and phone across every directory that matters — including the towing and roadside listings Google checks. We fix the wrong ones, build the missing ones, and keep them synced.",
  },
  {
    icon: <FiStar aria-hidden="true" />,
    title: "Review Growth & Reputation",
    desc: "A steady stream of real reviews from real drivers you've rescued, with responses that show Google — and the next motorist comparing towing companies — that somebody is on call.",
  },
  {
    ...
    desc: (
      <>
        Service and city pages built around real towing searches, with schema
  ...
  },
  {
    ...
    desc: "Rankings, calls, direction requests, and dispatched-job leads in one plain-English report. You always know what we did, what moved, and what is next.",
  },
];
...
const ResultCards = [
  {
    ...
    industry: "24/7 Roadside Co.",
    metric: "+212%",
    label: "Calls from Google Business Profile",
    desc: "From page-two invisibility to top-three map pack rankings for 'tow truck near me' across every service city in a single quarter.",
  },
  {
    icon: <RiSearchLine aria-hidden="true" />,
    industry: "Heavy-Duty Towing",
    metric: "Top 3",
    label: "Map pack for every core keyword",
    desc: "A profile rebuild, citation cleanup, and review growth took the company from #13 to the top three for its highest-value recovery jobs.",
  },
  {
    icon: <FiTrendingUp aria-hidden="true" />,
    industry: "Multi-Truck Towing",
    metric: "3.2×",
    label: "More dispatched jobs from local search",
    desc: "Service-area and highway-corridor pages turned unpredictable call flow into a steady, round-the-clock dispatch pipeline.",
  },
];
...
const RankRows = [
  { kw: "tow truck near me", pos: "#1", delta: "▲ 12" },
  { kw: "roadside assistance [city]", pos: "#2", delta: "▲ 7" },
  { kw: "24 hour towing", pos: "#1", delta: "▲ 5" },
  { kw: "emergency towing near me", pos: "#3", delta: "▲ 8" },
];
...
const CompareThem = [
  ...
  "Reports full of impressions, empty of dispatch calls",
...
const CompareUs = [
  "Profile worked weekly — posts, photos, Q&A, towing categories",
  "Reporting tied to calls, direction requests, and dispatched jobs",
  "Hand-built citations and local links that compound",
  "A dedicated strategist who knows your towing market",
...
const WhyCards = [
  {
    icon: <RiSearchLine aria-hidden="true" />,
    title: "Call-Driven Local Services is All We Do",
    desc: "We are not a generalist agency dabbling in maps. Local rankings, local calls, and dispatched jobs for towing and roadside businesses is the entire practice.",
  },
  {
    icon: <FiZap aria-hidden="true" />,
    title: "Fast, Compounding Execution",
    desc: "Foundation fixes ship in the first weeks, not the first quarter — so you are capturing 'tow truck near me' calls sooner. Every month of work stacks on the last.",
  },
  {
    icon: <MdOutlineVerifiedUser aria-hidden="true" />,
...
const GrowCards = [
  {
    ...
    icon: <MdOutlineVerifiedUser aria-hidden="true" />,
    title: "Google Business Profile Optimization",
    desc: "Most stranded drivers pick a towing company straight from the map pack. We optimize your profile so that company is you.",
  ...
  },
  {
    ...
    desc: "Rankings mean nothing if the click-to-call is buried. We build fast, mobile-first towing sites that turn searches into dispatched calls.",
  ...
  },
  {
    ...
    desc: "Pair organic rankings with paid coverage and own the whole results page during peak roadside emergencies.",
    cta: "See Google Ads",
  },
];
    ...
    <>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify(towingSeoFaqJsonLd),
        }}
      />
                ...
                <div className="tseo-hero-copy">
                  ...
                  <div className="tseo-hero-ctas">
                    <HashScrollLink
                      ...
                      offset={120}
                    >
                      Get Your Free Towing SEO Audit
                ...
                <div className="tseo-hero-visual">
                  ...
                  <div className="tseo-hero-dash" aria-hidden="true">
                    <div className="tseo-dash-head">
                      <div className="tseo-dash-title">Towing Local SEO Performance</div>
                    </div>
                        ...
                        <div className="tseo-dash-body">
                          <div className="tseo-dash-list">
                            <p className="tseo-dash-sub">
                              Map pack · &ldquo;tow truck near me&rdquo;
                            </p>
                            <div className="tseo-dash-li tseo-dash-li--you">
                              <FiMapPin />
                              <span>Your Towing Company</span>
                              <em>#1</em>
                            </div>
                            <div className="tseo-dash-li">
                              <FiMapPin />
                              <span>Competitor Towing &amp; Recovery</span>
                              <em>#2</em>
                            </div>
                            <div className="tseo-dash-li">
                              <FiMapPin />
                              <span>Competitor Roadside</span>
                              <em>#3</em>
                            </div>
                      ...
                      <div className="tseo-ba-panel tseo-ba-panel--before">
                        <div className="tseo-dash-body">
                          <div className="tseo-dash-list">
                            ...
                            <div className="tseo-dash-li">
                              <FiMapPin />
                              <span>Competitor Recovery Co.</span>
                              <em>#3</em>
                            </div>
              ...
              <div className="tseo-problem-grid">
                <div className="tseo-gbp-wrap" aria-hidden="true">
                  <div className="tseo-gbp">
                    ...
                    <p className="tseo-gbp-meta">
                      Towing service · <em>Open 24/7</em> · Fast response
                    </p>
                ...
                <div>
                  ...
                  <h2 className="tseo-h2">
                    Stranded Drivers are Searching for a Tow.{" "}
                    <span className="tseo-hl-text">
                      We Make Sure They Find You.
                    </span>
                  </h2>
                  <p className="tseo-lead">
                    When a car breaks down or an accident happens, the first
                    thing a driver does is search &ldquo;tow truck near me&rdquo;
                    ...
                    have spent years mastering for towing and roadside
                    operators.
                  </p>
                  <p className="tseo-lead">
                    ...
                    monthly — that is how our clients turn urgent searches into
                    calls, dispatched jobs, and revenue that compounds month
                    after month.
                  </p>
            ...
            <div className="tseo-container">
              <div className="tseo-sec-head">
                <div>
                  ...
                  <h2 className="tseo-h2">
                    Everything Your Towing Rankings Need, in One System
                  </h2>
                </div>
          ...
          <section className="tseo-band">
            <div className="tseo-band-grid">
              <div className="tseo-band-content">
                ...
                <h2 className="tseo-h2">
                  We Put Your Towing Company in the Top Three — And Keep It There
                </h2>
                <p className="tseo-lead">
                  The map pack gets the majority of clicks and nearly all of the
                  emergency calls, and that is exactly where we specialize. Every
                  campaign is built around one goal: earning your business those
                  top spots for the towing services and cities that pay you best,
                ...
                <p className="tseo-lead">
                  ...
                  Google exactly which towing and roadside services you offer,
                  consistent citations confirm you are who you say you are, and a
                  steady flow of reviews and local content proves drivers trust
                  you when it counts. And if a listing ever gets suspended, our{" "}
                  <Link
                ...
                <div className="tseo-mappack-list">
                  ...
                  <div className="tseo-mappack-row tseo-mappack-row--you">
                    ...
                    <span className="tseo-mappack-info">
                      <strong>Your Towing Company</strong>
                      <span className="tseo-mappack-stars">
                        <FaStar />
                        4.9 (196) · Towing service ·{" "}
                        <span className="tseo-mappack-open">Open 24/7</span>
                      </span>
                    </span>
                  ...
                  <div className="tseo-mappack-row">
                    ...
                    <span className="tseo-mappack-info">
                      <strong>Competitor Towing &amp; Recovery</strong>
                      <span className="tseo-mappack-stars">
                        <FaStar />
                        4.6 (98) · Towing service
                      </span>
                    </span>
                  </div>
                  <div className="tseo-mappack-row">
                    ...
                    <span className="tseo-mappack-info">
                      <strong>Competitor Roadside Co.</strong>
                      <span className="tseo-mappack-stars">
                        <FaStar />
                        4.4 (61) · Towing service
                      </span>
                    </span>
                  </div>
                </div>
            ...
            <div className="tseo-container">
              ...
              <div className="tseo-bento">
                ...
                <article className="tseo-bento-card tseo-bento-card--s1">
                  ...
                  <h3>Free Towing Visibility Audit</h3>
                  <p>
                    We audit your rankings, profile, citations, reviews, and
                    competitors — and show you exactly where the emergency tow
                  ...
                  <div className="tseo-bento-visual" aria-hidden="true">
                    <p className="tseo-bento-visual-title">
                      Where towing clients typically land after 90 days
                    </p>
                    {[
                ...
                <article className="tseo-bento-card tseo-bento-card--s3">
                  ...
                  <p>
                    ...
                    keep you there around the clock.
                  </p>
                ...
                <article className="tseo-bento-card tseo-bento-card--s4">
                  <div className="tseo-bento-s4-copy">
                    ...
                    <p>
                      Monthly reporting tied to calls and dispatched jobs, not
                      vanity metrics. As rankings lock in, we expand to more
                      towing services and more cities.
                    </p>
                  </div>
          ...
          <section className="tseo-results">
            <div className="tseo-container">
              <div className="tseo-sec-head-center">
                ...
                <h2 className="tseo-h2">
                  What Happens When Towing Local SEO is Done Properly
                </h2>
                <p className="tseo-lead">
          ...
          <section className="tseo-compare">
            <div className="tseo-container">
              <div className="tseo-sec-head-center">
                ...
                <h2 className="tseo-h2">
                  What You Get with Zonic Vs. A Typical Towing SEO Agency
                </h2>
                <p className="tseo-lead">
              ...
              <div className="tseo-compare-grid">
                <div className="tseo-compare-col tseo-compare-col--them">
                  ...
                  <p className="tseo-compare-sub">
                    Why most towing campaigns quietly stall
                  </p>
                  <ul>
                ...
                <div className="tseo-compare-col tseo-compare-col--us">
                  <h3>Towing Local SEO with Zonic Media</h3>
                  <p className="tseo-compare-sub">
                ...
                >
                  ...
                  <p className="tseo-compare-sub">
                    A typical towing client&apos;s first six months
                  </p>
          ...
          <section className="tseo-why">
            <div className="tseo-container">
              <div className="tseo-sec-head-center">
                ...
                <h2 className="tseo-h2">
                  A Towing Local SEO Partner, Not a Monthly Invoice
                </h2>
                <p className="tseo-lead">
              ...
              <div className="tseo-why-banner">
                <div className="tseo-why-banner-text">
                  <p className="tseo-eyebrow">Free Towing SEO Audit</p>
                  <h3>See Exactly How We&apos;ll Grow Your Towing Rankings</h3>
                  <p>
                    We&apos;ll map your profile, citations, reviews, and
                    rankings — and show you the clear path to the top three for
                    the towing searches in your market. Free, and yours to keep
                    either way.
                  </p>
                ...
                <div className="tseo-audit-card" aria-hidden="true">
                  ...
                  <div className="tseo-audit-ring-wrap">
                    ...
                    <div className="tseo-audit-ring-info">
                      ...
                      <small>
                        Where our towing campaigns typically land after six
          ...
          <section className="tseo-nationwide">
            <div className="tseo-container">
              <div className="tseo-sec-head-center">
                ...
                <h2 className="tseo-h2">
                  Local SEO for Towing Companies in Every Market in the US
                </h2>
                <p className="tseo-lead">
                  From single-truck operators to multi-truck, 24-hour towing
                  fleets, we run local SEO campaigns in every state. Everything
            ...
            <div className="tseo-container">
              <div className="tseo-form-grid">
                <aside className="tseo-form-aside">
                  ...
                  <h2 className="tseo-h2">
                    Claim Your Free Towing Local SEO Audit
                  </h2>
                  <p className="tseo-lead">
                    Tell us about your towing business and we will send a full
                ...
                <div className="tseo-form-main">
                  <ServiceLeadForm
                    formType="local-seo"
                    badge="Free Audit"
                    title="Get Your Free Towing SEO Audit"
                    subtitle="No contracts, no pressure — just a clear picture of where your towing company stands and what it takes to win your market."
                    submitText="Send My Free Audit"
                    messageLabel="Tell us about your towing business"
      ...
      <RelatedServices current="/services/industry/seo-services-for-car-towing" />
      <Footer />
    </>
  );
}
