/*
 * LOCAL SEO SERVICES FOR RESIDENTIAL CLEANING — revamped July 2026 onto the
 * approved local SEO template layout (see /services/template-seo). Design/classes
 * come from templateSeo.css (scoped under .tseo-page); all copy, mockups, FAQs,
 * and schema are residential / house-cleaning specific. Form leads submit as
 ...
 * ==========================================================================
 *
 * The prior page was a thin wrapper that rendered a separate
 * ./ResidentialSeoPage component:
 *
 ...
 *   };
 *
 * (Full prior JSX for both the wrapper and ResidentialSeoPage.tsx preserved in
...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    title: "Residential Cleaning SEO That Books More Clients | Zonic Media",
    description:
      "Residential cleaning SEO that wins the Google map pack — profile optimization, reviews, and service-area pages that turn 'house cleaning near me' searches into booked cleanings.",
    url: PAGE_PATH,
    type: "website",
  },
};
...
const breadcrumbJsonLd = buildBreadcrumbJsonLd([
  ...
  { name: "Residential Cleaning SEO", url: PAGE_PATH },
]);
...
const serviceJsonLd = {
  ...
  "@type": "Service",
  name: "Residential Cleaning SEO",
  serviceType: "Local Search Engine Optimization for House Cleaning Companies",
  ...
  audience: {
    ...
    name: "House cleaning companies, maid services, residential cleaning businesses",
  },
  hasOfferCatalog: {
    "@type": "OfferCatalog",
    name: "Residential Cleaning SEO Services",
    itemListElement: [
      {
        "@type": "Offer",
        itemOffered: {
          "@type": "Service",
          name: "Google Business Profile Optimization for House Cleaners",
        },
      },
      {
        "@type": "Offer",
        itemOffered: {
          "@type": "Service",
          name: "House Cleaning Keyword & Competitor Research",
        },
      },
      {
        "@type": "Offer",
...
const CleaningSeoFaqs = [
  {
    question: "What's Included in Your Residential Cleaning SEO Services?",
    answer:
      "Every house cleaning campaign covers the full local ranking system: Google Business Profile optimization, citation building and cleanup, review growth, on-page SEO for your recurring, deep-clean, and service-area pages, local content, and a monthly report that shows rankings, calls, and booked cleanings — not vanity metrics.",
  },
  {
    question: "How Long Does House Cleaning SEO Take to Show Results?",
    answer:
      "Most cleaning companies see measurable movement within 60 to 90 days — better map pack visibility, more profile actions, and more booking requests for searches like 'house cleaning near me' and 'maid service near me.' Competitive markets take longer to fully dominate, but the trajectory is visible from the first monthly report, and momentum compounds every month.",
  },
  {
    question: "How Much Does Residential Cleaning SEO Cost?",
    answer:
      "Pricing depends on how many crews you run, how competitive your market is, and how aggressively you want to grow recurring clients. After a free audit we quote a flat monthly price — no long-term contracts and no surprise line items.",
  },
  {
    question: "Do You Guarantee First-Page Google Rankings for Cleaning Keywords?",
    answer:
      "Our track record speaks for itself — most house cleaning clients reach top-three map pack positions for their core keywords, and every campaign is built on the exact signals Google rewards. Because Google's results change daily, no agency can honestly promise a fixed position, so we guarantee what matters: full transparency. You see exactly where you rank, what improved, and what we did each month — and with no long-term contracts, we earn your business with results.",
  },
  {
    question: "Do House Cleaning Companies Really Need Google Business Profile Optimization?",
    answer:
      "Yes — it is the single biggest lever in residential cleaning SEO. Your Google Business Profile decides whether you show up in the local map pack when a homeowner searches for a cleaner or maid service, and it drives your booking requests, direction requests, and review visibility. We optimize every field, category, photo, and post so Google trusts your profile and homeowners choose it.",
  },
  {
    question: "Can You Help Multi-Crew Cleaning Companies and Large Service Areas?",
    answer:
      "Absolutely. We build local SEO systems for solo maid services and multi-crew cleaning brands alike — service-area targeting, individual location pages, and map visibility for every city and neighborhood you cover, all reported in one clear dashboard.",
  },
  {
...
const cleaningSeoFaqJsonLd = {
  "@context": "https://schema.org",
  "@type": "FAQPage",
  url: `${SITE_URL}${PAGE_PATH}`,
  mainEntity: CleaningSeoFaqs.map((faq) => ({
    "@type": "Question",
    name: faq.question,
    acceptedAnswer: {
      "@type": "Answer",
...
const BannerChecks = [
  "Your house cleaning map pack growth plan",
...
const ServiceCards = [
  {
    ...
    desc: (
      <>
        ...
        — so Google trusts it and homeowners book you.
      </>
    ),
  },
  {
    icon: <FiSearch aria-hidden="true" />,
    title: "House Cleaning Keyword & Competitor Research",
    desc: "We map every search your clients actually type — house cleaning near me, maid service, deep cleaning, move-out cleaning — city by city, and build the exact strategy that wins those searches for you.",
  },
  {
    icon: <FiLink2 aria-hidden="true" />,
    title: "Citations & Listing Management",
    desc: "Consistent name, address, and phone across every directory that matters — including the home-service and cleaning listings Google checks. We fix the wrong ones, build the missing ones, and keep them synced.",
  },
  {
    icon: <FiStar aria-hidden="true" />,
    title: "Review Growth & Reputation",
    desc: "A steady stream of real reviews from real homeowners, with responses that show Google — and the next client comparing cleaning companies — that somebody is home.",
  },
  {
    ...
    desc: (
      <>
        Service and city pages built around real house cleaning searches, with
        schema and internal links that make every page easier to rank — backed by
        conversion-first{" "}
  ...
  },
  {
    ...
    desc: "Rankings, calls, direction requests, and booking leads in one plain-English report. You always know what we did, what moved, and what is next.",
  },
];
...
const ResultCards = [
  {
    ...
    industry: "Maid Service Co.",
    metric: "+212%",
    label: "Bookings from Google Business Profile",
    desc: "From page-two invisibility to top-three map pack rankings for 'house cleaning near me' across every service city within one quarter.",
  },
  {
    icon: <RiSearchLine aria-hidden="true" />,
    industry: "Deep-Clean Specialists",
    metric: "Top 3",
    label: "Map pack for every core keyword",
    desc: "A profile rebuild, citation cleanup, and review growth took the company from #11 to the top three and filled the recurring-client calendar.",
  },
  {
    icon: <FiTrendingUp aria-hidden="true" />,
    industry: "Multi-Crew Cleaning",
    metric: "3.2×",
    label: "More recurring clients from local search",
    desc: "Service-area and city pages turned one-time cleans into a steady, year-round book of recurring residential clients.",
  },
];
...
const RankRows = [
  { kw: "house cleaning near me", pos: "#1", delta: "▲ 5" },
  { kw: "maid service [city]", pos: "#2", delta: "▲ 7" },
  { kw: "deep cleaning service", pos: "#1", delta: "▲ 4" },
  { kw: "home cleaning services", pos: "#3", delta: "▲ 8" },
];
...
const CompareThem = [
  ...
  "Reports full of impressions, empty of booked cleanings",
...
const CompareUs = [
  ...
  "Reporting tied to calls, direction requests, and booked cleanings",
  "Hand-built citations and local links that compound",
  "A dedicated strategist who knows your cleaning market",
...
const WhyCards = [
  {
    ...
    desc: "We are not a generalist agency dabbling in maps. Local rankings, local calls, and booked cleanings for house cleaning and home-service companies is the entire practice.",
  },
  {
    icon: <FiZap aria-hidden="true" />,
    title: "Fast, Compounding Execution",
    desc: "Foundation fixes ship in the first weeks, not the first quarter — so you start booking clients sooner. Every month of work stacks on the last into a recurring pipeline.",
  },
  {
    icon: <MdOutlineVerifiedUser aria-hidden="true" />,
...
const GrowCards = [
  {
    ...
    icon: <MdOutlineVerifiedUser aria-hidden="true" />,
    title: "Google Business Profile Optimization",
    desc: "Most homeowners pick a cleaner straight from the map pack. We optimize your profile so that company is you.",
  ...
  },
  {
    ...
    desc: "Ready to convert more of the traffic you rank? A conversion-first cleaning website that turns visitors into booked cleanings.",
  ...
  },
  {
    ...
    desc: "Pair organic rankings with paid coverage and own the whole results page for high-intent cleaning searches.",
    cta: "See Google Ads",
  },
];
    ...
    <>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify(cleaningSeoFaqJsonLd),
        }}
      />
            ...
            <div className="tseo-container">
              <div className="tseo-hero-grid">
                <div className="tseo-hero-copy">
                  <p className="tseo-eyebrow">Residential Cleaning SEO</p>
                  <h1 className="tseo-hero-h1">
                    Local SEO for House Cleaning That{" "}
                    <span className="tseo-hl">Books Clients</span>
                  </h1>
                  <p className="tseo-hero-sub">
                    ...
                    full local ranking system for house cleaning companies —
                    Google Business Profile, citations, reviews, and service-area
                    content — so when homeowners search &ldquo;house cleaning near
                    me,&rdquo; they find and book you first.
                  </p>
                  ...
                  <div className="tseo-hero-ctas">
                    <HashScrollLink
                      ...
                      offset={120}
                    >
                      Get Your Free House Cleaning SEO Audit
                        ...
                        <div className="tseo-dash-body">
                          <div className="tseo-dash-list">
                            <p className="tseo-dash-sub">
                              Map pack · &ldquo;house cleaning near me&rdquo;
                            </p>
                            ...
                            <div className="tseo-dash-li">
                              <FiMapPin />
                              <span>Competitor Maid Service</span>
                              <em>#2</em>
                            </div>
                            <div className="tseo-dash-li">
                              <FiMapPin />
                              <span>Competitor Cleaners</span>
                              <em>#3</em>
                            </div>
                      ...
                      <div className="tseo-ba-panel tseo-ba-panel--before">
                        <div className="tseo-dash-body">
                          <div className="tseo-dash-list">
                            ...
                            <div className="tseo-dash-li">
                              <FiMapPin />
                              <span>Competitor Home Cleaning Co.</span>
                              <em>#3</em>
                            </div>
                  ...
                  <div className="tseo-hero-floats">
                    <div className="tseo-float-card">
                      ...
                      <p>
                        ...
                        &ldquo;house cleaning near me&rdquo;
                      </p>
                    </div>
                    <div className="tseo-float-card">
              ...
              <div className="tseo-problem-grid">
                <div className="tseo-gbp-wrap" aria-hidden="true">
                  <div className="tseo-gbp">
                    ...
                    <p className="tseo-gbp-meta">
                      House cleaning · <em>Open now</em> · Free quotes
                    </p>
                ...
                <div>
                  ...
                  <h2 className="tseo-h2">
                    Homeowners are Searching for a Cleaner.{" "}
                    <span className="tseo-hl-text">
                      We Make Sure They Find You.
                    </span>
                  </h2>
                  <p className="tseo-lead">
                    When a homeowner needs their house cleaned, the first thing
                    they do is search &ldquo;house cleaning near me&rdquo; and
                    ...
                    spent years mastering for residential cleaning companies.
                  </p>
                  <p className="tseo-lead">
                    ...
                    around the searches your clients actually type. Every
                    ranking signal Google rewards, done properly and done
                    monthly — that is how our clients turn local searches into
                    calls, booked cleanings, and recurring clients that compound
                    month after month.
                  </p>
            ...
            <div className="tseo-container">
              <div className="tseo-sec-head">
                <div>
                  ...
                  <h2 className="tseo-h2">
                    Everything Your House Cleaning Rankings Need, in One System
                  </h2>
                </div>
            ...
            <div className="tseo-band-grid">
              <div className="tseo-band-content">
                ...
                <p className="tseo-lead">
                  ...
                  booking calls, and that is exactly where we specialize. Every
                  campaign is built around one goal: earning your business those
                  top spots for the cleaning services and cities that pay you
                ...
                <p className="tseo-lead">
                  ...
                  Google exactly which cleaning services you offer, consistent
              ...
              <div className="tseo-mappack" aria-hidden="true">
                ...
                <div className="tseo-mappack-list">
                  ...
                  <div className="tseo-mappack-row">
                    ...
                    <span className="tseo-mappack-info">
                      <strong>Competitor Maid Service</strong>
                      <span className="tseo-mappack-stars">
                        <FaStar />
                        4.6 (98) · House cleaning
                      </span>
                    </span>
                  </div>
                  <div className="tseo-mappack-row">
                    ...
                    <span className="tseo-mappack-info">
                      <strong>Competitor Cleaners Co.</strong>
                      <span className="tseo-mappack-stars">
                        <FaStar />
                        4.4 (61) · House cleaning
                      </span>
                    </span>
                  </div>
                </div>
            ...
            <div className="tseo-container">
              ...
              <div className="tseo-bento">
                ...
                <article className="tseo-bento-card tseo-bento-card--s1">
                  ...
                  <h3>Free House Cleaning Visibility Audit</h3>
                  <p>
                    We audit your rankings, profile, citations, reviews, and
                    competitors — and show you exactly where the cleaning clients
                    you are missing are booking instead.
                  </p>
                ...
                <article className="tseo-bento-card tseo-bento-card--s4">
                  <div className="tseo-bento-s4-copy">
                    ...
                    <p>
                      Monthly reporting tied to calls and booked cleanings, not
          ...
          <section className="tseo-results">
            <div className="tseo-container">
              <div className="tseo-sec-head-center">
                ...
                <h2 className="tseo-h2">
                  What Happens When House Cleaning SEO is Done Properly
                </h2>
                <p className="tseo-lead">
                  Different markets, different services — the same system,
                  executed month after month, often paired with a <Link href="/services/residential-cleaning-website-design" className="tseo-inline-link">house cleaning website design</Link> that turns the extra traffic into booked cleanings.
                </p>
              </div>
          ...
          <section className="tseo-compare">
            <div className="tseo-container">
              <div className="tseo-sec-head-center">
                ...
                <h2 className="tseo-h2">
                  What You Get with Zonic Vs. A Typical Cleaning SEO Agency
                </h2>
                <p className="tseo-lead">
                  Local SEO for home-service businesses is all we do, and it
                  shows. Here is exactly what working with a dedicated <Link href="/services/cleaning-company-marketing-agency" className="tseo-inline-link">cleaning marketing agency</Link>
                  looks like.
                </p>
              </div>
              <div className="tseo-compare-grid">
                ...
                <div className="tseo-compare-col tseo-compare-col--us">
                  <h3>House Cleaning SEO with Zonic Media</h3>
                  <p className="tseo-compare-sub">
              ...
              <div className="tseo-tracking-grid">
                <div>
                  ...
                  <p className="tseo-lead">
                    ...
                    for the cleaning keywords that pay you, review growth
          ...
          <section className="tseo-why">
            <div className="tseo-container">
              <div className="tseo-sec-head-center">
                ...
                <h2 className="tseo-h2">
                  A House Cleaning Local SEO Partner, Not a Monthly Invoice
                </h2>
                <p className="tseo-lead">
              ...
              <div className="tseo-why-banner">
                <div className="tseo-why-banner-text">
                  <p className="tseo-eyebrow">Free House Cleaning SEO Audit</p>
                  ...
                  <p>
                    ...
                    the cleaning searches in your market. Free, and yours to keep
                    either way.
                  </p>
                ...
                <div className="tseo-audit-card" aria-hidden="true">
                  ...
                  <div className="tseo-audit-ring-wrap">
                    ...
                    <div className="tseo-audit-ring-info">
                      ...
                      <small>
                        Where our cleaning campaigns typically land after six
          ...
          <section className="tseo-nationwide">
            <div className="tseo-container">
              <div className="tseo-sec-head-center">
                ...
                <h2 className="tseo-h2">
                  Local SEO for House Cleaning Companies in Every Market in the
                  US
                </h2>
                <p className="tseo-lead">
                  From solo maid services to multi-crew cleaning brands, we run
            ...
            <div className="tseo-container">
              <div className="tseo-split-grid">
                <div>
                  ...
                  <h2 className="tseo-h2">
                    Straight Answers About House Cleaning Local SEO
                  </h2>
                  <p className="tseo-lead">
                    Pricing, timelines, guarantees, how SEO stacks up against <Link href="/services/google-ads" className="tseo-inline-link">Google Ads for cleaning companies</Link>, and what actually moves
                    cleaning rankings. If your question is not here, send it
            ...
            <div className="tseo-container">
              <div className="tseo-form-grid">
                <aside className="tseo-form-aside">
                  ...
                  <h2 className="tseo-h2">
                    Claim Your Free House Cleaning Local SEO Audit
                  </h2>
                  <p className="tseo-lead">
                    Tell us about your cleaning business and we will send a full
                    local visibility audit — rankings, profile, citations,
                    reviews — plus a flat-price growth plan to take you to the
                    top of your market and book more recurring clients.
                  </p>
                ...
                <div className="tseo-form-main">
                  <ServiceLeadForm
                    formType="local-seo"
                    badge="Free Audit"
                    title="Get Your Free House Cleaning SEO Audit"
                    subtitle="No contracts, no pressure — just a clear picture of where your cleaning company stands and what it takes to book more clients in your market."
                    submitText="Send My Free Audit"
                    messageLabel="Tell us about your cleaning business"
