...
export const metadata: Metadata = {
  ...
  description:
    "Residential cleaning SEO that wins the Google map pack for 'house cleaning near me' and 'maid service near me' — profile, reviews & pages that book more clients. Free audit.",
  keywords: [
