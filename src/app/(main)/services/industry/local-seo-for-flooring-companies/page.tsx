/*
 * LOCAL SEO FOR FLOORING COMPANIES — built on the approved local SEO template
 ...
 * flooring-specific. Form leads submit as service "Local SEO" (on the API
 * whitelist).
 */
...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    title: "Local SEO for Flooring Companies That Wins Jobs | Zonic Media",
    description:
      "Local SEO for flooring companies that wins the map pack — profile optimization, citations, reviews, and service-area pages that turn flooring searches into booked estimates.",
    url: PAGE_PATH,
    type: "website",
  },
};
...
const breadcrumbJsonLd = buildBreadcrumbJsonLd([
  ...
  { name: "Local SEO for Flooring Companies", url: PAGE_PATH },
]);
...
const serviceJsonLd = {
  ...
  "@type": "Service",
  name: "Local SEO for Flooring Companies",
  serviceType: "Local Search Engine Optimization for Flooring Contractors",
  url: `${SITE_URL}${PAGE_PATH}`,
  description:
    "Local SEO for flooring companies covering Google Business Profile optimization, citation building, review growth, on-page SEO, and service-area content — built to rank flooring installers in the Google map pack and grow booked estimates.",
  provider: {
    "@type": "Organization",
  ...
  audience: {
    ...
    name: "Flooring companies, flooring installers, hardwood, tile, and vinyl plank contractors",
  },
  hasOfferCatalog: {
    "@type": "OfferCatalog",
    name: "Flooring Local SEO Services",
    itemListElement: [
      {
        "@type": "Offer",
        itemOffered: {
          "@type": "Service",
          name: "Google Business Profile Optimization for Flooring",
        },
      },
      {
        "@type": "Offer",
        itemOffered: {
          "@type": "Service",
          name: "Flooring Keyword & Competitor Research",
        },
      },
      {
        "@type": "Offer",
...
const flooringSeoFaqJsonLd = {
  "@context": "https://schema.org",
  "@type": "FAQPage",
  url: `${SITE_URL}${PAGE_PATH}`,
  mainEntity: FlooringSeoFaqs.map((faq) => ({
    "@type": "Question",
    name: faq.question,
    acceptedAnswer: {
      "@type": "Answer",
...
const BannerChecks = [
  "Your flooring map pack growth plan",
...
const ServiceCards = [
  {
    ...
    desc: (
      <>
        ...
        field, flooring category, project photo, and post — the same system
        behind our{" "}
        <Link href="/local-seo-google-business-optimization" className="tseo-inline-link">
          GBP optimization service
        </Link>{" "}
        — so Google trusts it and homeowners choose you for their estimate.
      </>
    ),
  },
  {
    icon: <FiSearch aria-hidden="true" />,
    title: "Flooring Keyword & Competitor Research",
    desc: "We map every search your customers actually type — flooring installer near me, hardwood flooring, tile installation, laminate and vinyl plank — city by city, and build the exact strategy that wins those searches for you.",
  },
  {
    icon: <FiLink2 aria-hidden="true" />,
    title: "Citations & Listing Management",
    desc: "Consistent name, address, and phone across every directory that matters — including the flooring and contractor listings Google checks. We fix the wrong ones, build the missing ones, and keep them synced.",
  },
  {
    icon: <FiStar aria-hidden="true" />,
    title: "Review Growth & Reputation",
    desc: "A steady stream of real reviews from real homeowners, with responses that show Google — and the next customer comparing flooring companies — that somebody is home and the installs are worth trusting.",
  },
  {
    ...
    desc: (
      <>
        Service and city pages built around real flooring searches, with schema
...
const ResultCards = [
  {
    ...
    industry: "Hardwood Flooring Co.",
    metric: "+212%",
    label: "Calls from Google Business Profile",
    desc: "From page-two invisibility to top-three map pack rankings for 'flooring installer near me' across every service city within a few months.",
  },
  {
    ...
    desc: "A profile rebuild, citation cleanup, and review growth took the company from #13 to the top three for tile installation searches across the metro.",
  },
  {
    icon: <FiTrendingUp aria-hidden="true" />,
    ...
    desc: "Service-area and city pages turned scattered residential and commercial demand into a steady, year-round flooring pipeline.",
  },
];
...
const RankRows = [
  { kw: "flooring installer near me", pos: "#1", delta: "▲ 5" },
  { kw: "hardwood flooring [city]", pos: "#2", delta: "▲ 7" },
  { kw: "tile installation near me", pos: "#1", delta: "▲ 4" },
  { kw: "laminate flooring near me", pos: "#3", delta: "▲ 8" },
];
...
const CompareThem = [
  ...
  "Reports full of impressions, empty of estimate calls",
...
const CompareUs = [
  "Profile worked weekly — posts, project photos, Q&A, flooring categories",
  "Reporting tied to calls, direction requests, and booked estimates",
  "Hand-built citations and local links that compound",
  "A dedicated strategist who knows your flooring market",
...
const GrowCards = [
  {
    ...
    icon: <MdOutlineVerifiedUser aria-hidden="true" />,
    title: "Google Business Profile Optimization",
    desc: "Most homeowners pick a flooring company straight from the map pack. We optimize your profile so that company is you.",
  ...
  },
  {
    ...
    desc: "Ready to convert more of your traffic? Conversion-first flooring websites that turn visitors into booked measures and estimates.",
  ...
  },
  {
    ...
    desc: "Pair organic rankings with paid coverage and own the whole results page during peak remodeling and flooring demand.",
    cta: "See Google Ads",
  },
];
    ...
    <>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify(flooringSeoFaqJsonLd),
        }}
      />
              ...
              <div className="tseo-hero-grid">
                <div className="tseo-hero-copy">
                  ...
                  <p className="tseo-hero-sub">
                    ...
                    content — so when homeowners search &ldquo;flooring installer
                ...
                <div className="tseo-hero-visual">
                  ...
                  <div className="tseo-hero-dash" aria-hidden="true">
                    <div className="tseo-dash-head">
                      <div className="tseo-dash-title">Flooring Local SEO Performance</div>
                    </div>
                        ...
                        <div className="tseo-dash-body">
                          <div className="tseo-dash-list">
                            <p className="tseo-dash-sub">
                              Map pack · &ldquo;flooring installer near me&rdquo;
                            </p>
                            <div className="tseo-dash-li tseo-dash-li--you">
                              <FiMapPin />
                              <span>Your Flooring Company</span>
                              <em>#1</em>
                            </div>
                            <div className="tseo-dash-li">
                              <FiMapPin />
                              <span>Competitor Floors &amp; Tile</span>
                              <em>#2</em>
                            </div>
                            <div className="tseo-dash-li">
                              <FiMapPin />
                              <span>Competitor Hardwood</span>
                              <em>#3</em>
                            </div>
                      ...
                      <div className="tseo-ba-panel tseo-ba-panel--before">
                        <div className="tseo-dash-body">
                          <div className="tseo-dash-list">
                            ...
                            <div className="tseo-dash-li">
                              <FiMapPin />
                              <span>Competitor Carpet Co.</span>
                              <em>#3</em>
                            </div>
                  ...
                  <div className="tseo-hero-floats">
                    <div className="tseo-float-card">
                      ...
                      <p>
                        ...
                        &ldquo;flooring installer near me&rdquo;
                      </p>
                    </div>
                    <div className="tseo-float-card">
              ...
              <div className="tseo-problem-grid">
                <div className="tseo-gbp-wrap" aria-hidden="true">
                  <div className="tseo-gbp">
                    ...
                    <p className="tseo-gbp-meta">
                      Flooring contractor · <em>Open now</em> · Free measure &amp; quote
                    </p>
                ...
                <div>
                  ...
                  <p className="tseo-lead">
                    When a homeowner is ready to replace worn carpet or install
                    new hardwood, the first thing they do is search
                    &ldquo;flooring company near me&rdquo; and call one of the top
                    three companies on the map for an estimate. That is an
                    enormous, high-intent growth channel sitting right in front
                    of your business — and it is exactly the channel we have
                    spent years mastering for flooring contractors.
                  </p>
                  <p className="tseo-lead">
                    ...
                    calls, booked estimates, and revenue that compounds month
                    after month.
                  </p>
            ...
            <div className="tseo-band-grid">
              <div className="tseo-band-content">
                ...
                <p className="tseo-lead">
                  ...
                  top spots for the flooring services and cities that pay you
                ...
                <p className="tseo-lead">
                  ...
                  Google exactly which flooring services you offer — hardwood,
                  tile, laminate, vinyl plank — consistent citations confirm you
                ...
                <div className="tseo-mappack-list">
                  ...
                  <div className="tseo-mappack-row tseo-mappack-row--you">
                    ...
                    <span className="tseo-mappack-info">
                      <strong>Your Flooring Company</strong>
                      <span className="tseo-mappack-stars">
                        <FaStar />
                        4.9 (176) · Flooring contractor ·{" "}
                  ...
                  <div className="tseo-mappack-row">
                    ...
                    <span className="tseo-mappack-info">
                      <strong>Competitor Floors &amp; Tile</strong>
                      <span className="tseo-mappack-stars">
                        <FaStar />
                        4.6 (98) · Flooring contractor
                      </span>
                    </span>
                  </div>
                  <div className="tseo-mappack-row">
                    ...
                    <span className="tseo-mappack-info">
                      <strong>Competitor Hardwood Co.</strong>
                      <span className="tseo-mappack-stars">
                        <FaStar />
                        4.4 (61) · Flooring contractor
                      </span>
                    </span>
                  </div>
                </div>
              ...
              <div className="tseo-bento">
                ...
                <article className="tseo-bento-card tseo-bento-card--s1">
                  ...
                  <div className="tseo-bento-visual" aria-hidden="true">
                    <p className="tseo-bento-visual-title">
                      Where flooring clients typically land after 90 days
                    </p>
                    {[
                ...
                <article className="tseo-bento-card tseo-bento-card--s3">
                  ...
                  <p>
                    ...
                    keep you there season after season.
                  </p>
                ...
                <article className="tseo-bento-card tseo-bento-card--s4">
                  <div className="tseo-bento-s4-copy">
                    ...
                    <p>
                      ...
                      flooring services and more cities.
                    </p>
                  </div>
            ...
            <div className="tseo-container">
              ...
              <div className="tseo-compare-grid">
                ...
                <div className="tseo-compare-col tseo-compare-col--us">
                  <h3>Flooring Local SEO with Zonic Media</h3>
                  <p className="tseo-compare-sub">
                ...
                >
                  ...
                  <p className="tseo-compare-sub">
                    A typical flooring client&apos;s first six months
                  </p>
              ...
              <div className="tseo-tracking-grid">
                <div>
                  ...
                  <p className="tseo-lead">
                    ...
                    for the flooring keywords that pay you, review growth
              ...
              <div className="tseo-why-banner">
                <div className="tseo-why-banner-text">
                  ...
                  <p>
                    ...
                    the flooring searches in your market. Free, and yours to keep
                    either way.
                  </p>
                ...
                <div className="tseo-audit-card" aria-hidden="true">
                  ...
                  <div className="tseo-audit-ring-wrap">
                    ...
                    <div className="tseo-audit-ring-info">
                      ...
                      <small>
                        Where our flooring campaigns typically land after six
      ...
      <RelatedServices current="/services/industry/local-seo-for-flooring-companies" />
      <Footer />
    </>
  );
}
