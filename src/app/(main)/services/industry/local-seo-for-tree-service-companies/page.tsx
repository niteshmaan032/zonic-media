/*
 * LOCAL SEO FOR TREE SERVICE COMPANIES — built on the approved local SEO
 ...
 * schema are tree-service-specific. Form leads submit as service "Local SEO"
...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    title: "Local SEO for Tree Service Companies | Zonic Media",
    description:
      "Local SEO for tree service companies that win the Google map pack — profile optimization, reviews, and service-area pages that turn 'tree service near me' searches into booked jobs.",
    url: PAGE_PATH,
    type: "website",
  },
};
...
const breadcrumbJsonLd = buildBreadcrumbJsonLd([
  ...
  { name: "Local SEO for Tree Service Companies", url: PAGE_PATH },
]);
...
const serviceJsonLd = {
  ...
  "@type": "Service",
  name: "Local SEO for Tree Service Companies",
  serviceType: "Local Search Engine Optimization for Tree Service Companies",
  url: `${SITE_URL}${PAGE_PATH}`,
  description:
    "Local SEO for tree service companies covering Google Business Profile optimization, citation building, review growth, on-page SEO, and service-area content — built to rank tree removal, trimming, and stump grinding businesses in the Google map pack and grow booked jobs.",
  provider: {
    "@type": "Organization",
  ...
  audience: {
    ...
    name: "Tree service companies, arborists, tree removal and trimming businesses",
  },
  hasOfferCatalog: {
    "@type": "OfferCatalog",
    name: "Tree Service Local SEO Services",
    itemListElement: [
      {
        "@type": "Offer",
        itemOffered: {
          "@type": "Service",
          name: "Google Business Profile Optimization for Tree Service",
        },
      },
      {
        "@type": "Offer",
        itemOffered: {
          "@type": "Service",
          name: "Tree Service Keyword & Competitor Research",
        },
      },
      {
        "@type": "Offer",
...
const TreeSeoFaqs = [
  {
    question: "What's Included in Your Tree Service Local SEO?",
    answer:
      "Every tree service campaign covers the full local ranking system: Google Business Profile optimization, citation building and cleanup, review growth, on-page SEO for your tree removal, trimming, and stump grinding pages, local content, and a monthly report that shows rankings, calls, and booked estimates — not vanity metrics.",
  },
  {
    question: "How Long Does Tree Service SEO Take to Show Results?",
    answer:
      "Most tree service companies see measurable movement within 60 to 90 days — better map pack visibility, more profile actions, and more calls for searches like 'tree service near me' and 'tree removal near me.' Competitive markets take longer to fully dominate, but the trajectory is visible from the first monthly report, and momentum compounds ahead of storm and peak trimming seasons.",
  },
  {
    question: "How Much Does Local SEO for Tree Service Companies Cost?",
    answer:
      "Pricing depends on how many crews and cities you run, how competitive your market is, and how aggressively you want to grow. After a free audit we quote a flat monthly price — no long-term contracts and no surprise line items.",
  },
  {
    question: "Do You Guarantee First-Page Google Rankings for Tree Service Keywords?",
    answer:
      "Our track record speaks for itself — most tree service clients reach top-three map pack positions for their core keywords, and every campaign is built on the exact signals Google rewards. Because Google's results change daily, no agency can honestly promise a fixed position, so we guarantee what matters: full transparency. You see exactly where you rank, what improved, and what we did each month — and with no long-term contracts, we earn your business with results.",
  },
  {
    question: "Do Tree Service Companies Really Need Google Business Profile Optimization?",
    answer:
      "Yes — it is the single biggest lever in tree service local SEO. Your Google Business Profile decides whether you show up in the local map pack when a homeowner searches for tree removal or emergency tree help, and it drives your call volume, direction requests, and review visibility. We optimize every field, category, photo, and post so Google trusts your profile and homeowners choose it.",
  },
  {
    question: "Can You Handle Seasonal Spikes, Emergencies, and Multiple Service Areas?",
    answer:
      "Absolutely. We build local SEO systems for single-crew operators and multi-truck tree companies alike — service-area targeting, individual city pages, and map visibility for every neighborhood you cover. We tune profiles and content for storm cleanup and emergency tree service so you capture the surge when a big storm rolls through, all reported in one clear dashboard.",
  },
  {
...
const treeSeoFaqJsonLd = {
  "@context": "https://schema.org",
  "@type": "FAQPage",
  url: `${SITE_URL}${PAGE_PATH}`,
  mainEntity: TreeSeoFaqs.map((faq) => ({
    "@type": "Question",
    name: faq.question,
    acceptedAnswer: {
      "@type": "Answer",
...
const BannerChecks = [
  "Your tree service map pack growth plan",
...
const ServiceCards = [
  {
    ...
    desc: (
      <>
        ...
        field, tree service category, photo, and post — the same system behind
        our{" "}
  ...
  },
  {
    ...
    title: "Tree Service Keyword & Competitor Research",
    desc: "We map every search your customers actually type — tree removal, tree trimming, stump grinding, emergency tree service — city by city, and build the exact strategy that wins those searches for you.",
  },
  {
    icon: <FiLink2 aria-hidden="true" />,
    title: "Citations & Listing Management",
    desc: "Consistent name, address, and phone across every directory that matters — including the arborist and contractor listings Google checks. We fix the wrong ones, build the missing ones, and keep them synced.",
  },
  {
    icon: <FiStar aria-hidden="true" />,
    title: "Review Growth & Reputation",
    desc: "A steady stream of real reviews from real homeowners, with responses that show Google — and the next customer comparing tree companies — that somebody is home.",
  },
  {
    ...
    desc: (
      <>
        Service and city pages built around real tree service searches, with
...
const ResultCards = [
  {
    ...
    industry: "Tree Removal Co.",
    metric: "+212%",
    label: "Calls from Google Business Profile",
    desc: "From page-two invisibility to top-three map pack rankings for 'tree service near me' across every service city within one growing season.",
  },
  {
    icon: <RiSearchLine aria-hidden="true" />,
    industry: "Trimming & Arborist Care",
    metric: "Top 3",
    label: "Map pack for every core keyword",
    desc: "A profile rebuild, citation cleanup, and review growth took the company from #12 to the top three before peak trimming season.",
  },
  {
    icon: <FiTrendingUp aria-hidden="true" />,
    industry: "Storm & Emergency Tree",
    metric: "3.2×",
    label: "More booked jobs from local search",
    desc: "Service-area and city pages turned storm cleanup and emergency spikes into a steady, year-round tree service pipeline.",
  },
];
...
const RankRows = [
  { kw: "tree service near me", pos: "#1", delta: "▲ 5" },
  { kw: "tree removal [city]", pos: "#2", delta: "▲ 7" },
  { kw: "tree trimming near me", pos: "#1", delta: "▲ 4" },
  { kw: "stump grinding near me", pos: "#3", delta: "▲ 8" },
];
...
const CompareUs = [
  "Profile worked weekly — posts, photos, Q&A, tree service categories",
  "Reporting tied to calls, direction requests, and booked estimates",
  "Hand-built citations and local links that compound",
  "A dedicated strategist who knows your tree service market",
...
const WhyCards = [
  {
    ...
    desc: "We are not a generalist agency dabbling in maps. Local rankings, local calls, and booked jobs for tree service and home-service contractors is the entire practice.",
  },
  {
    icon: <FiZap aria-hidden="true" />,
    title: "Fast, Compounding Execution",
    desc: "Foundation fixes ship in the first weeks, not the first quarter — so you are stronger heading into storm and peak trimming demand. Every month of work stacks on the last.",
  },
  {
    icon: <MdOutlineVerifiedUser aria-hidden="true" />,
...
const MarqueeItems = [
  "Tree Service SEO",
  "Tree Removal Rankings",
  "Google Business Profile",
  "Map Pack Rankings",
  "Emergency Tree Leads",
  "Review Growth",
  "Service-Area Pages",
];
...
const GrowCards = [
  {
    ...
    icon: <MdOutlineVerifiedUser aria-hidden="true" />,
    title: "Google Business Profile Optimization",
    desc: "Most homeowners pick a tree service straight from the map pack. We optimize your profile so that company is you.",
  ...
  },
  {
    ...
    desc: "Ready to grow beyond local SEO? A fast, conversion-first tree service website that turns visitors into booked estimates.",
  ...
  },
  {
    ...
    desc: "Pair organic rankings with paid coverage and own the whole results page during storm surges and peak season.",
    cta: "See Google Ads",
  },
];
    ...
    <>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify(treeSeoFaqJsonLd),
        }}
      />
              ...
              <div className="tseo-hero-grid">
                <div className="tseo-hero-copy">
                  ...
                  <h1 className="tseo-hero-h1">
                    Local SEO for Tree Service That{" "}
                  ...
                  <p className="tseo-hero-sub">
                    ...
                    full local ranking system for tree service companies — Google
                    Business Profile, citations, reviews, and service-area
                    content — so when homeowners search &ldquo;tree service near
                  ...
                  <div className="tseo-hero-ctas">
                    <HashScrollLink
                      ...
                      offset={120}
                    >
                      Get Your Free Tree Service SEO Audit
                ...
                <div className="tseo-hero-visual">
                  ...
                  <div className="tseo-hero-dash" aria-hidden="true">
                    <div className="tseo-dash-head">
                      <div className="tseo-dash-title">Tree Service Local SEO Performance</div>
                    </div>
                        ...
                        <div className="tseo-dash-body">
                          <div className="tseo-dash-list">
                            <p className="tseo-dash-sub">
                              Map pack · &ldquo;tree service near me&rdquo;
                            </p>
                            <div className="tseo-dash-li tseo-dash-li--you">
                              <FiMapPin />
                              <span>Your Tree Service</span>
                              <em>#1</em>
                            </div>
                            <div className="tseo-dash-li">
                              <FiMapPin />
                              <span>Competitor Tree &amp; Arbor</span>
                              <em>#2</em>
                            </div>
                            <div className="tseo-dash-li">
                              <FiMapPin />
                              <span>Competitor Tree Care</span>
                              <em>#3</em>
                            </div>
                  ...
                  <div className="tseo-hero-floats">
                    <div className="tseo-float-card">
                      ...
                      <p>
                        ...
                        &ldquo;tree service near me&rdquo;
                      </p>
                    </div>
                    <div className="tseo-float-card">
              ...
              <div className="tseo-problem-grid">
                <div className="tseo-gbp-wrap" aria-hidden="true">
                  <div className="tseo-gbp">
                    ...
                    <p className="tseo-gbp-meta">
                      Tree service · <em>Open now</em> · Free estimates · 24/7
                      emergency
                    </p>
                ...
                <div>
                  ...
                  <h2 className="tseo-h2">
                    Homeowners are Searching for Tree Help.{" "}
                    <span className="tseo-hl-text">
                      We Make Sure They Find You.
                    </span>
                  </h2>
                  <p className="tseo-lead">
                    When a storm drops a limb or a dying tree threatens the
                    house, the first thing homeowners do is search &ldquo;tree
                    service near me&rdquo; and call one of the top three
                    companies on the map. That is an enormous, high-intent growth
                    channel sitting right in front of your business — and it is
                    exactly the channel we have spent years mastering for tree
                    service companies.
                  </p>
                  <p className="tseo-lead">
            ...
            <div className="tseo-container">
              <div className="tseo-sec-head">
                <div>
                  ...
                  <h2 className="tseo-h2">
                    Everything Your Tree Service Rankings Need, in One System
                  </h2>
                </div>
          ...
          <section className="tseo-band">
            <div className="tseo-band-grid">
              <div className="tseo-band-content">
                ...
                <h2 className="tseo-h2">
                  We Put Your Tree Service in the Top Three — And Keep It There
                </h2>
                <p className="tseo-lead">
                  ...
                  top spots for the tree services and cities that pay you best,
                ...
                <p className="tseo-lead">
                  ...
                  Google exactly which tree services you offer, consistent
                ...
                <div className="tseo-mappack-list">
                  ...
                  <div className="tseo-mappack-row tseo-mappack-row--you">
                    ...
                    <span className="tseo-mappack-info">
                      <strong>Your Tree Service</strong>
                      <span className="tseo-mappack-stars">
                        <FaStar />
                        4.9 (176) · Tree service ·{" "}
                  ...
                  <div className="tseo-mappack-row">
                    ...
                    <span className="tseo-mappack-info">
                      <strong>Competitor Tree &amp; Arbor</strong>
                      <span className="tseo-mappack-stars">
                        <FaStar />
                        4.6 (98) · Tree service
                      </span>
                  ...
                  <div className="tseo-mappack-row">
                    ...
                    <span className="tseo-mappack-info">
                      <strong>Competitor Tree Care Co.</strong>
                      <span className="tseo-mappack-stars">
                        <FaStar />
                        4.4 (61) · Tree service
                      </span>
            ...
            <div className="tseo-container">
              ...
              <div className="tseo-bento">
                ...
                <article className="tseo-bento-card tseo-bento-card--s1">
                  ...
                  <h3>Free Tree Service Visibility Audit</h3>
                  <p>
                    We audit your rankings, profile, citations, reviews, and
                    competitors — and show you exactly where the tree removal and
                    trimming calls you are missing are going instead.
                  </p>
                  <div className="tseo-bento-visual" aria-hidden="true">
                    <p className="tseo-bento-visual-title">
                      Where tree service clients typically land after 90 days
                    </p>
                    {[
                ...
                <article className="tseo-bento-card tseo-bento-card--s2">
                  ...
                  <p>
                    A keyword-mapped plan for your tree services and cities, then
                ...
                <article className="tseo-bento-card tseo-bento-card--s4">
                  <div className="tseo-bento-s4-copy">
                    ...
                    <p>
                      ...
                      vanity metrics. As rankings lock in, we expand to more tree
          ...
          <section className="tseo-results">
            <div className="tseo-container">
              <div className="tseo-sec-head-center">
                ...
                <h2 className="tseo-h2">
                  What Happens When Tree Service Local SEO is Done Properly
                </h2>
                <p className="tseo-lead">
                  Different markets, different seasons — the same system,
                  executed month after month, and often a <Link href="/services/tree-service-website-design" className="tseo-inline-link">tree service website design</Link> that converts that traffic into booked jobs.
                </p>
              </div>
          ...
          <section className="tseo-compare">
            <div className="tseo-container">
              <div className="tseo-sec-head-center">
                ...
                <h2 className="tseo-h2">
                  What You Get with Zonic Vs. A Typical Tree Service SEO Agency
                </h2>
                <p className="tseo-lead">
                  Local SEO for home-service businesses is all we do, and it
                  shows. Here is exactly what working with a dedicated <Link href="/services/tree-service-marketing-agency" className="tseo-inline-link">tree service marketing agency</Link>
                  looks like.
                </p>
              </div>
              <div className="tseo-compare-grid">
                <div className="tseo-compare-col tseo-compare-col--them">
                  ...
                  <p className="tseo-compare-sub">
                    Why most tree service campaigns quietly stall
                  </p>
                  <ul>
                ...
                <div className="tseo-compare-col tseo-compare-col--us">
                  <h3>Tree Service Local SEO with Zonic Media</h3>
                  <p className="tseo-compare-sub">
                ...
                >
                  ...
                  <p className="tseo-compare-sub">
                    A typical tree service client&apos;s first six months
                  </p>
            ...
            <div className="tseo-container">
              <div className="tseo-tracking-grid">
                <div>
                  ...
                  <h2 className="tseo-h2">
                    Watch Your Tree Service Rankings and Reviews Climb,{" "}
                    <span className="tseo-hl-text">Month over Month</span>
                  </h2>
                  <p className="tseo-lead">
                    No black box. Every campaign comes with live rank tracking
                    for the tree service keywords that pay you, review growth
          ...
          <section className="tseo-why">
            <div className="tseo-container">
              <div className="tseo-sec-head-center">
                ...
                <h2 className="tseo-h2">
                  A Tree Service Local SEO Partner, Not a Monthly Invoice
                </h2>
                <p className="tseo-lead">
              ...
              <div className="tseo-why-banner">
                <div className="tseo-why-banner-text">
                  <p className="tseo-eyebrow">Free Tree Service SEO Audit</p>
                  <h3>
                    See Exactly How We&apos;ll Grow Your Tree Service Rankings
                  </h3>
                  <p>
                    We&apos;ll map your profile, citations, reviews, and
                    rankings — and show you the clear path to the top three for
                    the tree service searches in your market. Free, and yours to
                    keep either way.
                  </p>
                ...
                <div className="tseo-audit-card" aria-hidden="true">
                  ...
                  <div className="tseo-audit-ring-wrap">
                    ...
                    <div className="tseo-audit-ring-info">
                      ...
                      <small>
                        Where our tree service campaigns typically land after six
          ...
          <section className="tseo-nationwide">
            <div className="tseo-container">
              <div className="tseo-sec-head-center">
                ...
                <h2 className="tseo-h2">
                  Local SEO for Tree Service Companies in Every Market in the US
                </h2>
                <p className="tseo-lead">
                  From single-crew operators to multi-truck tree companies, we
            ...
            <div className="tseo-container">
              <div className="tseo-split-grid">
                <div>
                  ...
                  <h2 className="tseo-h2">
                    Straight Answers About Tree Service Local SEO
                  </h2>
                  <p className="tseo-lead">
                    Pricing, timelines, guarantees, how SEO stacks up against <Link href="/services/google-ads" className="tseo-inline-link">Google Ads for tree services</Link>, and what actually moves tree
            ...
            <div className="tseo-container">
              <div className="tseo-form-grid">
                <aside className="tseo-form-aside">
                  ...
                  <h2 className="tseo-h2">
                    Claim Your Free Tree Service Local SEO Audit
                  </h2>
                  <p className="tseo-lead">
                    Tell us about your tree service business and we will send a
                ...
                <div className="tseo-form-main">
                  <ServiceLeadForm
                    formType="local-seo"
                    badge="Free Audit"
                    title="Get Your Free Tree Service SEO Audit"
                    subtitle="No contracts, no pressure — just a clear picture of where your tree service company stands and what it takes to win your market."
                    submitText="Send My Free Audit"
                    messageLabel="Tell us about your tree service business"
      ...
      <RelatedServices current="/services/industry/local-seo-for-tree-service-companies" />
      <Footer />
    </>
  );
}
