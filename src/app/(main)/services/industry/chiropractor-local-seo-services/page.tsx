/*
 * LOCAL SEO FOR CHIROPRACTORS — revamped July 2026 onto the approved local SEO
 ...
 * schema are chiropractic-specific and patient-focused. Form leads submit as
 * service "Local SEO" (on the API whitelist).
 *
 * ==========================================================================
 * OLD IMPLEMENTATION — kept commented for reference during the revamp.
 * The prior page was a two-file setup: this page.tsx rendered a client
 * component <ChiroDigitalPage /> (car-tow / phila layout). Its imports were:
 *
 * import type { Metadata } from "next";
 * import ChiroDigitalPage from "./ChiroDigitalPage";
 * import { buildBreadcrumbJsonLd } from "@/shared/seoSchemas";
 *
 * ChiroDigitalPage.tsx imported:
 ...
 * (react-icons: FaMapMarkerAlt, FaGlobe, FaStar, FaUserInjured, FaChartLine,
 *  FaBullhorn, FaCalendarCheck, FaPhoneAlt, FaCheckCircle, FaTimesCircle,
 *  FaSearch, FaUsers, FaShieldAlt, FaBolt, FaExclamationTriangle, FaHandshake,
 *  FaRegClock, FaLaptopCode, FaArrowRight, FaSyncAlt, FaArrowTrendUp,
 *  FaRegCircleCheck, FaPhoneVolume, FaRankingStar, FaRoute, FiPhoneCall,
 *  FiArrowUpRight, MdOutlineLocationOn.)
 *
 * OLD FAQ array (faqs): "What does a chiropractor digital marketing agency
 * do?"; "How can digital marketing help my chiropractic clinic?"; "How long
 * does chiropractor SEO take to work?"; "Do I need a website for chiropractic
 * marketing?"; "Is SEO better than paid ads for chiropractors?"; "Can you help
 * my clinic rank on Google Maps?"; "What makes Zonic Media different from other
 * chiropractic marketing agencies?"; "How do I get started?".
 *
 * Old data arrays: marqueeTerms, problemCards, journeySteps, journeyChecklist,
 * systemCards, beforePoints, afterPoints, caseStudyStats, benefitCards,
 * seoPoints, adsPoints, whyCards, processSteps, philaContactFormHead.
 *
 * Full prior JSX preserved in git history. Replaced wholesale by the template
 * layout below. Old ChiroDigitalPage.tsx is now orphaned (no longer imported).
 */
...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    title: "Local SEO for Chiropractors That Books Patients | Zonic Media",
    description:
      "Local SEO for chiropractors that wins the Google map pack — profile optimization, reviews, and service pages that turn 'chiropractor near me' searches into booked patients.",
    url: PAGE_PATH,
    type: "website",
  },
};
...
const breadcrumbJsonLd = buildBreadcrumbJsonLd([
  ...
  { name: "Chiropractor Local SEO", url: PAGE_PATH },
]);
...
const serviceJsonLd = {
  ...
  "@type": "Service",
  name: "Local SEO for Chiropractors",
  serviceType: "Local Search Engine Optimization for Chiropractic Clinics",
  ...
  audience: {
    ...
    name: "Chiropractors, chiropractic clinics, spinal and sports injury practices",
  },
  hasOfferCatalog: {
    "@type": "OfferCatalog",
    name: "Chiropractor Local SEO Services",
    itemListElement: [
      {
        "@type": "Offer",
        itemOffered: {
          "@type": "Service",
          name: "Google Business Profile Optimization for Chiropractors",
        },
      },
      {
        "@type": "Offer",
        itemOffered: {
          "@type": "Service",
          name: "Chiropractic Keyword & Competitor Research",
        },
      },
      {
        "@type": "Offer",
...
const ChiroSeoFaqs = [
  {
    question: "What's Included in Your Local SEO for Chiropractors?",
    answer:
      "Every chiropractic campaign covers the full local ranking system: Google Business Profile optimization, citation building and cleanup, review growth, on-page SEO for your treatment and service-area pages, local content, and a monthly report that shows rankings, calls, and booked patients — not vanity metrics.",
  },
  {
    question: "How Long Does Chiropractor SEO Take to Show Results?",
    answer:
      "Most chiropractic clinics see measurable movement within 60 to 90 days — better map pack visibility, more profile actions, and more calls for searches like 'chiropractor near me' and 'back pain relief.' Competitive markets take longer to fully dominate, but the trajectory is visible from the first monthly report, and momentum compounds every month.",
  },
  {
    question: "How Much Does Local SEO for Chiropractors Cost?",
    answer:
      "Pricing depends on how many locations you run, how competitive your market is, and how aggressively you want to grow your patient base. After a free audit we quote a flat monthly price — no long-term contracts and no surprise line items.",
  },
  {
    question: "Do You Guarantee First-Page Google Rankings for Chiropractic Keywords?",
    answer:
      "Our track record speaks for itself — most chiropractic clients reach top-three map pack positions for their core keywords, and every campaign is built on the exact signals Google rewards. Because Google's results change daily, no agency can honestly promise a fixed position, so we guarantee what matters: full transparency. You see exactly where you rank, what improved, and what we did each month — and with no long-term contracts, we earn your business with results.",
  },
  {
    question: "Do Chiropractors Really Need Google Business Profile Optimization?",
    answer:
      "Yes — it is the single biggest lever in chiropractic local SEO. Your Google Business Profile decides whether you show up in the local map pack when someone searches for a chiropractor near them, and it drives your call volume, direction requests, and review visibility. We optimize every field, category, photo, and post so Google trusts your profile and new patients choose your clinic.",
  },
  {
    question: "Can You Help Multi-Location Chiropractic Clinics?",
    answer:
      "Absolutely. We build local SEO systems for solo practitioners and multi-location chiropractic groups alike — service-area targeting, individual location pages, and map visibility for every city and neighborhood you serve, all reported in one clear dashboard.",
  },
  {
...
const chiroSeoFaqJsonLd = {
  "@context": "https://schema.org",
  "@type": "FAQPage",
  url: `${SITE_URL}${PAGE_PATH}`,
  mainEntity: ChiroSeoFaqs.map((faq) => ({
    "@type": "Question",
    name: faq.question,
    acceptedAnswer: {
      "@type": "Answer",
...
const HeroStats = [
  {
    ...
    num: "50+",
    label: "Local & appointment-based businesses ranked",
  },
  {
...
const BannerChecks = [
  "Your chiropractic map pack growth plan",
...
const ServiceCards = [
  ...
  },
  {
    ...
    title: "Chiropractic Keyword & Competitor Research",
    desc: "We map every search your patients actually type — chiropractor near me, back pain relief, spinal adjustment, sports injury chiropractor — city by city, and build the exact strategy that wins those searches for your clinic.",
  },
  {
    icon: <FiLink2 aria-hidden="true" />,
    title: "Citations & Listing Management",
    desc: "Consistent name, address, and phone across every directory that matters — including the health and clinic listings Google checks. We fix the wrong ones, build the missing ones, and keep them synced.",
  },
  {
    icon: <FiStar aria-hidden="true" />,
    title: "Review Growth & Reputation",
    desc: "A steady stream of real reviews from real patients, with responses that show Google — and the next person comparing chiropractors — that your clinic is trusted and active.",
  },
  {
    ...
    desc: (
      <>
        Treatment and city pages built around real chiropractic searches, with
  ...
  },
  {
    ...
    desc: "Rankings, calls, direction requests, and new-patient leads in one plain-English report. You always know what we did, what moved, and what is next.",
  },
];
...
const ResultCards = [
  {
    ...
    industry: "Family Chiropractic",
    metric: "+212%",
    label: "New-patient calls from Google Business Profile",
    desc: "From page-two invisibility to top-three map pack rankings for 'chiropractor near me' across every service city within one quarter.",
  },
  {
    icon: <RiSearchLine aria-hidden="true" />,
    industry: "Sports & Rehab Clinic",
    metric: "Top 3",
    label: "Map pack for every core keyword",
    desc: "A profile rebuild, citation cleanup, and review growth took the clinic from #13 to the top three for sports injury and back pain searches.",
  },
  {
    icon: <FiTrendingUp aria-hidden="true" />,
    industry: "Multi-Location Clinic",
    metric: "3.2×",
    label: "More booked patients from local search",
    desc: "Treatment and city pages turned scattered referral traffic into a steady, year-round flow of new-patient appointments.",
  },
];
...
const RankRows = [
  { kw: "chiropractor near me", pos: "#1", delta: "▲ 5" },
  { kw: "back pain relief [city]", pos: "#2", delta: "▲ 7" },
  { kw: "sports injury chiropractor", pos: "#1", delta: "▲ 4" },
  { kw: "spinal adjustment", pos: "#3", delta: "▲ 8" },
];
...
const CompareUs = [
  "Profile worked weekly — posts, photos, Q&A, chiropractic categories",
  "Reporting tied to calls, direction requests, and booked patients",
  "Hand-built citations and local links that compound",
  "A dedicated strategist who knows your chiropractic market",
...
const WhyCards = [
  {
    icon: <RiSearchLine aria-hidden="true" />,
    title: "Appointment-Based Local is All We Do",
    desc: "We are not a generalist agency dabbling in maps. Local rankings, local calls, and booked patients for chiropractic and health clinics is the entire practice.",
  },
  {
    icon: <FiZap aria-hidden="true" />,
    title: "Fast, Compounding Execution",
    desc: "Foundation fixes ship in the first weeks, not the first quarter — so patients start finding you sooner. Every month of work stacks on the last.",
  },
  {
    icon: <MdOutlineVerifiedUser aria-hidden="true" />,
...
const GrowCards = [
  ...
  },
  {
    ...
    desc: "Ready to turn more visitors into booked patients? A fast, mobile-first site with clear service pages and easy appointment CTAs.",
    cta: "See web design",
  },
  {
    ...
    desc: "Pair organic rankings with paid coverage and own the whole results page for high-intent chiropractic searches.",
    cta: "See Google Ads",
  },
];
    ...
    <>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify(chiroSeoFaqJsonLd),
        }}
      />
                ...
                <div className="tseo-hero-visual">
                  ...
                  <div className="tseo-hero-dash" aria-hidden="true">
                    <div className="tseo-dash-head">
                      <div className="tseo-dash-title">Chiropractic Local SEO Performance</div>
                    </div>
                        ...
                        <div className="tseo-dash-body">
                          <div className="tseo-dash-list">
                            <p className="tseo-dash-sub">
                              Map pack · &ldquo;chiropractor near me&rdquo;
                            </p>
                            <div className="tseo-dash-li tseo-dash-li--you">
                              <FiMapPin />
                              <span>Your Chiropractic Clinic</span>
                              <em>#1</em>
                            </div>
                            <div className="tseo-dash-li">
                              <FiMapPin />
                              <span>Competitor Spine &amp; Wellness</span>
                              <em>#2</em>
                            </div>
                            <div className="tseo-dash-li">
                              <FiMapPin />
                              <span>Competitor Chiropractic</span>
                              <em>#3</em>
                            </div>
                      ...
                      <div className="tseo-ba-panel tseo-ba-panel--before">
                        <div className="tseo-dash-body">
                          <div className="tseo-dash-list">
                            ...
                            <div className="tseo-dash-li">
                              <FiMapPin />
                              <span>Competitor Family Care</span>
                              <em>#3</em>
                            </div>
                  ...
                  <div className="tseo-hero-floats">
                    <div className="tseo-float-card">
                      ...
                      <p>
                        ...
                        &ldquo;chiropractor near me&rdquo;
                      </p>
                    </div>
                    <div className="tseo-float-card">
              ...
              <div className="tseo-problem-grid">
                <div className="tseo-gbp-wrap" aria-hidden="true">
                  <div className="tseo-gbp">
                    ...
                    <p className="tseo-gbp-meta">
                      Chiropractor · <em>Open now</em> · Accepting new patients
                    </p>
                ...
                <div>
                  ...
                  <p className="tseo-lead">
                    When back pain flares up or a sports injury won&apos;t quit,
                    the first thing people do is search &ldquo;chiropractor near
                    me&rdquo; and book with one of the top three clinics on the
                    map. That is an enormous, high-intent growth channel sitting
                    right in front of your practice — and it is exactly the
                    channel we have spent years mastering for chiropractic
                    clinics.
                  </p>
                  <p className="tseo-lead">
          ...
          <section className="tseo-band">
            <div className="tseo-band-grid">
              <div className="tseo-band-content">
                ...
                <h2 className="tseo-h2">
                  We Put Your Clinic in the Top Three — And Keep It There
                </h2>
                <p className="tseo-lead">
                  The map pack gets the majority of clicks and nearly all of the
                  new-patient calls, and that is exactly where we specialize.
                  Every campaign is built around one goal: earning your clinic
                  those top spots for the chiropractic services and cities that
                  book the most patients, then strengthening them month after
                  month.
                </p>
                <p className="tseo-lead">
                  We work the signals Google actually rewards: proximity,
                  relevance, and prominence. A fully built-out profile tells
                  Google exactly which chiropractic services you offer,
                ...
                <div className="tseo-mappack-list">
                  ...
                  <div className="tseo-mappack-row tseo-mappack-row--you">
                    ...
                    <span className="tseo-mappack-info">
                      <strong>Your Chiropractic Clinic</strong>
                      <span className="tseo-mappack-stars">
                        <FaStar />
                        4.9 (194) · Chiropractor ·{" "}
                  ...
                  <div className="tseo-mappack-row">
                    ...
                    <span className="tseo-mappack-info">
                      <strong>Competitor Spine &amp; Wellness</strong>
                      <span className="tseo-mappack-stars">
                        <FaStar />
                        4.6 (98) · Chiropractor
                      </span>
                  ...
                  <div className="tseo-mappack-row">
                    ...
                    <span className="tseo-mappack-info">
                      <strong>Competitor Chiropractic</strong>
                      <span className="tseo-mappack-stars">
                        <FaStar />
                        4.4 (61) · Chiropractor
                      </span>
            ...
            <div className="tseo-container">
              ...
              <div className="tseo-bento">
                ...
                <article className="tseo-bento-card tseo-bento-card--s1">
                  ...
                  <h3>Free Chiropractic Visibility Audit</h3>
                  <p>
                  ...
                  <div className="tseo-bento-visual" aria-hidden="true">
                    <p className="tseo-bento-visual-title">
                      Where chiropractic clients typically land after 90 days
                    </p>
                    {[
                ...
                <article className="tseo-bento-card tseo-bento-card--s4">
                  <div className="tseo-bento-s4-copy">
                    ...
                    <p>
                      Monthly reporting tied to calls and booked patients, not
                      vanity metrics. As rankings lock in, we expand to more
                      chiropractic services and more cities.
                    </p>
                  </div>
          ...
          <section className="tseo-results">
            <div className="tseo-container">
              <div className="tseo-sec-head-center">
                ...
                <h2 className="tseo-h2">
                  What Happens When Chiropractic Local SEO is Done Properly
                </h2>
                <p className="tseo-lead">
          ...
          <section className="tseo-compare">
            <div className="tseo-container">
              <div className="tseo-sec-head-center">
                ...
                <h2 className="tseo-h2">
                  What You Get with Zonic Vs. A Typical Chiropractic SEO Agency
                </h2>
                <p className="tseo-lead">
              ...
              <div className="tseo-compare-grid">
                <div className="tseo-compare-col tseo-compare-col--them">
                  ...
                  <p className="tseo-compare-sub">
                    Why most chiropractic campaigns quietly stall
                  </p>
                  <ul>
                ...
                <div className="tseo-compare-col tseo-compare-col--us">
                  <h3>Chiropractic Local SEO with Zonic Media</h3>
                  <p className="tseo-compare-sub">
                ...
                >
                  ...
                  <p className="tseo-compare-sub">
                    A typical chiropractic client&apos;s first six months
                  </p>
            ...
            <div className="tseo-container">
              ...
              <div className="tseo-why-banner">
                <div className="tseo-why-banner-text">
                  <p className="tseo-eyebrow">Free Chiropractic SEO Audit</p>
                  <h3>See Exactly How We&apos;ll Grow Your Chiropractic Rankings</h3>
                  <p>
                    We&apos;ll map your profile, citations, reviews, and
                    rankings — and show you the clear path to the top three for
                    the chiropractic searches in your market. Free, and yours to
                    keep either way.
                  </p>
                ...
                <div className="tseo-audit-card" aria-hidden="true">
                  ...
                  <div className="tseo-audit-ring-wrap">
                    ...
                    <div className="tseo-audit-ring-info">
                      ...
                      <small>
                        Where our chiropractic campaigns typically land after six
          ...
          <section className="tseo-nationwide">
            <div className="tseo-container">
              <div className="tseo-sec-head-center">
                ...
                <h2 className="tseo-h2">
                  Local SEO for Chiropractors in Every Market in the US
                </h2>
                <p className="tseo-lead">
            ...
            <div className="tseo-container">
              <div className="tseo-form-grid">
                <aside className="tseo-form-aside">
                  ...
                  <h2 className="tseo-h2">
                    Claim Your Free Chiropractic Local SEO Audit
                  </h2>
                  <p className="tseo-lead">
                    Tell us about your chiropractic clinic and we will send a
                ...
                <div className="tseo-form-main">
                  <ServiceLeadForm
                    formType="local-seo"
                    badge="Free Audit"
                    title="Get Your Free Chiropractic SEO Audit"
                    subtitle="No contracts, no pressure — just a clear picture of where your clinic stands and what it takes to book more patients in your market."
                    submitText="Send My Free Audit"
                    messageLabel="Tell us about your chiropractic clinic"
