...
const tickerRun =
  "<span><b>1,500+</b> Google Business Profiles optimized</span><span>★ <b>5.0</b> rating on Clutch</span><span>No long-term contracts</span><span>US-based team</span><span>Exclusive leads — never shared</span><span>Septic specialists</span>";
...
<span><b>1,500+</b> profiles optimized</span>
</div>`,
  trustbarHtml: `<div class="trustbar"><div class="wrap trustbar-in">
<div class="stat"><div class="n">1,500<span class="u">+</span></div><div class="l">GBP profiles optimized</div></div>
...
<p>Most septic customers never scroll past the first three map results. We track your rank across a geo-grid of your service area and work every signal — <a class="ima-inline-link" href="/local-seo-google-business-optimization">Google Business Profile optimization</a>, reviews, citations, and links — to move you into the spots that get the calls.</p>
<div class="hero-pills">
