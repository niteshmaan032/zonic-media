...
const breadcrumbJsonLd = buildBreadcrumbJsonLd([
  ...
  { name: "Window & Door Website Design", url: PAGE_PATH },
]);

const serviceJsonLd = {
  "@context": "https://schema.org",
  "@type": "Service",
  name: "Window & Door Website Design",
  serviceType: "Window and Door Company Website Design",
  url: `${SITE_URL}${PAGE_PATH}`,
  description:
    "Custom window and door website design with instant quote request flows, product galleries, financing and energy-rebate pages, and product-specific landing pages built to book installs.",
  provider: {
    "@type": "LocalBusiness",
    name: "Zonic Media",
  },
  ...
  hasOfferCatalog: {
    "@type": "OfferCatalog",
    name: "Window & Door Website Design Services",
    itemListElement: [
      {
        "@type": "Offer",
        itemOffered: {
          "@type": "Service",
          name: "New Window & Door Websites",
        },
      },
      {
        "@type": "Offer",
        itemOffered: {
          "@type": "Service",
          name: "Window & Door Website Redesigns",
        },
      },
      {
        "@type": "Offer",
...
const windowDoorWebFaqJsonLd = {
  "@context": "https://schema.org",
  "@type": "FAQPage",
  url: `${SITE_URL}${PAGE_PATH}`,
  mainEntity: WindowDoorWebFaqs.map((faq) => ({
    "@type": "Question",
    name: faq.question,
    acceptedAnswer: {
      "@type": "Answer",
...
const ServiceCards = [
  {
    ...
    title: "New Window & Door Websites",
    desc: (
      <>
  ...
  },
  {
    ...
    title: "Window & Door Website Redesigns",
    desc: "Quality products, dated website? We rebuild it around homeowner conversion and map every existing URL so your rankings carry over on launch day.",
  },
  {
    icon: <RiPagesLine aria-hidden="true" />,
    title: "Product & Service Landing Pages",
    desc: "Dedicated pages for replacement windows, entry doors, patio and sliding doors, and storm doors — each built around one product and one action: request a quote.",
  },
  {
  ...
  },
  {
    ...
    title: "Financing & Rebate Pages",
    desc: "A window project is a five-figure decision. Clear financing options and plain-English energy-rebate guidance answer sticker-shock objections before homeowners ever call.",
  },
  {
...
const BandStats = [
  ...
  { num: "6+", label: "Product lines designed for" },
...
const NationwideChips = [
  ...
  "Full-Home Window Projects",
  "Multi-Crew Installers",
];
...
const GrowCards = [
  {
    ...
    desc: "Rank for replacement window and door searches across Google Search and Maps in every city you work.",
    cta: "See window & door SEO",
  },
  {
    href: "/services/general-contractor-website-design",
    icon: <FiLayout aria-hidden="true" />,
    title: "General Contractor Website Design",
    desc: "Do broader remodeling too? A general contractor site that shows the range and books the build.",
...
const formVariant = {
  formType: "window-and-door-website-design",
  headline: "Get Your Free Homepage Mockup",
  subcopy:
    "See what your window and door company's new website could look like before you spend a dollar — delivered within about a week.",
  namePlaceholder: "Mike Johnson",
  companyLabel: "Company name",
  companyPlaceholder: "Johnson Window & Door",
  cityPlaceholder: "Dover, DE",
  emailPlaceholder: "mike@johnsonwindows.com",
  messagePlaceholder:
    "Tell us about your company, your current website, or the installs you want more of — replacement windows, entry doors, patio doors...",
};
    ...
    <>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify(windowDoorWebFaqJsonLd),
        }}
      />

      <div className="hiw-page hiw-theme-window">
        <main>
          {/* 1. Hero */}
            ...
            <div className="hiw-container">
              <div className="hiw-hero-grid">
                <div className="hiw-hero-copy">
                  ...
                  <p className="hiw-hero-sub">
                    ...
                    like a lead system — instant quote flows, product
                    galleries, financing and energy-rebate UX, and pages that
                    sell the upgrade. Our{" "}
                  ...
                  <div className="hiw-hero-ctas">
                    <HashScrollLink
                      ...
                      offset={120}
                    >
                      Start Your Window & Door Website
                    </HashScrollLink>
              ...
              <div className="hiw-strip-inner">
                <div className="hiw-strip-cell hiw-strip-cell-main">
                  ...
                  <p>
                    <span>Planning a new window & door website?</span>
              ...
              <div className="hiw-about-grid">
                    ...
                    <svg viewBox="0 0 120 120">
                      ...
                      <text>
                        <textPath href="#hiwBadgeCircle">
                          Window & Door Web Design • Zonic Media •
                        </textPath>
                      </text>
                    </svg>
                ...
                <div className="hiw-about-copy">
                  ...
                  <p className="hiw-lead">
                    ...
                    five seconds. They scanned your replacement window photos,
                    looked for your reviews, and tried to figure out roughly
                    what new windows and doors cost. If any of that was slow,
                    confusing, or missing, they tapped the next installer on the
                    list.
                  </p>
                  <p className="hiw-lead">
                    Great window and door website design closes that gap: it
                    answers the three questions every homeowner has — can I
                    trust your work on my entry and patio doors, what will this
                    cost, and how do I start — and then makes requesting a quote
                    effortless. Energy efficiency is front and center, and it is
                    also the foundation of any wider{" "}
                    <Link
                      href="/services/industry/local-seo-for-window-and-door-companies"
                      className="hiw-inline-link"
                    >
            ...
            <div className="hiw-band-grid">
              <div className="hiw-band-content">
                ...
                <p className="hiw-lead">
                  ...
                  storm doors, and full-home window projects — we design around
                  your product mix, your service area, and the way homeowners in
                  your market actually search. Your site should feel like your
                  company, not like a template every competitor is also using —
                  and if you also do broader remodeling, we can tie in a
                  matching{" "}
                  <Link
                    href="/services/general-contractor-website-design"
                    className="hiw-inline-link"
              ...
              <div className="hiw-band-media">
                <Image
                  src="/images/home-improvement-web/window-and-door-responsive-preview-square.webp"
                  alt="Window and door website displayed on a desktop monitor and tablet"
                  fill
            ...
            <div className="hiw-container">
              <div className="hiw-sec-head-center">
                ...
                <p className="hiw-lead">
                  ...
                  photo of a window, a list of services, a contact form nobody
              ...
              <div className="hiw-why-cards">
                ...
                <article className="hiw-why-card">
                  ...
                  <p>
                    ...
                    look at the drafty windows they want replaced.
                  </p>
                </article>
                <article className="hiw-why-card">
                  <span className="hiw-why-card-icon">
            ...
            <div className="hiw-container">
              <div className="hiw-sec-head-center">
                ...
                <p className="hiw-lead">
                  ...
                  companies, Zonic Media designs window and door websites
          ...
          <section className="hiw-faqs" id="hiw-faqs">
            <div className="hiw-container">
              <div className="hiw-split-grid">
                ...
                <div>
                  <GmbFaqs items={WindowDoorWebFaqs} />
                </div>
              </div>
            </div>
          </section>
          ...
          <div className="hiw-container">
            <div className="hiw-footer-grid">
              <div className="hiw-footer-brand">
                ...
                <p>
                  Zonic Media is a digital growth agency helping window and door
