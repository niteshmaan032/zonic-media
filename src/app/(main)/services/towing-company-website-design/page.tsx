...
const breadcrumbJsonLd = buildBreadcrumbJsonLd([
  ...
  { name: "Towing Company Website Design", url: PAGE_PATH },
]);

const serviceJsonLd = {
  "@context": "https://schema.org",
  "@type": "Service",
  name: "Towing Company Website Design",
  serviceType: "Towing Company Website Design",
  url: `${SITE_URL}${PAGE_PATH}`,
  description:
    "Custom towing company website design with click-to-call roadside pages, 24/7 dispatch flows, service-area and GPS coverage pages, and mobile-first design built to book tows.",
  provider: {
    "@type": "Organization",
  ...
  hasOfferCatalog: {
    "@type": "OfferCatalog",
    name: "Towing Company Website Design Services",
    itemListElement: [
      {
        "@type": "Offer",
        itemOffered: {
          "@type": "Service",
          name: "New Towing Company Websites",
        },
      },
      {
        "@type": "Offer",
      ...
      },
      {
        ...
        itemOffered: {
          "@type": "Service",
          name: "Roadside & Service Landing Pages",
        },
      },
      {
        "@type": "Offer",
        itemOffered: {
          "@type": "Service",
          name: "Click-to-Call & Dispatch Flows",
        },
      },
    ],
  },
...
const towingWebFaqJsonLd = {
  "@context": "https://schema.org",
  "@type": "FAQPage",
  url: `${SITE_URL}${PAGE_PATH}`,
  mainEntity: TowingWebFaqs.map((faq) => ({
    "@type": "Question",
    name: faq.question,
    acceptedAnswer: {
      "@type": "Answer",
...
const ServiceCards = [
  ...
  },
  {
    ...
    title: "Towing Website Redesigns",
    desc: "Old site that buries your phone number? We rebuild it around the roadside call and map every existing URL so your rankings carry over on launch day.",
  },
  {
    icon: <FiTruck aria-hidden="true" />,
    title: "Roadside & Service Landing Pages",
    desc: "Dedicated pages for roadside assistance, lockouts, jump starts, winch-outs, flatbed, and accident recovery — each built around one job and one action: call now.",
  },
  {
    icon: <FiPhoneCall aria-hidden="true" />,
    title: "Click-to-Call & Dispatch Flows",
    desc: "Towbook, TRAXERO, or a clean request flow to your dispatcher — with a giant tap-to-call button on every page, so stranded drivers reach you in one tap.",
  },
  {
    icon: <FiMapPin aria-hidden="true" />,
    title: "Service-Area & Coverage Pages",
    desc: "Highway corridors, cities, and coverage maps that tell drivers — and Google — exactly where you tow, so you own every mile you actually run.",
  },
  {
...
const BandStats = [
  ...
  { num: "6+", label: "Towing services designed for" },
  { num: "24/7", label: "Roadside calls, around the clock" },
...
const BannerFeats = [
  {
    ...
    desc: "Every layout decision serves one goal: turning a stranded driver into a ringing phone.",
  },
  {
  ...
  },
  {
    ...
    desc: "License, insurance, and response-time proof placed where drivers look for it.",
  },
  {
    icon: <RiLineChartLine aria-hidden="true" />,
...
const GrowCards = [
  {
    ...
    icon: <RiSearchLine aria-hidden="true" />,
    title: "SEO Services for Car Towing",
    desc: "Rank for towing, roadside, and recovery searches across Google Search and Maps in every corridor you run.",
    cta: "See towing SEO",
  },
  {
...
const formVariant = {
  formType: "towing-company-website-design",
  headline: "Get Your Free Homepage Mockup",
  subcopy:
    "See what your towing company's new website could look like before you spend a dollar — delivered within about a week.",
  namePlaceholder: "Rick Morales",
  companyLabel: "Company name",
  companyPlaceholder: "RapidTow Recovery",
  cityPlaceholder: "Dover, DE",
  emailPlaceholder: "rick@rapidtow.com",
  messagePlaceholder:
    "Tell us about your company, your current website, or the jobs you want more of — roadside, flatbed, heavy-duty, accident recovery...",
};
    ...
    <>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify(towingWebFaqJsonLd),
        }}
      />

      <div className="hiw-page hiw-theme-towing">
        <main>
          {/* 1. Hero */}
            ...
            <div className="hiw-container">
              <div className="hiw-hero-grid">
                <div className="hiw-hero-copy">
                  ...
                  <p className="hiw-hero-sub">
                    ...
                    system — click-to-call roadside pages, 24/7 dispatch UX,
                    coverage maps, and mobile-first design that books tows fast.
                    Our{" "}
              ...
              <div className="hiw-strip-inner">
                <div className="hiw-strip-cell hiw-strip-cell-main">
                  ...
                  <p>
                    <span>Planning a new towing website?</span>
              ...
              <div className="hiw-about-grid">
                ...
                <div className="hiw-about-copy">
                  ...
                  <p className="hiw-lead">
                    ...
                    and search — and in about five seconds they have judged your
                    company. They looked for a phone number, checked your
                    reviews, and tried to figure out if you could get there fast.
                    If your number was buried or your site loaded slowly, they
                    tapped the next tow truck on the list.
                  </p>
                  <p className="hiw-lead">
                    Great towing website design closes that gap: it answers the
                    two questions every stranded driver has — can I trust you and
                    how fast can you get here — and then puts a call one tap away.
                    It is also the foundation of any wider{" "}
                    <Link
                      href="/services/industry/seo-services-for-car-towing"
                      className="hiw-inline-link"
                    >
            ...
            <div className="hiw-band-grid">
              <div className="hiw-band-content">
                ...
                <p className="hiw-lead">
                  ...
                  flatbed transport, accident recovery, and heavy-duty towing —
            ...
            <div className="hiw-container">
              <div className="hiw-sec-head-center">
                ...
                <p className="hiw-lead">
                  ...
                  and a wall of text. We design every site as a working system,
                  where each page has one job — putting a stranded driver one tap
                  from calling your dispatcher.
                </p>
              </div>
              ...
              <div className="hiw-anatomy-grid">
                <div>
                  ...
                  <p className="hiw-lead">
                    ...
                    is a checklist of things drivers and search engines both
                    expect. Every website we ship includes all eight, as
                    standard, not as upsells.
                  </p>
                  <p className="hiw-lead">
                    Miss any one of them and you leak calls: slow pages lose the
                    roadside driver, a buried phone number loses the emergency,
                    and a site without service area pages loses every corridor to
              ...
              <div className="hiw-why-cards">
                ...
                <article className="hiw-why-card">
                  ...
                  <p>
                    ...
                    weak signal at the side of a highway.
                  </p>
                </article>
                <article className="hiw-why-card">
                  <span className="hiw-why-card-icon">
                  ...
                  <p>
                    ...
                    stranded driver will never read.
                  </p>
                </article>
              </div>
          ...
          <section className="hiw-banner">
            <div className="hiw-banner-grid">
              ...
              <div className="hiw-banner-media">
                <ServiceSiteMockup
                  prefix="hiw"
                  brand="RapidTow Recovery"
                  url="rapidtow.com"
                  headline="24/7 towing & roadside."
                  primaryCta="Call for a Tow"
                  chips={["Roadside", "Winch-Outs", "Flatbed"]}
                  toastTitle="New dispatch request"
                />
              </div>
          ...
          <div className="hiw-container">
            <div className="hiw-footer-grid">
              <div className="hiw-footer-brand">
                ...
                <p>
                  Zonic Media is a digital growth agency helping towing companies
                  turn roadside searches into booked calls.
                </p>
