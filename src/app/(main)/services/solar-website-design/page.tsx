...
const GrowCards = [
  {
    href: "/services/local-seo-for-solar-companies",
    icon: <RiSearchLine aria-hidden="true" />,
                ...
                <div className="hiw-hero-visual">
                  <div className="hiw-hero-img">
                    <div className="hiw-ph">
                      <span>Solar company website mockup</span>
                    </div>
                  </div>
              ...
              <div className="hiw-about-grid">
                <div className="hiw-collage">
                  <div className="hiw-collage-img-1">
                    <div className="hiw-ph">
                      <span>Solar panel installation on a roof</span>
                    </div>
                  </div>
                  <div className="hiw-collage-img-2">
                    <div className="hiw-ph">
                      <span>Solar company website on desktop</span>
                    </div>
                  </div>
          ...
          <section className="hiw-band">
            <div className="hiw-band-grid">
              ...
              <div className="hiw-band-media">
                <div className="hiw-ph">
                  <span>Responsive solar website preview</span>
                </div>
              </div>
            </div>
          </section>
              ...
              <div className="hiw-split-grid">
                <div>
                  ...
                  <p className="hiw-lead">
                    ...
                    leads, and what happens to your current rankings. If your
                    question is not here, send it through the form — a strategist
