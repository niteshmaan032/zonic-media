...
const breadcrumbJsonLd = buildBreadcrumbJsonLd([
  ...
  { name: "Bathroom Remodeling Website Design", url: PAGE_PATH },
]);

const serviceJsonLd = {
  "@context": "https://schema.org",
  "@type": "Service",
  name: "Bathroom Remodeling Website Design",
  serviceType: "Bathroom Remodeling Company Website Design",
  url: `${SITE_URL}${PAGE_PATH}`,
  description:
    "Custom bathroom remodeling website design with instant quote request flows, before-and-after project galleries, financing pages, and service-specific landing pages built to book renovations.",
  provider: {
    "@type": "LocalBusiness",
    name: "Zonic Media",
  },
  ...
  hasOfferCatalog: {
    "@type": "OfferCatalog",
    name: "Bathroom Remodeling Website Design Services",
    itemListElement: [
      {
        "@type": "Offer",
        itemOffered: {
          "@type": "Service",
          name: "New Bathroom Remodeler Websites",
        },
      },
      {
        "@type": "Offer",
        itemOffered: {
          "@type": "Service",
          name: "Bathroom Remodeling Website Redesigns",
        },
      },
      {
        "@type": "Offer",
      ...
      },
      {
        ...
        itemOffered: {
          "@type": "Service",
          name: "Quote & Design Consultation Flows",
        },
      },
    ],
  },
...
const BathroomWebFaqs = [
  {
    question: "How Much Does Bathroom Remodeling Website Design Cost?",
    answer:
  ...
  {
    question: "How Long Does It Take to Design a Bathroom Remodeling Website?",
    answer:
      "Most bathroom remodeling websites launch in one to two weeks. You see a free homepage mockup within about a week of our discovery call, and once the design direction is approved we move into build, content, and on-page SEO. Larger sites with many service-area pages or custom integrations can take longer.",
  },
  {
    question: "Can My Website Show off Before-and-After Project Photos?",
    answer:
      "Yes — for a remodeler, the gallery is the sale. We build fast, filterable before-and-after galleries organized by project type (walk-in showers, tub-to-shower conversions, full remodels) so homeowners can see your craftsmanship before they ever call. Every gallery is paired with a quote button, because a photo that impresses should never leave a visitor with nowhere to go.",
  },
  {
...
const bathroomWebFaqJsonLd = {
  "@context": "https://schema.org",
  "@type": "FAQPage",
  url: `${SITE_URL}${PAGE_PATH}`,
  mainEntity: BathroomWebFaqs.map((faq) => ({
    "@type": "Question",
    name: faq.question,
    acceptedAnswer: {
      "@type": "Answer",
...
const ServiceCards = [
  {
    ...
    title: "New Bathroom Remodeler Websites",
    desc: (
      <>
  ...
  },
  {
    ...
    title: "Bathroom Remodeling Redesigns",
    desc: "Beautiful work, forgettable website? We rebuild it around homeowner conversion and map every existing URL so your rankings carry over on launch day.",
  },
  {
    icon: <RiPagesLine aria-hidden="true" />,
    title: "Project & Service Landing Pages",
    desc: "Dedicated pages for walk-in showers, tub-to-shower conversions, full remodels, and aging-in-place bathrooms — each built around one project type and one action: request a quote.",
  },
  {
    icon: <LuCalendarCheck2 aria-hidden="true" />,
    title: "Quote & Design Consultation Flows",
    desc: "Jobber, Housecall Pro, Buildertrend, or a clean estimate request flow routed to your office — homeowners book a design consultation in a few taps, day or night.",
  },
  {
...
const BandStats = [
  ...
  { num: "6+", label: "Remodeling niches designed for" },
...
const SystemCards = [
  ...
  },
  {
    ...
    desc: "Tile, fixtures, and finish choices shown the way homeowners imagine them — pages that sell the transformation, not just the trade.",
  },
];
...
const AnatomyItems = [
  ...
  },
  {
    ...
    desc: "Real project photos organized by remodel type, because homeowners buy the bathroom they can already picture.",
  },
  {
    title: "Service Area Pages",
    desc: "A dedicated page for every city and suburb you work, built to rank for local bathroom remodeling searches.",
  },
  {
...
const NationwideChips = [
  ...
  "Luxury & Master Baths",
  "Aging-in-Place & ADA",
  "Small-Bath Renovations",
  "Multi-Crew Remodelers",
];
...
const GrowCards = [
  {
    ...
    desc: "Rank for bathroom remodel and walk-in shower searches across Google Search and Maps in every city you work.",
    cta: "See bathroom SEO",
  },
  {
    href: "/services/kitchen-remodeling-website-design",
    icon: <FiLayout aria-hidden="true" />,
    title: "Kitchen Remodeling Website Design",
    desc: "Also remodel kitchens? A matching, conversion-first site for your highest-ticket projects — built on the same system.",
  ...
  },
  {
    ...
    desc: "Tile and flooring a big part of your work? A dedicated flooring site that shows the finish and books the measure.",
    cta: "See flooring web design",
  },
];

const formVariant = {
  formType: "bathroom-remodeling-website-design",
  headline: "Get Your Free Homepage Mockup",
  subcopy:
    "See what your bathroom remodeling company's new website could look like before you spend a dollar — delivered within about a week.",
  namePlaceholder: "Mike Johnson",
  companyLabel: "Company name",
  companyPlaceholder: "Johnson Bath & Remodel",
  cityPlaceholder: "Dover, DE",
  emailPlaceholder: "mike@johnsonbath.com",
  messagePlaceholder:
    "Tell us about your company, your current website, or the remodels you want more of — walk-in showers, full remodels, aging-in-place...",
};
    ...
    <>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify(bathroomWebFaqJsonLd),
        }}
      />

      <div className="hiw-page hiw-theme-bathroom">
        <main>
          {/* 1. Hero */}
            ...
            <div className="hiw-container">
              <div className="hiw-hero-grid">
                <div className="hiw-hero-copy">
                  <p className="hiw-eyebrow">Bathroom Remodeling Website Design</p>
                  <h1 className="hiw-hero-h1">
                    Bathroom Remodeling Website Design That Turns Browsers into{" "}
                    <span className="hiw-hl">Booked Renovations</span>
                  </h1>
                  <p className="hiw-hero-sub">
                    Zonic Media designs bathroom remodeling websites that work
                    like a lead system — instant quote flows, before-and-after
                    galleries, financing UX, and design-driven pages that sell
              ...
              <div className="hiw-strip-inner">
                <div className="hiw-strip-cell hiw-strip-cell-main">
                  ...
                  <p>
                    <span>Planning a new remodeling website?</span>
              ...
              <div className="hiw-about-grid">
                    ...
                    <svg viewBox="0 0 120 120">
                      ...
                      <text>
                        <textPath href="#hiwBadgeCircle">
                          Bathroom Web Design • Zonic Media •
                        </textPath>
                      </text>
                    </svg>
                ...
                <div className="hiw-about-copy">
                  ...
                  <p className="hiw-lead">
                    ...
                    what a remodel costs. If any of that was slow, confusing, or
                    missing, they tapped the next remodeler on the list.
                  </p>
                  <p className="hiw-lead">
                    Great bathroom remodeling website design closes that gap: it
            ...
            <div className="hiw-container">
              <div className="hiw-sec-head">
                <div>
                  ...
                  <h2 className="hiw-h2">
                    Bathroom Remodeling Website Design for Every Stage of Your
                    Company
                  </h2>
                </div>
          ...
          <section className="hiw-band">
            <div className="hiw-band-grid">
              <div className="hiw-band-content">
                ...
                <h2 className="hiw-h2">
                  Web Design for Every Kind of Bathroom Project
                </h2>
                <p className="hiw-lead">
                  Tub-to-shower conversions, walk-in showers, full gut remodels,
                  luxury master baths, and aging-in-place accessibility work —
                  we design around your project mix, your service area, and the
                  way homeowners in your market actually search. Your site
                  should feel like your work, not like a template every
                  competitor is also using — and if you also handle{" "}
                  <Link
                    href="/services/kitchen-remodeling-website-design"
                    className="hiw-inline-link"
                  >
          ...
          <section className="hiw-system">
            <div className="hiw-container">
              <div className="hiw-sec-head-center">
                ...
                <p className="hiw-lead">
                  Most remodeling websites are digital business cards: a stock
                  photo of a bathroom, a list of services, a contact form nobody
            ...
            <div className="hiw-container">
              <div className="hiw-anatomy-grid">
                <div>
                  ...
                  <p className="hiw-lead">
                    The best bathroom remodeling website design is not about
              ...
              <div className="hiw-why-cards">
                ...
                <article className="hiw-why-card">
                  ...
                  <p>
                    ...
                    couch, next to the bathroom they want gone.
                  </p>
                </article>
                <article className="hiw-why-card">
                  <span className="hiw-why-card-icon">
          ...
          <section className="hiw-nationwide">
            <div className="hiw-container">
              <div className="hiw-sec-head-center">
                ...
                <h2 className="hiw-h2">
                  Bathroom Remodeling Website Design Across the United States
                </h2>
                <p className="hiw-lead">
                  From single-crew startups to multi-market remodeling
                  companies, Zonic Media designs bathroom remodeling websites
          ...
          <div className="hiw-container">
            <div className="hiw-footer-grid">
              <div className="hiw-footer-brand">
                ...
                <p>
                  Zonic Media is a digital growth agency helping bathroom
                  remodelers turn website visitors into booked renovations.
                </p>
