          ...
          <section className="hiw-band">
            <div className="hiw-band-grid">
              ...
              <div className="hiw-band-media">
                <Image
                  src="/images/home-improvement-web/kitchen-remodeling-responsive-preview-square.webp"
                  alt="Kitchen remodeling website displayed on a desktop monitor and tablet"
                  fill
