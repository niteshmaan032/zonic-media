...
const breadcrumbJsonLd = buildBreadcrumbJsonLd([
  ...
  { name: "Kitchen Remodeling Website Design", url: PAGE_PATH },
]);

const serviceJsonLd = {
  "@context": "https://schema.org",
  "@type": "Service",
  name: "Kitchen Remodeling Website Design",
  serviceType: "Kitchen Remodeling Company Website Design",
  url: `${SITE_URL}${PAGE_PATH}`,
  description:
    "Custom kitchen remodeling website design with instant quote request flows, before-and-after project galleries, financing pages, and service-specific landing pages built to book renovations.",
  provider: {
    "@type": "LocalBusiness",
    name: "Zonic Media",
  },
  ...
  hasOfferCatalog: {
    "@type": "OfferCatalog",
    name: "Kitchen Remodeling Website Design Services",
    itemListElement: [
      {
        "@type": "Offer",
        itemOffered: {
          "@type": "Service",
          name: "New Kitchen Remodeler Websites",
        },
      },
      {
        "@type": "Offer",
        itemOffered: {
          "@type": "Service",
          name: "Kitchen Remodeling Website Redesigns",
        },
      },
      {
        "@type": "Offer",
...
const kitchenWebFaqJsonLd = {
  "@context": "https://schema.org",
  "@type": "FAQPage",
  url: `${SITE_URL}${PAGE_PATH}`,
  mainEntity: KitchenWebFaqs.map((faq) => ({
    "@type": "Question",
    name: faq.question,
    acceptedAnswer: {
      "@type": "Answer",
...
const ServiceCards = [
  {
    ...
    title: "New Kitchen Remodeler Websites",
    desc: (
      <>
  ...
  },
  {
    ...
    title: "Kitchen Remodeling Redesigns",
  ...
  },
  {
    ...
    desc: "Dedicated pages for cabinet refacing, countertop installs, custom islands, and full kitchen remodels — each built around one project type and one action: request a quote.",
  },
  {
...
const GrowCards = [
  {
    ...
    desc: "Rank for kitchen remodel and cabinet install searches across Google Search and Maps in every city you work.",
    cta: "See kitchen SEO",
  },
  {
    ...
    desc: "Also remodel bathrooms? A matching, conversion-first site for your other high-ticket projects — built on the same system.",
    cta: "Explore bathroom web design",
  },
  {
    href: "/services/general-contractor-website-design",
    icon: <FiImage aria-hidden="true" />,
    title: "General Contractor Website Design",
    desc: "Do full-home projects too? A general contractor site that shows the range and books the build.",
    cta: "See contractor web design",
  },
];

const formVariant = {
  formType: "kitchen-remodeling-website-design",
  headline: "Get Your Free Homepage Mockup",
  subcopy:
    "See what your kitchen remodeling company's new website could look like before you spend a dollar — delivered within about a week.",
  namePlaceholder: "Mike Johnson",
  companyLabel: "Company name",
  companyPlaceholder: "Johnson Kitchen & Bath",
  cityPlaceholder: "Dover, DE",
  emailPlaceholder: "mike@johnsonkitchens.com",
  messagePlaceholder:
    "Tell us about your company, your current website, or the remodels you want more of — cabinet refacing, countertops, full kitchen remodels...",
};
    ...
    <>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify(kitchenWebFaqJsonLd),
        }}
      />

      <div className="hiw-page hiw-theme-kitchen">
        <main>
          {/* 1. Hero */}
              ...
              <div className="hiw-hero-grid">
                ...
                <div className="hiw-hero-visual">
                  <div className="hiw-hero-img">
                    <Image
                      src="/images/home-improvement-web/kitchen-remodeling-hero.webp"
                      alt="Kitchen remodeling specialist reviewing her company website beside plans and material samples"
                      fill
                      priority
              ...
              <div className="hiw-about-grid">
                <div className="hiw-collage">
                  <div className="hiw-collage-img-1">
                    <Image
                      src="/images/home-improvement-web/kitchen-remodeling-first-impressions-1.webp"
                      alt="Completed custom kitchen remodel with warm oak cabinets and a stone island"
                      fill
                  ...
                  <div className="hiw-collage-img-2">
                    <Image
                      src="/images/home-improvement-web/kitchen-remodeling-first-impressions-2.webp"
                      alt="Kitchen remodeling company website displayed on a desktop monitor"
                      fill
                    ...
                    <svg viewBox="0 0 120 120">
                      ...
                      <text>
                        <textPath href="#hiwBadgeCircle">
                          Kitchen Web Design • Zonic Media •
                        </textPath>
                      </text>
                    </svg>
                ...
                <div className="hiw-about-copy">
                  ...
                  <p className="hiw-lead">
                    Great kitchen remodeling website design closes that gap: it
            ...
            <div className="hiw-band-grid">
              <div className="hiw-band-content">
                ...
                <p className="hiw-lead">
                  ...
                  remodels, custom islands, and open-concept conversions — we
                  design around your project mix, your service area, and the
              ...
              <div className="hiw-band-media">
                <Image
                  src="/images/home-improvement-web/kitchen-remodeling-responsive-preview-v4.webp"
                  alt="Responsive kitchen remodeling website displayed across desktop, tablet, and phone"
                  fill
            ...
            <div className="hiw-container">
              <div className="hiw-sec-head-center">
                ...
                <p className="hiw-lead">
                  ...
                  photo of a kitchen, a list of services, a contact form nobody
              ...
              <div className="hiw-why-cards">
                ...
                <article className="hiw-why-card">
                  ...
                  <p>
                    ...
                    couch, next to the kitchen they want gone.
                  </p>
                </article>
                <article className="hiw-why-card">
                  <span className="hiw-why-card-icon">
          ...
          <section className="hiw-banner">
            <div className="hiw-banner-grid">
              ...
              <div className="hiw-banner-media">
                <ServiceSiteMockup
                  prefix="hiw"
                  brand="Craft Kitchen Co."
                  url="craftkitchenco.com"
                  headline="Kitchens worth cooking in."
                  primaryCta="Get Free Quote"
                  chips={["Cabinets", "Countertops", "Islands"]}
            ...
            <div className="hiw-container">
              <div className="hiw-sec-head-center">
                ...
                <p className="hiw-lead">
                  ...
                  companies, Zonic Media designs kitchen remodeling websites
          ...
          <div className="hiw-container">
            <div className="hiw-footer-grid">
              <div className="hiw-footer-brand">
                ...
                <p>
                  Zonic Media is a digital growth agency helping kitchen
