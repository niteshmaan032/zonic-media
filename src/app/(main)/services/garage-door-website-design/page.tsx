...
const breadcrumbJsonLd = buildBreadcrumbJsonLd([
  ...
  { name: "Garage Door Website Design", url: PAGE_PATH },
]);

const serviceJsonLd = {
  "@context": "https://schema.org",
  "@type": "Service",
  name: "Garage Door Website Design",
  serviceType: "Garage Door Company Website Design",
  url: `${SITE_URL}${PAGE_PATH}`,
  description:
    "Custom garage door company website design with instant quote request flows, emergency repair landing pages, financing pages, and service-area pages built to book repairs and installations.",
  provider: {
    "@type": "Organization",
  ...
  hasOfferCatalog: {
    "@type": "OfferCatalog",
    name: "Garage Door Website Design Services",
    itemListElement: [
      {
        "@type": "Offer",
        itemOffered: {
          "@type": "Service",
          name: "New Garage Door Company Websites",
        },
      },
      {
        "@type": "Offer",
        itemOffered: {
          "@type": "Service",
          name: "Garage Door Website Redesigns",
        },
      },
      {
        "@type": "Offer",
        itemOffered: {
          "@type": "Service",
          name: "Repair & Service Landing Pages",
        },
      },
      {
        "@type": "Offer",
        itemOffered: {
          "@type": "Service",
          name: "Quote & Online Booking Flows",
        },
      },
    ],
  },
...
const garageWebFaqJsonLd = {
  "@context": "https://schema.org",
  "@type": "FAQPage",
  url: `${SITE_URL}${PAGE_PATH}`,
  mainEntity: GarageWebFaqs.map((faq) => ({
    "@type": "Question",
    name: faq.question,
    acceptedAnswer: {
      "@type": "Answer",
...
const ServiceCards = [
  {
    ...
    title: "New Garage Door Company Websites",
    desc: (
      <>
  ...
  },
  {
    ...
    title: "Garage Door Website Redesigns",
  ...
  },
  {
    ...
    title: "Repair & Service Landing Pages",
    desc: "Dedicated pages for broken springs, opener repair, off-track doors, and cable replacement — each built around one urgent job and one action: request service.",
  },
  {
    icon: <LuCalendarCheck2 aria-hidden="true" />,
    title: "Quote & Online Booking Flows",
    desc: "ServiceTitan, Housecall Pro, Jobber, or a clean quote request flow routed to your office — homeowners book a repair or install in a few taps, day or night.",
  },
  {
    icon: <FiDollarSign aria-hidden="true" />,
    title: "Financing & New-Door Pages",
    desc: "A new door is a real investment. Clear financing options and plain-English style and material guidance answer objections before homeowners ever call.",
  },
  {
...
const BandStats = [
  ...
  { num: "6+", label: "Garage door services designed for" },
...
const formVariant = {
  formType: "garage-door-website-design",
  headline: "Get Your Free Homepage Mockup",
  subcopy:
    "See what your garage door company's new website could look like before you spend a dollar — delivered within about a week.",
  namePlaceholder: "Mike Reyes",
  companyLabel: "Company name",
  companyPlaceholder: "Reyes Overhead Door",
  cityPlaceholder: "Dover, DE",
  emailPlaceholder: "mike@reyesdoors.com",
  messagePlaceholder:
    "Tell us about your company, your current website, or the jobs you want more of — spring repair, opener installs, new doors...",
};
    ...
    <>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify(garageWebFaqJsonLd),
        }}
      />

      <div className="hiw-page hiw-theme-garage-door">
        <main>
          {/* 1. Hero */}
            ...
            <div className="hiw-container">
              <div className="hiw-hero-grid">
                <div className="hiw-hero-copy">
                  ...
                  <p className="hiw-hero-sub">
                    ...
                    lead system — emergency repair pages, instant quote flows,
                    financing UX, and mobile-first pages that book repairs and
                    installs. Our{" "}
                  ...
                  <div className="hiw-hero-ctas">
                    <HashScrollLink
                      ...
                      offset={120}
                    >
                      Start Your Garage Door Website
                    </HashScrollLink>
              ...
              <div className="hiw-strip-inner">
                <div className="hiw-strip-cell hiw-strip-cell-main">
                  ...
                  <p>
                    <span>Planning a new garage door website?</span>
              ...
              <div className="hiw-about-grid">
                    ...
                    <svg viewBox="0 0 120 120">
                      ...
                      <text>
                        <textPath href="#hiwBadgeCircle">
                          Garage Door Web Design • Zonic Media •
                        </textPath>
                      </text>
                    </svg>
                ...
                <div className="hiw-about-copy">
                  ...
                  <p className="hiw-lead">
                    ...
                    grabs their phone and searches — and in about five seconds
                    they have judged your company. They scanned your reviews,
                    looked for a phone number, and tried to figure out if you
                    could come today. If any of that was slow, confusing, or
                    missing, they tapped the next company on the list.
                  </p>
                  <p className="hiw-lead">
                    Great garage door website design closes that gap: it answers
                    the three questions every homeowner has — can I trust you,
                    how fast can you get here, and what will this cost — and then
            ...
            <div className="hiw-band-grid">
              <div className="hiw-band-content">
                ...
                <p className="hiw-lead">
                  ...
                  door installation, and commercial overhead doors — we design
            ...
            <div className="hiw-container">
              <div className="hiw-sec-head-center">
                ...
                <p className="hiw-lead">
                  ...
                  photo of a door, a list of services, a contact form nobody
              ...
              <div className="hiw-anatomy-grid">
                <div>
                  ...
                  <p className="hiw-lead">
                    ...
                    mobile visitors, a missing phone number loses the emergency
                    call, and a site without service area pages loses every
                    suburb to the company that built them.
                  </p>
              ...
              <div className="hiw-why-cards">
                ...
                <article className="hiw-why-card">
                  ...
                  <p>
                    ...
                    standing in the driveway staring at a door that will not
                    open.
                  </p>
                </article>
                <article className="hiw-why-card">
            ...
            <div className="hiw-banner-grid">
              <div className="hiw-banner-copy">
                ...
                <p className="hiw-lead">
                  ...
                  service instead of keep scrolling. If the project touches ads,
              ...
              <div className="hiw-banner-media">
                <ServiceSiteMockup
                  prefix="hiw"
                  brand="Apex Garage Doors"
                  url="apexgaragedoors.com"
                  headline="Garage doors fixed today."
                  primaryCta="Get Free Quote"
                  chips={["Spring Repair", "Openers", "New Doors"]}
                  toastTitle="New repair request"
                />
              </div>
            ...
            <div className="hiw-container">
              <div className="hiw-sec-head-center">
                ...
                <p className="hiw-lead">
                  ...
                  companies, Zonic Media designs garage door websites for
          ...
          <div className="hiw-container">
            <div className="hiw-footer-grid">
              <div className="hiw-footer-brand">
                ...
                <p>
                  Zonic Media is a digital growth agency helping garage door
                  companies turn website visitors into booked repairs and
                  installs.
                </p>
