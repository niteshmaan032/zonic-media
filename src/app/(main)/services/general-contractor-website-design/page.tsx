...
const breadcrumbJsonLd = buildBreadcrumbJsonLd([
  ...
  { name: "General Contractor Website Design", url: PAGE_PATH },
]);
...
const serviceJsonLd = {
  ...
  serviceType: "General Contractor Website Design",
  url: `${SITE_URL}${PAGE_PATH}`,
  description:
    "Custom general contractor website design with instant quote request flows, project galleries, financing pages, and service-specific landing pages built to book remodels, additions, and builds.",
  provider: {
    "@type": "LocalBusiness",
    name: "Zonic Media",
  },
  ...
  hasOfferCatalog: {
    "@type": "OfferCatalog",
    name: "General Contractor Website Design Services",
    itemListElement: [
      {
        "@type": "Offer",
        itemOffered: {
          "@type": "Service",
          name: "New Contractor Websites",
        },
      },
      {
        "@type": "Offer",
        itemOffered: {
          "@type": "Service",
          name: "Contractor Website Redesigns",
        },
      },
      {
        "@type": "Offer",
        itemOffered: {
          "@type": "Service",
          name: "Project & Service Landing Pages",
        },
      },
      {
        "@type": "Offer",
...
const GeneralContractorWebFaqs = [
  {
    question: "How much does general contractor website design cost?",
    answer:
  ...
  {
    question: "How long does it take to design a contractor website?",
    answer:
      "Most contractor websites launch in one to two weeks. You see a free homepage mockup within about a week of our discovery call, and once the design direction is approved we move into build, content, and on-page SEO. Larger sites with many service-area pages or custom integrations can take longer.",
  },
  {
    question: "Can my website show off my past projects?",
    answer:
      "Yes — for a contractor, the gallery is the sale. We build fast, filterable project galleries organized by job type (kitchen and bath remodels, additions, whole-home renovations) so homeowners can see your craftsmanship before they ever call. Every gallery is paired with a quote button, because a project that impresses should never leave a visitor with nowhere to go.",
  },
  {
    question: "Can you integrate my CRM or estimating software?",
    answer:
      "Yes. We connect the tools contractors already run — Buildertrend, JobTread, CoConstruct, or a structured quote request flow that routes straight to your office. Either way, homeowners can request an estimate or book a consultation without waiting for business hours.",
  },
  {
...
const generalContractorWebFaqJsonLd = {
  "@context": "https://schema.org",
  "@type": "FAQPage",
  url: `${SITE_URL}${PAGE_PATH}`,
  mainEntity: GeneralContractorWebFaqs.map((faq) => ({
    "@type": "Question",
    name: faq.question,
    acceptedAnswer: {
      "@type": "Answer",
...
const ServiceCards = [
  ...
  },
  {
    ...
    title: "Contractor Website Redesigns",
    desc: "Solid reputation, dated website? We rebuild it around homeowner conversion and map every existing URL so your rankings carry over on launch day.",
  },
  {
    icon: <RiPagesLine aria-hidden="true" />,
    title: "Project & Service Landing Pages",
    desc: "Dedicated pages for kitchen and bath remodels, home additions, basement finishing, and whole-home renovations — each built around one project type and one action: request a quote.",
  },
  {
    icon: <LuCalendarCheck2 aria-hidden="true" />,
    title: "Quote & Consultation Flows",
    desc: "Buildertrend, JobTread, CoConstruct, or a clean estimate request flow routed to your office — homeowners book a consultation in a few taps, day or night.",
  },
  {
    icon: <FiDollarSign aria-hidden="true" />,
    title: "Financing & Estimate Pages",
    desc: "A remodel is a five-figure decision. Clear financing options and plain-English estimate guidance answer sticker-shock objections before homeowners ever call.",
  },
  {
...
const BandStats = [
  ...
  { num: "6+", label: "Contracting trades designed for" },
...
const SystemCards = [
  {
    ...
    desc: "Homeowners request an estimate or design consultation in a few taps — integrated with the CRM and estimating tools contractors already use.",
  },
  {
    icon: <FiImage aria-hidden="true" />,
    title: "Project galleries",
    desc: "Filterable project photos organized by job type, placed where hesitant homeowners actually decide whether your work is worth the call.",
  },
  {
    icon: <FiDollarSign aria-hidden="true" />,
    title: "Financing & trust UX",
  ...
  },
  {
    ...
    title: "Scope-clear service pages",
    desc: "Every trade and project scope explained so homeowners know exactly what you build — pages that sell the outcome, not just the trade.",
  },
];
...
const AnatomyItems = [
  ...
  },
  {
    ...
    desc: "Real project photos organized by job type, because homeowners buy the result they can already picture.",
  },
  {
    title: "Service area pages",
    desc: "A dedicated page for every city and suburb you work, built to rank for local general contractor searches.",
  },
  {
...
const GrowCards = [
  {
    ...
    desc: "Rank for remodeling, addition, and renovation searches across Google Search and Maps in every city you work.",
    cta: "See contractor SEO",
  },
  {
    href: "/services/kitchen-remodeling-website-design",
    icon: <FiLayout aria-hidden="true" />,
    title: "Kitchen Remodeling Website Design",
    desc: "Kitchens a big part of your work? A focused, conversion-first site for your highest-ticket remodels.",
    cta: "Explore kitchen web design",
  },
  {
    href: "/services/window-and-door-website-design",
    icon: <FiImage aria-hidden="true" />,
    title: "Window & Door Website Design",
    desc: "Install windows and doors too? A dedicated site that shows the products and books the estimate.",
    cta: "See window & door web design",
  },
];

const formVariant = {
  formType: "general-contractor-website-design",
  headline: "Get Your Free Homepage Mockup",
  subcopy:
    "See what your construction company's new website could look like before you spend a dollar — delivered within about a week.",
  namePlaceholder: "Mike Johnson",
  companyLabel: "Company name",
  companyPlaceholder: "Johnson Construction & Remodeling",
  cityPlaceholder: "Dover, DE",
  emailPlaceholder: "mike@johnsonbuilds.com",
  messagePlaceholder:
    "Tell us about your company, your current website, or the projects you want more of — remodels, additions, whole-home builds...",
};
    ...
    <>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify(generalContractorWebFaqJsonLd),
        }}
      />

      <div className="hiw-page hiw-theme-contractor">
        <main>
          {/* 1. Hero */}
            ...
            <div className="hiw-container">
              <div className="hiw-hero-grid">
                <div className="hiw-hero-copy">
                  <p className="hiw-eyebrow">General Contractor Website Design</p>
                  <h1 className="hiw-hero-h1">
                    General contractor website design that turns browsers into{" "}
                    <span className="hiw-hl">booked projects</span>
                  </h1>
                  <p className="hiw-hero-sub">
                    Zonic Media designs general contractor websites that work
                    like a lead system — instant quote flows, project galleries,
                    financing UX, and service pages that sell the build. Our{" "}
              ...
              <div className="hiw-strip-inner">
                <div className="hiw-strip-cell hiw-strip-cell-main">
                  ...
                  <p>
                    <span>Planning a new contractor website?</span>
            ...
            <div className="hiw-container">
              <div className="hiw-about-grid">
                    ...
                    <svg viewBox="0 0 120 120">
                      ...
                      <text>
                        <textPath href="#hiwBadgeCircle">
                          Contractor Web Design • Zonic Media •
                        </textPath>
                      </text>
                    </svg>
                ...
                <div className="hiw-about-copy">
                  ...
                  <h2 className="hiw-h2">
                    Your website is the{" "}
                    <span className="hiw-hl-text">first jobsite</span>{" "}
                    homeowners walk before they hire
                  </h2>
                  <p className="hiw-lead">
                    Before a homeowner ever lets a crew into their house, they
                    have already judged your company — on their phone, in about
                    five seconds. They scanned your project photos, looked for
                    your reviews, and tried to figure out roughly what a remodel,
                    addition, or whole-home build costs. If any of that was slow,
                    confusing, or missing, they tapped the next contractor on the
                    list.
                  </p>
                  <p className="hiw-lead">
                    Great general contractor website design closes that gap: it
            ...
            <div className="hiw-container">
              <div className="hiw-sec-head">
                <div>
                  ...
                  <h2 className="hiw-h2">
                    General contractor website design for every stage of your
                    company
                  </h2>
                </div>
          ...
          <section className="hiw-band">
            <div className="hiw-band-grid">
              <div className="hiw-band-content">
                <p className="hiw-eyebrow">Every Project Type</p>
                <h2 className="hiw-h2">
                  Web design for every kind of contracting work
                </h2>
                <p className="hiw-lead">
                  Kitchen and bath remodels, home additions, basement finishing,
                  decks, and whole-home renovations — we design around your
                  project mix, your service area, and the way homeowners in your
                  market actually search. Your site should feel like your work,
                  not like a template every competitor is also using — and if you
                  also handle{" "}
                  <Link
                    href="/services/kitchen-remodeling-website-design"
                    className="hiw-inline-link"
                  ...
                  , we can match both sites into one system.
                </p>
          ...
          <section className="hiw-system">
            <div className="hiw-container">
              <div className="hiw-sec-head-center">
                ...
                <p className="hiw-lead">
                  Most contractor websites are digital business cards: a stock
                  photo of a job site, a list of services, a contact form nobody
            ...
            <div className="hiw-container">
              <div className="hiw-anatomy-grid">
                <div>
                  ...
                  <p className="hiw-lead">
                    The best general contractor website design is not about
              ...
              <div className="hiw-why-cards">
                ...
                <article className="hiw-why-card">
                  ...
                  <p>
                    ...
                    because most remodeling research happens on a phone, while
                    they picture the remodel they have been putting off.
                  </p>
                </article>
                <article className="hiw-why-card">
                  <span className="hiw-why-card-icon">
          ...
          <section className="hiw-nationwide">
            <div className="hiw-container">
              <div className="hiw-sec-head-center">
                ...
                <h2 className="hiw-h2">
                  General contractor website design across the United States
                </h2>
                <p className="hiw-lead">
                  From single-crew startups to multi-market construction
                  companies, Zonic Media designs general contractor websites
                  for contractors in every state. Because everything happens
            ...
            <div className="hiw-container">
              <div className="hiw-split-grid">
                <div>
                  ...
                  <h2 className="hiw-h2">
                    Everything contractors ask us about website design
                  </h2>
                  <p className="hiw-lead">
                ...
                <div>
                  <GmbFaqs items={GeneralContractorWebFaqs} />
                </div>
              </div>
            </div>
          </section>
            ...
            <div className="hiw-container">
              <div className="hiw-form-grid">
                <aside className="hiw-form-aside">
                  ...
                  <h2 className="hiw-h2">
                    Book your free contractor website consult
                  </h2>
                  <p className="hiw-lead">
          ...
          <div className="hiw-container">
            <div className="hiw-footer-grid">
              <div className="hiw-footer-brand">
                ...
                <p>
                  Zonic Media is a digital growth agency helping general
                  contractors turn website visitors into booked projects.
                </p>
