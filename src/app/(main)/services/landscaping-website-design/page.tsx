...
const breadcrumbJsonLd = buildBreadcrumbJsonLd([
  ...
  { name: "Landscaping Website Design", url: PAGE_PATH },
]);

const serviceJsonLd = {
  "@context": "https://schema.org",
  "@type": "Service",
  name: "Landscaping Website Design",
  serviceType: "Landscaping Company Website Design",
  url: `${SITE_URL}${PAGE_PATH}`,
  description:
    "Custom landscaping company website design with instant quote request flows, before-and-after project galleries, seasonal service pages, and service-area pages built to book installs and maintenance.",
  provider: {
    "@type": "Organization",
  ...
  hasOfferCatalog: {
    "@type": "OfferCatalog",
    name: "Landscaping Website Design Services",
    itemListElement: [
      {
        "@type": "Offer",
        itemOffered: {
          "@type": "Service",
          name: "New Landscaping Websites",
        },
      },
      {
        "@type": "Offer",
        itemOffered: {
          "@type": "Service",
          name: "Landscaping Website Redesigns",
        },
      },
      {
        "@type": "Offer",
...
const LandscapingWebFaqs = [
  {
    question: "How Much Does Landscaping Website Design Cost?",
    answer:
  ...
  {
    question: "How Long Does It Take to Design a Landscaping Website?",
    answer:
      "Most landscaping websites launch in one to two weeks. You see a free homepage mockup within about a week of our discovery call, and once the design direction is approved we move into build, content, and on-page SEO. Larger sites with many service-area pages or custom integrations can take longer.",
  },
  {
    question: "Can My Website Show off Before-and-After Project Photos?",
    answer:
      "Yes — for a landscaper, the gallery is the sale. We build fast, filterable before-and-after galleries organized by project type (landscape design, hardscaping, lawn transformations) so homeowners can picture your work on their own yard before they ever call. Every gallery is paired with a quote button, because a photo that impresses should never leave a visitor with nowhere to go.",
  },
  {
    question: "Can You Integrate My CRM or Estimating Software?",
    answer:
      "Yes. We connect the tools landscapers already run — Jobber, Yardbook, LMN, or a structured quote request flow that routes straight to your office. Either way, homeowners can request an estimate or schedule a walkthrough without waiting for business hours.",
  },
  {
...
const landscapingWebFaqJsonLd = {
  "@context": "https://schema.org",
  "@type": "FAQPage",
  url: `${SITE_URL}${PAGE_PATH}`,
  mainEntity: LandscapingWebFaqs.map((faq) => ({
    "@type": "Question",
    name: faq.question,
    acceptedAnswer: {
      "@type": "Answer",
...
const ServiceCards = [
  {
    ...
    title: "New Landscaping Websites",
    desc: (
      <>
  ...
  },
  {
    ...
    title: "Landscaping Redesigns",
    desc: "Great yards, forgettable website? We rebuild it around homeowner conversion and map every existing URL so your rankings carry over on launch day.",
  },
  {
    icon: <RiPagesLine aria-hidden="true" />,
    title: "Service & Project Landing Pages",
    desc: "Dedicated pages for landscape design, hardscaping, lawn care, and irrigation — each built around one service and one action: request an estimate.",
  },
  {
    icon: <LuCalendarCheck2 aria-hidden="true" />,
    title: "Quote & Estimate Flows",
    desc: "Jobber, Yardbook, LMN, or a clean estimate request flow routed to your office — homeowners book a walkthrough in a few taps, day or night.",
  },
  {
    icon: <FiDollarSign aria-hidden="true" />,
    title: "Maintenance & Pricing Pages",
    desc: "Recurring maintenance plans and honest price-range guidance up front, so homeowners choose a program instead of bouncing to the next crew.",
  },
  {
...
const BandStats = [
  ...
  { num: "6+", label: "Landscaping services designed for" },
...
const SystemCards = [
  {
    ...
    desc: "Homeowners request an estimate or a design walkthrough in a few taps — integrated with the CRM and estimating tools landscapers already use.",
  },
  {
    icon: <FiImage aria-hidden="true" />,
    title: "Before-and-After Galleries",
    desc: "Filterable project photos organized by service type, placed where hesitant homeowners actually decide whether your work is worth the call.",
  },
  {
    icon: <FiGrid aria-hidden="true" />,
    title: "Seasonal Service Pages",
    desc: "Spring cleanups, summer maintenance, and fall prep pages that capture the searches your market makes every time the season turns.",
  },
  {
    icon: <FiDollarSign aria-hidden="true" />,
    title: "Maintenance & Pricing UX",
    desc: "Recurring plans and honest price ranges up front, so budget-conscious homeowners stop bouncing before they reach your inbox.",
  },
];
...
const AnatomyItems = [
  {
    ...
    desc: "Most homeowners plan a project on their phone — every layout starts at 375px, not on a desktop monitor.",
  },
  {
  ...
  },
  {
    ...
    desc: "Your best reviews pulled onto the site where cautious homeowners actually read them before spending on their yard.",
  },
  {
  ...
  },
  {
    ...
    desc: "Real project photos organized by service, because homeowners buy the yard they can already picture.",
  },
  {
    title: "Service Area Pages",
    desc: "A dedicated page for every city and suburb you serve, built to rank for local landscaping searches.",
  },
  {
    title: "Local Schema Markup",
    desc: "Structured data that tells Google exactly who you are, where you work, and what you install and maintain.",
  },
  {
...
const ProcessSteps = [
  {
    ...
    desc: "The work you want more of, the cities you serve, how your office handles leads today, and who outranks you — mapped into the pages and flows your site needs.",
  },
  {
    num: "02",
...
const formVariant = {
  formType: "landscaping-website-design",
  headline: "Get Your Free Homepage Mockup",
  subcopy:
    "See what your landscaping company's new website could look like before you spend a dollar — delivered within about a week.",
  namePlaceholder: "Chris Bennett",
  companyLabel: "Company name",
  companyPlaceholder: "GreenScape Landscaping",
  cityPlaceholder: "Dover, DE",
  emailPlaceholder: "chris@greenscapelawn.com",
  messagePlaceholder:
    "Tell us about your company, your current website, or the work you want more of — landscape design, hardscaping, maintenance...",
};
    ...
    <>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify(landscapingWebFaqJsonLd),
        }}
      />

      <div className="hiw-page hiw-theme-landscaping">
        <main>
          {/* 1. Hero */}
            ...
            <div className="hiw-container">
              <div className="hiw-hero-grid">
                <div className="hiw-hero-copy">
                  <p className="hiw-eyebrow">Landscaping Website Design</p>
                  <h1 className="hiw-hero-h1">
                    Landscaping Website Design That Turns Browsers into{" "}
                    <span className="hiw-hl">Booked Projects</span>
                  </h1>
                  <p className="hiw-hero-sub">
                    Zonic Media designs landscaping websites that work like a
                    lead system — instant quote flows, before-and-after
                    galleries, seasonal service pages, and design that sells the
                    transformation. Our{" "}
              ...
              <div className="hiw-strip-inner">
                <div className="hiw-strip-cell hiw-strip-cell-main">
                  ...
                  <p>
                    <span>Planning a new landscaping website?</span>
              ...
              <div className="hiw-about-grid">
                    ...
                    <svg viewBox="0 0 120 120">
                      ...
                      <text>
                        <textPath href="#hiwBadgeCircle">
                          Landscaping Web Design • Zonic Media •
                        </textPath>
                      </text>
                    </svg>
                ...
                <div className="hiw-about-copy">
                  ...
                  <p className="hiw-lead">
                    Before a homeowner ever books a walkthrough, they have
                    already judged your company — on their phone, in about five
                    seconds. They scanned your before-and-after photos, looked
                    for your reviews, and tried to figure out roughly what a
                    project costs. If any of that was slow, confusing, or
                    missing, they tapped the next landscaper on the list.
                  </p>
                  <p className="hiw-lead">
                    Great landscaping website design closes that gap: it answers
                    the three questions every homeowner has — can I trust your
                    work, what will this cost, and how do I start — and then
            ...
            <div className="hiw-container">
              <div className="hiw-sec-head">
                <div>
                  ...
                  <h2 className="hiw-h2">
                    Landscaping Website Design for Every Stage of Your Company
                  </h2>
                </div>
          ...
          <section className="hiw-band">
            <div className="hiw-band-grid">
              <div className="hiw-band-content">
                ...
                <h2 className="hiw-h2">
                  Web Design for Every Kind of Landscaping Work
                </h2>
                <p className="hiw-lead">
                  Landscape design and installation, lawn care and maintenance,
                  hardscaping and patios, irrigation, and seasonal cleanups — we
                  design around your service mix, your area, and the way
          ...
          <section className="hiw-system">
            <div className="hiw-container">
              <div className="hiw-sec-head-center">
                ...
                <h2 className="hiw-h2">
                  More Than a Brochure — A System Built to Book Projects
                </h2>
                <p className="hiw-lead">
                  Most landscaping websites are digital business cards: a stock
                  photo of a lawn, a list of services, a contact form nobody
                  fills out. We design every site as a working system, where each
                  page has one job — moving a homeowner closer to a booked
                  estimate.
                </p>
              </div>
            ...
            <div className="hiw-container">
              <div className="hiw-anatomy-grid">
                <div>
                  ...
                  <h2 className="hiw-h2">
                    The Anatomy of a High-Converting Landscaping Website
                  </h2>
                  <p className="hiw-lead">
                    The best landscaping website design is not about decoration —
                  ...
                  <p className="hiw-lead">
                    ...
                    visitors, missing project photos lose trust, and a site
                    without service area pages loses every suburb to the crew that
                    built them.
                  </p>
              ...
              <div className="hiw-why-cards">
                ...
                <article className="hiw-why-card">
                  ...
                  <p>
                    ...
                    because most landscaping research happens on a phone, out in
                    the yard the homeowner wants transformed.
                  </p>
                </article>
                <article className="hiw-why-card">
                  <span className="hiw-why-card-icon">
            ...
            <div className="hiw-banner-grid">
              ...
              <div className="hiw-banner-media">
                <ServiceSiteMockup
                  ...
                  url="greenscapelawn.com"
                  headline="Landscapes that turn heads."
                  primaryCta="Get Free Estimate"
                  chips={["Lawn Care", "Hardscaping", "Design"]}
          ...
          <section className="hiw-nationwide">
            <div className="hiw-container">
              <div className="hiw-sec-head-center">
                ...
                <h2 className="hiw-h2">
                  Landscaping Website Design Across the United States
                </h2>
                <p className="hiw-lead">
                  From single-crew startups to multi-market landscaping
                  companies, Zonic Media designs landscaping websites for
            ...
            <div className="hiw-container">
              <div className="hiw-split-grid">
                <div>
                  ...
                  <h2 className="hiw-h2">
                    Everything Landscapers Ask Us About Website Design
                  </h2>
                  <p className="hiw-lead">
                ...
                <div>
                  <GmbFaqs items={LandscapingWebFaqs} />
                </div>
              </div>
            </div>
          </section>
            ...
            <div className="hiw-container">
              <div className="hiw-form-grid">
                <aside className="hiw-form-aside">
                  ...
                  <h2 className="hiw-h2">
                    Book Your Free Landscaping Website Consult
                  </h2>
                  <p className="hiw-lead">
          ...
          <div className="hiw-container">
            <div className="hiw-footer-grid">
              <div className="hiw-footer-brand">
                ...
                <p>
                  Zonic Media is a digital growth agency helping landscaping
                  companies turn website visitors into booked projects.
                </p>
