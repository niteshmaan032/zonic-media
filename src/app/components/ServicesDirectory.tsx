...
const GROUPS: DirGroup[] = [
  {
    ...
    links: [
      ...
      { href: "/gmb-reinstatement-service-agency", label: "Rejected GBP Appeal — Escalation Desk" },
      { href: "/services/gmb-verification-help", label: "GMB Verification Help" },
      { href: "/google-business-profile-verification-help-2026", label: "GBP Verification Rules 2026" },
      { href: "/services/gmb-optimization", label: "GBP Optimization" },
      { href: "/local-seo-google-business-optimization", label: "Google Map Pack Ranking" },
