...
export default function NonProfitLeadForm() {
  ...
  const onSubmit = async (data: FormValues) => {
    ...
    try {
      ...
      console.error("Nonprofit form submission failed:", error);
      setSubmitError(
    ...
    <div className="hia-form-card">
      ...
      >
        <div className="hia-fg">
          <label htmlFor="npm-fullName">Your name</label>
          <input
            id="npm-fullName"
            type="text"
        ...
        <div className="hia-fg-row">
          <div className="hia-fg">
            <label htmlFor="npm-organization">Organization</label>
            <input
              id="npm-organization"
              type="text"
            ...
            />
            {errors.organization && (
              <p className="hia-field-error">{errors.organization.message}</p>
            )}
          </div>

          <div className="hia-fg">
            <label htmlFor="npm-city">City / region</label>
            <input
              id="npm-city"
              type="text"
        ...
        <div className="hia-fg-row">
          <div className="hia-fg">
            <label htmlFor="npm-email">Email</label>
            <input
              id="npm-email"
              type="email"
              placeholder="jordan@riversidefoodbank.org"
          ...
          <div className="hia-fg">
            <label htmlFor="npm-contact">Phone</label>
            <input
              id="npm-contact"
              type="tel"
        ...
        <div className="hia-fg">
          <label htmlFor="npm-message">Your message</label>
          <textarea
            id="npm-message"
            rows={2}
            placeholder="Tell us about your mission, your next fundraising goal, or what's holding your campaign back."
