...
/** Garage Door revenue lines — the answer routes the follow-up conversation. */
const SERVICES = [
  "Emergency Repair",
  "Broken Springs",
  "Opener Repair",
...
export default function GarageDoorLeadForm() {
  ...
  const onSubmit = async (data: FormValues) => {
    ...
    try {
      ...
      const messageParts = [
        `Garage door company: ${data.company}`,
      ...
      console.error("Free garage door website form submission failed:", error);
      setSubmitError(
  ...
  return (
    ...
    >
      ...
      <div className="form-heading">
        <span>
          <Icon name="mail" /> Free garage door website eligibility
        </span>
      ...
      <div className="form-grid">
        <div className="form-field">
          <label htmlFor="ofr-garage-door-full-name">Your name *</label>
          <input
            id="ofr-garage-door-full-name"
        ...
        <div className="form-field">
          <label htmlFor="ofr-garage-door-business-name">Garage door company *</label>
          <input
            id="ofr-garage-door-business-name"
            placeholder="Company name"
            autoComplete="organization"
            aria-invalid={errors.company ? "true" : "false"}
            {...register("company", {
              required: "Garage door company is required.",
              minLength: { value: 2, message: "At least 2 characters." },
        ...
        <div className="form-field">
          <label htmlFor="ofr-garage-door-phone">Phone *</label>
          <input
            id="ofr-garage-door-phone"
            type="tel"
        ...
        <div className="form-field">
          <label htmlFor="ofr-garage-door-email">Email *</label>
          <input
            id="ofr-garage-door-email"
            type="email"
        ...
        <div className="form-field">
          <label htmlFor="ofr-garage-door-website">Current website</label>
          <input
            id="ofr-garage-door-website"
        ...
        <div className="form-field">
          <label htmlFor="ofr-garage-door-service-area">Service area *</label>
          <input
            id="ofr-garage-door-service-area"
        ...
        <div className="form-field form-field--full">
          <label htmlFor="ofr-garage-door-primary-service">
            Which work do you want more of? *
          </label>
          <select
            id="ofr-garage-door-primary-service"
        ...
        <div className="form-field form-field--full">
          <label htmlFor="ofr-garage-door-budget">Monthly marketing budget *</label>
          <select
            id="ofr-garage-door-budget"
            className="form-select standalone-select"
            defaultValue=""
