...
/** Bathroom Remodeling revenue lines — the answer routes the follow-up conversation. */
const SERVICES = [
  "Shower Remodels",
  "Tub Conversions",
...
export default function BathroomRemodelingLeadForm() {
  ...
  const onSubmit = async (data: FormValues) => {
    ...
    try {
      ...
      console.error("Free bathroom remodeling website form submission failed:", error);
      setSubmitError(
  ...
  return (
    <form
      id="ofr-bathroom-remodeling-offer-form"
    ...
    >
      ...
      <div className="form-heading">
        <span>
          <Icon name="mail" /> Free bathroom remodeling website eligibility
        </span>
      ...
      <div className="form-grid">
        <div className="form-field">
          <label htmlFor="ofr-bathroom-remodeling-full-name">Your name *</label>
          <input
            id="ofr-bathroom-remodeling-full-name"
        ...
        <div className="form-field">
          <label htmlFor="ofr-bathroom-remodeling-business-name">Remodeling company *</label>
          <input
            id="ofr-bathroom-remodeling-business-name"
        ...
        <div className="form-field">
          <label htmlFor="ofr-bathroom-remodeling-phone">Phone *</label>
          <input
            id="ofr-bathroom-remodeling-phone"
            type="tel"
        ...
        <div className="form-field">
          <label htmlFor="ofr-bathroom-remodeling-email">Email *</label>
          <input
            id="ofr-bathroom-remodeling-email"
            type="email"
        ...
        <div className="form-field">
          <label htmlFor="ofr-bathroom-remodeling-website">Current website</label>
          <input
            id="ofr-bathroom-remodeling-website"
        ...
        <div className="form-field">
          <label htmlFor="ofr-bathroom-remodeling-service-area">Service area *</label>
          <input
            id="ofr-bathroom-remodeling-service-area"
        ...
        <div className="form-field form-field--full">
          <label htmlFor="ofr-bathroom-remodeling-primary-service">
            Which work do you want more of? *
          </label>
          <select
            id="ofr-bathroom-remodeling-primary-service"
          ...
          >
            <option value="" disabled>
              Select a bathroom remodeling service
            </option>
        ...
        <div className="form-field form-field--full">
          <label htmlFor="ofr-bathroom-remodeling-budget">Monthly marketing budget *</label>
          <select
            id="ofr-bathroom-remodeling-budget"
            className="form-select standalone-select"
            defaultValue=""
