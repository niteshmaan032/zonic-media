...
import BathroomRemodelingFaqList, { FAQS } from "./BathroomRemodelingFaqList";
import BathroomRemodelingLeadForm from "./BathroomRemodelingLeadForm";
import BathroomRemodelingOfferHeader from "./BathroomRemodelingOfferHeader";
import BathroomRemodelingServiceTabs from "./BathroomRemodelingServiceTabs";
import "./offer.css";

const PAGE_PATH = "/bathroom-remodeling-website-design-agency-us/offer";
...
const breadcrumbJsonLd = buildBreadcrumbJsonLd([
  { name: "Home", url: "/" },
  { name: "Free Bathroom Remodeling Website Offer", url: PAGE_PATH },
]);

const serviceJsonLd = {
  ...buildServiceJsonLd({
    name: "Free Bathroom Remodeling Website Offer",
    description:
      "A conversion-focused bathroom remodeling website with the upfront development fee waived for businesses on a qualifying Zonic Media marketing plan.",
    pageUrl: PAGE_PATH,
    serviceType: "Bathroom Remodeling Website Design",
...
const MARQUEE_ITEMS = [
  "Shower Remodels leads",
  "Tub Conversions leads",
  "Full Bathroom Remodels leads",
  "Accessible Bathrooms leads",
  "Vanities & Tile leads",
  "Design Consultation leads",
];
...
export const metadata: Metadata = {
  title: { absolute: "Free Bathroom Remodeling Website for Remodelers" },
  description:
    "Free bathroom remodeling website, no upfront development fee, when you start a qualifying Zonic marketing plan. Galleries and consultation booking built in.",
  // Offer-intent terms, kept disjoint from the head terms the matching
  // /services page targets so the two do not compete.
  keywords: [
    "free bathroom remodeling website",
    "bathroom remodeling website design",
    "remodeling contractor website",
    "free website for remodelers",
    "bathroom remodeler web design",
    "remodeling marketing plan",
    "home remodeling website design",
    "bathroom remodeling leads",
  ],
  alternates: { canonical: PAGE_PATH },
  openGraph: {
    title: "Free Bathroom Remodeling Website Offer | Zonic Media",
    description:
      "Free bathroom remodeling website, no upfront development fee, when you start a qualifying Zonic marketing plan. Galleries and consultation booking built in.",
    url: PAGE_PATH,
    type: "website",
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Zonic Media free bathroom remodeling website offer",
      },
    ],
  },
...
export default function BathroomRemodelingOfferPage() {
  const marqueeItems = [...MARQUEE_ITEMS, ...MARQUEE_ITEMS];

  return (
    <div className="ofr-bathroom-remodeling" id="top">
      <script
      ...
      <main id="main-content">
        ...
        <section className="hero" aria-labelledby="hero-title">
          <div className="hero-copy">
            <div className="eyebrow">
              ...
              <span>Free website offer for bathroom remodelers</span>
              <Icon name="sparkles" />
            </div>
            ...
            <p className="hero-lede">Start a qualifying Zonic Media marketing plan and we’ll build a professional, conversion-focused website for your bathroom remodeling company with no upfront development fee.</p>
            ...
            <div className="proof-row">
              ...
              <div className="proof-item proof-item--yellow">
                ...
                <span>
                  <strong>Bathroom Remodeling lead system</strong>
              ...
              <div className="proof-item proof-item--green">
                ...
                <span>
                  <strong>Project-led growth</strong>
                  <small>Website + remodel marketing</small>
                </span>
              </div>
          ...
          <div className="concept-stage">
            ...
            <div className="browser-card">
              <div className="browser-topbar">
                ...
                <div className="address-bar">bathroomremodelingpros.com</div>
              ...
              <div className="design-canvas">
                <div className="canvas-copy">
                  <div className="skeleton-label">BATHROOM REMODELING WEBSITE</div>
                  <h2>More estimates. More bathroom projects.</h2>
                  <p>A professional bathroom remodeling website connected to the channels that bring your best prospects.</p>
                ...
                <div className="visual-stack industry-visual-stack">
                  <Image
                    src="/images/free-website/free-bathroom-remodeling/hero.webp"
                    alt="Bathroom Remodeling professional at work"
                    fill
            ...
            <div className="phone-card">
              ...
              <div className="phone-body">
                <span className="phone-kicker">BATHROOM REMODELING SITE</span>
            ...
            <div className="floating-note floating-note--bottom">
              ...
              <span>
                <strong>Built for bathroom remodeling leads</strong>
        ...
        <section id="process" className="section process-section">
          <div className="section-heading section-heading--center">
            ...
            <p>Zonic combines the bathroom remodeling website your business needs with recurring marketing built to reach qualified prospects in the markets you serve.</p>
          </div>
          ...
          <div className="process-grid">
            <article>
              ...
              <p>We review your remodeling service mix, markets, current website, lead sources, and the channels most likely to create profitable demand.</p>
            ...
            <article>
              ...
              <p>
                Zonic creates the agreed bathroom remodeling lead-generation website with the upfront development fee waived under your marketing engagement. Same build standard as{" "}
                <Link href="/services/bathroom-remodeling-website-design" className="offer-inlink">
                  our bathroom remodeling website design service
                </Link>
                .
              </p>
          ...
          <div className="section-cta-row">
            <a className="button" href="#contact">
              <span>Check my bathroom remodeling company</span>
              <span className="button__icon">
                <Icon name="arrow-up-right" />
              </span>
            </a>
        ...
        <section id="lead-tracking" className="section leadtrack-section">
          <div className="leadtrack-copy">
            ...
            <h2>Every bathroom remodeling lead in one place.</h2>
            <p>
              Calls, forms and chats arrive in one dashboard with the source
              attached, so you can see which bathroom remodeling jobs your marketing produced
          ...
          <div className="leadtrack-panel">
            ...
            <div className="leadtrack-row">
              <b>
                Dana R.
                <small>Full Bathroom Remodels</small>
              </b>
            ...
            <div className="leadtrack-row">
              <b>
                Elena V.
                <small>Accessible Bathrooms</small>
              </b>
        ...
        <section id="work" className="section niche-section">
          <div className="section-heading section-heading--split">
            <div>
              <span className="section-kicker">Bathroom Remodeling website service paths</span>
              <h2>One bathroom remodeling website. A clear path for every profitable remodeling service.</h2>
            </div>
          ...
          <div className="niche-banner">
            <div className="niche-banner-copy">
              ...
              <h3>We build for every bathroom remodeling service.</h3>
            ...
            <div className="niche-banner-tags">
              ...
              <span className="niche-banner-more">+ every bathroom remodeling service</span>
            </div>
            <a className="section-button section-button--light" href="#contact">
              <span>Claim my bathroom remodeling website</span>
              <i>
                <Icon name="arrow-up-right" />
              </i>
            </a>
        ...
        <section id="deliverables" className="included-section">
          <div className="section-heading section-heading--center">
            ...
            <h2>More than a bathroom remodeling website handed over and forgotten.</h2>
            <p>Your bathroom remodeling website is built as part of a connected marketing system, with the structure, tracking, and conversion tools needed to support recurring growth.</p>
          </div>
        ...
        <section id="pricing" className="section pricing-section">
          <div className="section-heading section-heading--split">
            <div>
              ...
              <h2>Pick the growth plan. Your Bathroom Remodeling website comes with it.</h2>
            </div>
        ...
        <section id="why" className="dark-section">
          ...
          <div className="dark-copy">
            ...
            <h2>The website is the foundation. Marketing creates demand for bathroom remodelers.</h2>
            <p>Your plan is selected around your bathroom remodeling market and may combine paid search, local visibility, Google Business Profile growth, tracking, and ongoing conversion improvements.</p>
            <a className="section-button section-button--light" href="#contact">
              <span>Check my bathroom remodeling company</span>
              <i>
                <Icon name="arrow-up-right" />
        ...
        <section className="section terms-section">
          <div className="terms-main">
            ...
            <p>Zonic waives the upfront bathroom remodeling website design and development fee when an eligible business starts a qualifying recurring marketing engagement. Nothing is left vague before you agree.</p>
            <a className="section-button" href="#contact">
              <span>See if my bathroom remodeling company qualifies</span>
              <i>
                <Icon name="arrow-up-right" />
              </i>
            </a>
          ...
          <div className="terms-list">
            <div>
              ...
              <span>
                ...
                <small>The bathroom remodeling website development fee, valued at $2,000. Your monthly plan is billed at full rate and is not discounted.</small>
              </span>
            </div>
            <div>
              <Icon name="check" />
        ...
        <section id="reviews" className="section review-section">
          ...
          <div className="section-cta-row">
            <a className="button" href="#contact">
              <span>Build my bathroom remodeling lead system</span>
              <span className="button__icon">
                <Icon name="arrow-up-right" />
              </span>
            </a>
        ...
        <section id="faqs" className="section faq-section">
          <div className="faq-intro">
            ...
            <a className="section-button" href="#contact">
              <span>Ask about my bathroom remodeling market</span>
              <i>
                <Icon name="arrow-up-right" />
              </i>
            </a>
        ...
        <section id="contact" className="final-cta">
          ...
          <div className="cta-content">
            ...
            <h2>Claim your professional bathroom remodeling website with no upfront development fee.</h2>
            <p>Complete the short eligibility form. Zonic will review your bathroom remodeling company, website needs, service market, and growth goals before recommending a qualifying plan.</p>
            <div className="contact-points">
              <span>
                <Icon name="check" /> Professional bathroom remodeling lead-generation website
              </span>
              <span>
      ...
      <footer className="site-footer">
        <div className="footer-main">
          <div className="footer-brand">
            ...
            <p>Bathroom Remodeling lead-generation websites connected to the marketing services that grow bathroom remodelers.</p>
          ...
          <div className="footer-nav-group">
            ...
            <a href="#work">Bathroom Remodeling services</a>
          ...
          <div className="footer-offer">
            <span>Bathroom Remodeling Website Launch Offer</span>
            <strong>$0 upfront development fee</strong>
            <p>With a qualifying marketing plan at $895/month or above on a six-month term.</p>
            <a href="#ofr-bathroom-remodeling-offer-form">
              Get my bathroom remodeling website <Icon name="arrow-right" />
            </a>
          </div>
        </div>
        ...
        <nav className="offer-siblings" aria-label="Other free website offers">
          ...
          <div>
            ...
            <Link href="/chiropractic-website-design-agency-us/offer">Chiropractic websites</Link>
            <Link href="/cleaning-company-website-design-agency-us/offer">Cleaning Company websites</Link>
            <Link href="/electrician-website-design-agency-us/offer">Electrician websites</Link>
          </div>
        </nav>
        ...
        <div className="footer-bottom">
          <small>
            <strong>OFFER TERMS.</strong> Bathroom Remodeling website development fee, valued at $2,000, is
      ...
      <OfferPopupModal
        idPrefix="ofr-bathroom-remodeling"
        formType="free-bathroom-remodeling-website"
        heading="Get your bathroom remodeling website with no upfront fee."
        serviceLabel="Bathroom Remodeling work you want more of"
        servicePlaceholder="Select a bathroom remodeling service"
        services={[
          "Shower Remodels",
          "Tub Conversions",
