...
/** Landscaping revenue lines — the answer routes the follow-up conversation. */
const SERVICES = [
  "Landscape Design",
  "Lawn Care",
  "Hardscaping",
...
export default function LandscapingLeadForm() {
  ...
  const onSubmit = async (data: FormValues) => {
    ...
    try {
      ...
      const messageParts = [
        `Landscaping company: ${data.company}`,
      ...
      console.error("Free landscaping website form submission failed:", error);
      setSubmitError(
  ...
  return (
    ...
    >
      ...
      <div className="form-heading">
        <span>
          <Icon name="mail" /> Free landscaping website eligibility
        </span>
      ...
      <div className="form-grid">
        <div className="form-field">
          <label htmlFor="ofr-landscaping-full-name">Your name *</label>
          <input
            id="ofr-landscaping-full-name"
        ...
        <div className="form-field">
          <label htmlFor="ofr-landscaping-business-name">Landscaping company *</label>
          <input
            id="ofr-landscaping-business-name"
            placeholder="Company name"
            autoComplete="organization"
            aria-invalid={errors.company ? "true" : "false"}
            {...register("company", {
              required: "Landscaping company is required.",
              minLength: { value: 2, message: "At least 2 characters." },
        ...
        <div className="form-field">
          <label htmlFor="ofr-landscaping-phone">Phone *</label>
          <input
            id="ofr-landscaping-phone"
            type="tel"
        ...
        <div className="form-field">
          <label htmlFor="ofr-landscaping-email">Email *</label>
          <input
            id="ofr-landscaping-email"
            type="email"
        ...
        <div className="form-field">
          <label htmlFor="ofr-landscaping-website">Current website</label>
          <input
            id="ofr-landscaping-website"
        ...
        <div className="form-field">
          <label htmlFor="ofr-landscaping-service-area">Service area *</label>
          <input
            id="ofr-landscaping-service-area"
        ...
        <div className="form-field form-field--full">
          <label htmlFor="ofr-landscaping-primary-service">
            Which work do you want more of? *
          </label>
          <select
            id="ofr-landscaping-primary-service"
        ...
        <div className="form-field form-field--full">
          <label htmlFor="ofr-landscaping-budget">Monthly marketing budget *</label>
          <select
            id="ofr-landscaping-budget"
            className="form-select standalone-select"
            defaultValue=""
