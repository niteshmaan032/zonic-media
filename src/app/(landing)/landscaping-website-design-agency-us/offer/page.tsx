...
import LandscapingFaqList, { FAQS } from "./LandscapingFaqList";
import LandscapingLeadForm from "./LandscapingLeadForm";
import LandscapingOfferHeader from "./LandscapingOfferHeader";
import LandscapingServiceTabs from "./LandscapingServiceTabs";
import "./offer.css";

const PAGE_PATH = "/landscaping-website-design-agency-us/offer";
...
const breadcrumbJsonLd = buildBreadcrumbJsonLd([
  { name: "Home", url: "/" },
  { name: "Free Landscaping Website Offer", url: PAGE_PATH },
]);

const serviceJsonLd = {
  ...buildServiceJsonLd({
    name: "Free Landscaping Website Offer",
    description:
      "A conversion-focused landscaping website with the upfront development fee waived for businesses on a qualifying Zonic Media marketing plan.",
    pageUrl: PAGE_PATH,
...
export const metadata: Metadata = {
  title: { absolute: "Free Landscaping Website for Landscapers | Zonic Media" },
  description:
    "Free landscaping website, no upfront development fee, when you start a qualifying Zonic marketing plan. Galleries, seasonal pages and plan signups built in.",
  ...
  keywords: [
    ...
    "free website for landscapers",
    "lawn care website design",
    "landscaping marketing plan",
    "landscaper web design",
    "landscaping websites",
  ],
  alternates: { canonical: PAGE_PATH },
  openGraph: {
    title: "Free Landscaping Website Offer | Zonic Media",
    description:
      "Free landscaping website, no upfront development fee, when you start a qualifying Zonic marketing plan. Galleries, seasonal pages and plan signups built in.",
    url: PAGE_PATH,
    type: "website",
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Zonic Media free landscaping website offer",
      },
    ],
  },
...
export default function LandscapingOfferPage() {
  const marqueeItems = [...MARQUEE_ITEMS, ...MARQUEE_ITEMS];

  return (
    <div className="ofr-landscaping" id="top">
      <script
      ...
      <main id="main-content">
        ...
        <section className="hero" aria-labelledby="hero-title">
          <div className="hero-copy">
            <div className="eyebrow">
              ...
              <span>Free website offer for landscaping companies</span>
              <Icon name="sparkles" />
            </div>
            ...
            <p className="hero-lede">Start a qualifying Zonic Media marketing plan and we’ll build a professional, conversion-focused website for your landscaping company with no upfront development fee.</p>
            ...
            <div className="proof-row">
              ...
              <div className="proof-item proof-item--yellow">
                ...
                <span>
                  <strong>Landscaping lead system</strong>
              ...
              <div className="proof-item proof-item--green">
                ...
                <span>
                  ...
                  <small>Website + landscape marketing</small>
                </span>
              </div>
          ...
          <div className="concept-stage">
            ...
            <div className="browser-card">
              <div className="browser-topbar">
                ...
                <div className="address-bar">landscapingpros.com</div>
              ...
              <div className="design-canvas">
                <div className="canvas-copy">
                  <div className="skeleton-label">LANDSCAPING WEBSITE</div>
                  <h2>More estimates. More outdoor projects.</h2>
                  <p>A professional landscaping website connected to the channels that bring your best prospects.</p>
                ...
                <div className="visual-stack industry-visual-stack">
                  <Image
                    src="/images/free-website/free-landscaping/hero.webp"
            ...
            <div className="phone-card">
              ...
              <div className="phone-body">
                <span className="phone-kicker">LANDSCAPING SITE</span>
            ...
            <div className="floating-note floating-note--bottom">
              ...
              <span>
                <strong>Built for landscaping leads</strong>
        ...
        <section id="process" className="section process-section">
          <div className="section-heading section-heading--center">
            ...
            <p>Zonic combines the landscaping website your business needs with recurring marketing built to reach qualified prospects in the markets you serve.</p>
          </div>
          ...
          <div className="process-grid">
            <article>
              ...
              <p>We review your landscaping service mix, markets, current website, lead sources, and the channels most likely to create profitable demand.</p>
            ...
            <article>
              ...
              <p>
                Zonic creates the agreed landscaping lead-generation website with the upfront development fee waived under your marketing engagement. Same build standard as{" "}
                <Link href="/services/landscaping-website-design" className="offer-inlink">
                  our landscaping website design service
                </Link>
                .
              </p>
          ...
          <div className="section-cta-row">
            <a className="button" href="#contact">
              <span>Check my landscaping company</span>
              <span className="button__icon">
                <Icon name="arrow-up-right" />
              </span>
            </a>
        ...
        <section id="lead-tracking" className="section leadtrack-section">
          <div className="leadtrack-copy">
            ...
            <h2>Every landscaping lead in one place.</h2>
            <p>
              Calls, forms and chats arrive in one dashboard with the source
              attached, so you can see which landscaping jobs your marketing produced
        ...
        <section id="work" className="section niche-section">
          <div className="section-heading section-heading--split">
            <div>
              <span className="section-kicker">Landscaping website service paths</span>
              <h2>One landscaping website. A clear path for every profitable landscaping service.</h2>
            </div>
          ...
          <div className="niche-banner">
            <div className="niche-banner-copy">
              ...
              <h3>We build for every landscaping service.</h3>
            ...
            <div className="niche-banner-tags">
              ...
              <span className="niche-banner-more">+ every landscaping service</span>
            </div>
            <a className="section-button section-button--light" href="#contact">
              <span>Claim my landscaping website</span>
              <i>
                <Icon name="arrow-up-right" />
              </i>
            </a>
        ...
        <section id="deliverables" className="included-section">
          <div className="section-heading section-heading--center">
            ...
            <h2>More than a landscaping website handed over and forgotten.</h2>
            <p>Your landscaping website is built as part of a connected marketing system, with the structure, tracking, and conversion tools needed to support recurring growth.</p>
          </div>
        ...
        <section id="pricing" className="section pricing-section">
          <div className="section-heading section-heading--split">
            <div>
              ...
              <h2>Pick the growth plan. Your Landscaping website comes with it.</h2>
            </div>
        ...
        <section id="why" className="dark-section">
          ...
          <div className="dark-copy">
            ...
            <h2>The website is the foundation. Marketing creates demand for landscaping companies.</h2>
            <p>Your plan is selected around your landscaping market and may combine paid search, local visibility, Google Business Profile growth, tracking, and ongoing conversion improvements.</p>
            <a className="section-button section-button--light" href="#contact">
              <span>Check my landscaping company</span>
              <i>
                <Icon name="arrow-up-right" />
        ...
        <section className="section terms-section">
          <div className="terms-main">
            ...
            <p>Zonic waives the upfront landscaping website design and development fee when an eligible business starts a qualifying recurring marketing engagement. Nothing is left vague before you agree.</p>
            <a className="section-button" href="#contact">
              <span>See if my landscaping company qualifies</span>
              <i>
                <Icon name="arrow-up-right" />
              </i>
            </a>
          ...
          <div className="terms-list">
            <div>
              ...
              <span>
                ...
                <small>The landscaping website development fee, valued at $2,000. Your monthly plan is billed at full rate and is not discounted.</small>
              </span>
            </div>
            <div>
              <Icon name="check" />
        ...
        <section id="reviews" className="section review-section">
          ...
          <div className="section-cta-row">
            <a className="button" href="#contact">
              <span>Build my landscaping lead system</span>
              <span className="button__icon">
                <Icon name="arrow-up-right" />
              </span>
            </a>
        ...
        <section id="faqs" className="section faq-section">
          <div className="faq-intro">
            ...
            <a className="section-button" href="#contact">
              <span>Ask about my landscaping market</span>
              <i>
                <Icon name="arrow-up-right" />
              </i>
            </a>
        ...
        <section id="contact" className="final-cta">
          ...
          <div className="cta-content">
            ...
            <h2>Claim your professional landscaping website with no upfront development fee.</h2>
            <p>Complete the short eligibility form. Zonic will review your landscaping company, website needs, service market, and growth goals before recommending a qualifying plan.</p>
            <div className="contact-points">
              <span>
                <Icon name="check" /> Professional landscaping lead-generation website
              </span>
              <span>
      ...
      <footer className="site-footer">
        <div className="footer-main">
          <div className="footer-brand">
            ...
            <p>Landscaping lead-generation websites connected to the marketing services that grow landscaping companies.</p>
          ...
          <div className="footer-nav-group">
            ...
            <a href="#work">Landscaping services</a>
          ...
          <div className="footer-offer">
            <span>Landscaping Website Launch Offer</span>
            <strong>$0 upfront development fee</strong>
            <p>With a qualifying marketing plan at $895/month or above on a six-month term.</p>
            <a href="#ofr-landscaping-offer-form">
              Get my landscaping website <Icon name="arrow-right" />
            </a>
          </div>
        </div>
        ...
        <div className="footer-bottom">
          <small>
            <strong>OFFER TERMS.</strong> Landscaping website development fee, valued at $2,000, is
      ...
      <OfferPopupModal
        idPrefix="ofr-landscaping"
        formType="free-landscaping-website"
        heading="Get your landscaping website with no upfront fee."
        serviceLabel="Landscaping work you want more of"
        servicePlaceholder="Select a landscaping service"
        services={[
          "Landscape Design",
          "Lawn Care",
          "Hardscaping",
