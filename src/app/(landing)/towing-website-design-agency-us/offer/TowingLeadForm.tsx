...
/** Towing revenue lines — the answer routes the follow-up conversation. */
const SERVICES = [
  "Emergency Towing",
  "Roadside Assistance",
  "Accident Recovery",
...
export default function TowingLeadForm() {
  ...
  const onSubmit = async (data: FormValues) => {
    ...
    try {
      ...
      console.error("Free towing website form submission failed:", error);
      setSubmitError(
  ...
  return (
    ...
    >
      ...
      <div className="form-heading">
        <span>
          <Icon name="mail" /> Free towing website eligibility
        </span>
      ...
      <div className="form-grid">
        <div className="form-field">
          <label htmlFor="ofr-towing-full-name">Your name *</label>
          <input
            id="ofr-towing-full-name"
        ...
        <div className="form-field">
          <label htmlFor="ofr-towing-business-name">Towing company *</label>
          <input
            id="ofr-towing-business-name"
            placeholder="Company name"
            autoComplete="organization"
            aria-invalid={errors.company ? "true" : "false"}
            {...register("company", {
              required: "Towing company is required.",
              minLength: { value: 2, message: "At least 2 characters." },
        ...
        <div className="form-field">
          <label htmlFor="ofr-towing-phone">Phone *</label>
          <input
            id="ofr-towing-phone"
            type="tel"
        ...
        <div className="form-field">
          <label htmlFor="ofr-towing-email">Email *</label>
          <input
            id="ofr-towing-email"
            type="email"
        ...
        <div className="form-field">
          <label htmlFor="ofr-towing-website">Current website</label>
          <input
            id="ofr-towing-website"
        ...
        <div className="form-field">
          <label htmlFor="ofr-towing-service-area">Service area *</label>
          <input
            id="ofr-towing-service-area"
        ...
        <div className="form-field form-field--full">
          <label htmlFor="ofr-towing-primary-service">
            Which work do you want more of? *
          </label>
          <select
            id="ofr-towing-primary-service"
        ...
        <div className="form-field form-field--full">
          <label htmlFor="ofr-towing-budget">Monthly marketing budget *</label>
          <select
            id="ofr-towing-budget"
            className="form-select standalone-select"
            defaultValue=""
