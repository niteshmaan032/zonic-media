...
import TowingFaqList, { FAQS } from "./TowingFaqList";
import TowingLeadForm from "./TowingLeadForm";
import TowingOfferHeader from "./TowingOfferHeader";
import TowingServiceTabs from "./TowingServiceTabs";
import "./offer.css";

const PAGE_PATH = "/towing-website-design-agency-us/offer";
...
const breadcrumbJsonLd = buildBreadcrumbJsonLd([
  { name: "Home", url: "/" },
  { name: "Free Towing Website Offer", url: PAGE_PATH },
]);

const serviceJsonLd = {
  ...buildServiceJsonLd({
    name: "Free Towing Website Offer",
    description:
      "A conversion-focused towing website with the upfront development fee waived for businesses on a qualifying Zonic Media marketing plan.",
    pageUrl: PAGE_PATH,
    serviceType: "Towing Website Design",
...
const MARQUEE_ITEMS = [
  ...
  "Accident Recovery leads",
  "Flatbed Towing leads",
  "Heavy-Duty Towing leads",
  "Fleet Accounts leads",
];
...
export const metadata: Metadata = {
  title: { absolute: "Free Towing Website for Towing Companies | Zonic Media" },
  description:
    "Free towing company website, no upfront development fee, when you start a qualifying Zonic marketing plan. Tap-to-call layouts that send trucks out.",
  ...
  keywords: [
    ...
    "towing website",
    "free website for towing companies",
    "tow truck website design",
    "towing marketing plan",
    "towing company websites",
    "roadside assistance website",
  ],
  alternates: { canonical: PAGE_PATH },
  openGraph: {
    title: "Free Towing Website Offer | Zonic Media",
    description:
      "Free towing company website, no upfront development fee, when you start a qualifying Zonic marketing plan. Tap-to-call layouts that send trucks out.",
    url: PAGE_PATH,
    type: "website",
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Zonic Media free towing website offer",
      },
    ],
  },
...
export default function TowingOfferPage() {
  const marqueeItems = [...MARQUEE_ITEMS, ...MARQUEE_ITEMS];

  return (
    <div className="ofr-towing" id="top">
      <script
      ...
      <main id="main-content">
        ...
        <section className="hero" aria-labelledby="hero-title">
          <div className="hero-copy">
            <div className="eyebrow">
              ...
              <span>Free website offer for towing companies</span>
              <Icon name="sparkles" />
            </div>
            ...
            <p className="hero-lede">Start a qualifying Zonic Media marketing plan and we’ll build a professional, conversion-focused website for your towing company with no upfront development fee.</p>

            <HeroTrustBadges trustpilotSrc="/images/trust-black.png" />

            <div className="hero-actions">
              <a className="button" href="#contact">
                <span>Claim my towing website</span>
            ...
            <div className="proof-row">
              ...
              <div className="proof-item proof-item--yellow">
                ...
                <span>
                  <strong>Towing lead system</strong>
              ...
              <div className="proof-item proof-item--green">
                ...
                <span>
                  <strong>Dispatch-ready growth</strong>
                  <small>Website + towing marketing</small>
                </span>
              </div>
          ...
          <div className="concept-stage">
            ...
            <div className="browser-card">
              <div className="browser-topbar">
                ...
                <div className="address-bar">towingpros.com</div>
              ...
              <div className="design-canvas">
                <div className="canvas-copy">
                  <div className="skeleton-label">TOWING WEBSITE</div>
                  <h2>More calls. More dispatched tows.</h2>
                  <p>A professional towing website connected to the channels that bring your best prospects.</p>
                ...
                <div className="visual-stack industry-visual-stack">
                  <Image
                    src="/images/free-website/free-towing/hero.webp"
                    alt="Towing professional at work"
                    fill
            ...
            <div className="phone-card">
              ...
              <div className="phone-body">
                <span className="phone-kicker">TOWING SITE</span>
            ...
            <div className="floating-note floating-note--bottom">
              ...
              <span>
                <strong>Built for towing leads</strong>
        ...
        <section id="process" className="section process-section">
          <div className="section-heading section-heading--center">
            ...
            <p>Zonic combines the towing website your business needs with recurring marketing built to reach qualified prospects in the markets you serve.</p>
          </div>
          ...
          <div className="process-grid">
            <article>
              ...
              <p>We review your dispatch service mix, markets, current website, lead sources, and the channels most likely to create profitable demand.</p>
            ...
            <article>
              ...
              <p>
                Zonic creates the agreed towing lead-generation website with the upfront development fee waived under your marketing engagement. Same build standard as{" "}
                <Link href="/services/towing-company-website-design" className="offer-inlink">
                  our towing website design service
                </Link>
                .
              </p>
          ...
          <div className="section-cta-row">
            <a className="button" href="#contact">
              <span>Check my towing company</span>
              <span className="button__icon">
                <Icon name="arrow-up-right" />
              </span>
            </a>
        ...
        <section id="lead-tracking" className="section leadtrack-section">
          <div className="leadtrack-copy">
            ...
            <h2>Every towing lead in one place.</h2>
            <p>
              Calls, forms and chats arrive in one dashboard with the source
              attached, so you can see which towing jobs your marketing produced
        ...
        <section id="work" className="section niche-section">
          <div className="section-heading section-heading--split">
            <div>
              <span className="section-kicker">Towing website service paths</span>
              <h2>One towing website. A clear path for every profitable dispatch service.</h2>
            </div>
          ...
          <div className="niche-banner">
            <div className="niche-banner-copy">
              ...
              <h3>We build for every towing service.</h3>
            ...
            <div className="niche-banner-tags">
              ...
              <span className="niche-banner-more">+ every towing service</span>
            </div>
        ...
        <section id="deliverables" className="included-section">
          <div className="section-heading section-heading--center">
            ...
            <h2>More than a towing website handed over and forgotten.</h2>
            <p>Your towing website is built as part of a connected marketing system, with the structure, tracking, and conversion tools needed to support recurring growth.</p>
          </div>
        ...
        <section id="pricing" className="section pricing-section">
          <div className="section-heading section-heading--split">
            <div>
              ...
              <h2>Pick the growth plan. Your Towing website comes with it.</h2>
            </div>
        ...
        <section id="why" className="dark-section">
          ...
          <div className="dark-copy">
            ...
            <h2>The website is the foundation. Marketing creates demand for towing companies.</h2>
            <p>Your plan is selected around your towing market and may combine paid search, local visibility, Google Business Profile growth, tracking, and ongoing conversion improvements.</p>
            <a className="section-button section-button--light" href="#contact">
              <span>Check my towing company</span>
              <i>
                <Icon name="arrow-up-right" />
        ...
        <section className="section terms-section">
          <div className="terms-main">
            ...
            <p>Zonic waives the upfront towing website design and development fee when an eligible business starts a qualifying recurring marketing engagement. Nothing is left vague before you agree.</p>
            <a className="section-button" href="#contact">
              <span>See if my towing company qualifies</span>
              <i>
                <Icon name="arrow-up-right" />
              </i>
            </a>
          ...
          <div className="terms-list">
            <div>
              ...
              <span>
                ...
                <small>The towing website development fee, valued at $2,000. Your monthly plan is billed at full rate and is not discounted.</small>
              </span>
            </div>
            <div>
              <Icon name="check" />
        ...
        <section id="reviews" className="section review-section">
          ...
          <div className="section-cta-row">
            <a className="button" href="#contact">
              <span>Build my towing lead system</span>
              <span className="button__icon">
                <Icon name="arrow-up-right" />
              </span>
            </a>
        ...
        <section id="faqs" className="section faq-section">
          <div className="faq-intro">
            ...
            <a className="section-button" href="#contact">
              <span>Ask about my towing market</span>
              <i>
                <Icon name="arrow-up-right" />
              </i>
            </a>
        ...
        <section id="contact" className="final-cta">
          ...
          <div className="cta-content">
            ...
            <h2>Claim your professional towing website with no upfront development fee.</h2>
            <p>Complete the short eligibility form. Zonic will review your towing company, website needs, service market, and growth goals before recommending a qualifying plan.</p>
            <div className="contact-points">
              <span>
                <Icon name="check" /> Professional towing lead-generation website
              </span>
              <span>
      ...
      <footer className="site-footer">
        <div className="footer-main">
          <div className="footer-brand">
            ...
            <p>Towing lead-generation websites connected to the marketing services that grow towing companies.</p>
        ...
        <nav className="offer-siblings" aria-label="Other free website offers">
          ...
          <div>
            ...
            <Link href="/auto-repair-website-design-agency-us/offer">Auto Repair websites</Link>
        ...
        <div className="footer-bottom">
          <small>
            <strong>OFFER TERMS.</strong> Towing website development fee, valued at $2,000, is
      ...
      <OfferPopupModal
        idPrefix="ofr-towing"
        formType="free-towing-website"
        heading="Get your towing website with no upfront fee."
        serviceLabel="Towing work you want more of"
        servicePlaceholder="Select a towing service"
        services={[
          "Emergency Towing",
          "Roadside Assistance",
          "Accident Recovery",
