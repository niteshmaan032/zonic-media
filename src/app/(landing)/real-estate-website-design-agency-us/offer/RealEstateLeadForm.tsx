...
/** Real Estate revenue lines — the answer routes the follow-up conversation. */
const SERVICES = [
  "Buy a Home",
  "Sell a Home",
  "Luxury Listings",
...
export default function RealEstateLeadForm() {
  ...
  const onSubmit = async (data: FormValues) => {
    ...
    try {
      ...
      const messageParts = [
        `Brokerage or team: ${data.company}`,
      ...
      console.error("Free real estate website form submission failed:", error);
      setSubmitError(
  ...
  return (
    ...
    >
      ...
      <div className="form-heading">
        <span>
          <Icon name="mail" /> Free real estate website eligibility
        </span>
      ...
      <div className="form-grid">
        <div className="form-field">
          <label htmlFor="ofr-real-estate-full-name">Your name *</label>
          <input
            id="ofr-real-estate-full-name"
        ...
        <div className="form-field">
          <label htmlFor="ofr-real-estate-business-name">Brokerage or team *</label>
          <input
            id="ofr-real-estate-business-name"
            placeholder="Brokerage name"
            autoComplete="organization"
            aria-invalid={errors.company ? "true" : "false"}
            {...register("company", {
              required: "Brokerage or team is required.",
              minLength: { value: 2, message: "At least 2 characters." },
        ...
        <div className="form-field">
          <label htmlFor="ofr-real-estate-phone">Phone *</label>
          <input
            id="ofr-real-estate-phone"
            type="tel"
        ...
        <div className="form-field">
          <label htmlFor="ofr-real-estate-email">Email *</label>
          <input
            id="ofr-real-estate-email"
            type="email"
        ...
        <div className="form-field">
          <label htmlFor="ofr-real-estate-website">Current website</label>
          <input
            id="ofr-real-estate-website"
        ...
        <div className="form-field">
          <label htmlFor="ofr-real-estate-service-area">Service area *</label>
          <input
            id="ofr-real-estate-service-area"
        ...
        <div className="form-field form-field--full">
          <label htmlFor="ofr-real-estate-primary-service">
            Which work do you want more of? *
          </label>
          <select
            id="ofr-real-estate-primary-service"
        ...
        <div className="form-field form-field--full">
          <label htmlFor="ofr-real-estate-budget">Monthly marketing budget *</label>
          <select
            id="ofr-real-estate-budget"
            className="form-select standalone-select"
            defaultValue=""
