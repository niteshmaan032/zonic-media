...
import KitchenRemodelingFaqList, { FAQS } from "./KitchenRemodelingFaqList";
import KitchenRemodelingLeadForm from "./KitchenRemodelingLeadForm";
import KitchenRemodelingOfferHeader from "./KitchenRemodelingOfferHeader";
import KitchenRemodelingServiceTabs from "./KitchenRemodelingServiceTabs";
import "./offer.css";

const PAGE_PATH = "/kitchen-remodeling-website-design-agency-us/offer";
...
const breadcrumbJsonLd = buildBreadcrumbJsonLd([
  { name: "Home", url: "/" },
  { name: "Free Kitchen Remodeling Website Offer", url: PAGE_PATH },
]);

const serviceJsonLd = {
  ...buildServiceJsonLd({
    name: "Free Kitchen Remodeling Website Offer",
    description:
      "A conversion-focused kitchen remodeling website with the upfront development fee waived for businesses on a qualifying Zonic Media marketing plan.",
    pageUrl: PAGE_PATH,
    serviceType: "Kitchen Remodeling Website Design",
...
const MARQUEE_ITEMS = [
  "Full Kitchen Remodels leads",
  "Custom Cabinetry leads",
  "Countertops leads",
  "Kitchen Islands leads",
  "Lighting & Layout leads",
  "Design-Build leads",
];
...
export const metadata: Metadata = {
  title: { absolute: "Free Kitchen Remodeling Website for Remodelers | Zonic Media" },
  description:
    "Free kitchen remodeling website, no upfront development fee, when you start a qualifying Zonic marketing plan. Built to rank and book jobs.",
  // Offer-intent terms, kept disjoint from the head terms the matching
  // /services page targets so the two do not compete.
  keywords: [
    "free kitchen remodeling website",
    "kitchen remodeling website design",
    "remodeling contractor website",
    "free website for remodelers",
    "kitchen remodeler web design",
  ...
  openGraph: {
    title: "Free Kitchen Remodeling Website Offer | Zonic Media",
    description:
      "Free kitchen remodeling website, no upfront development fee, when you start a qualifying Zonic marketing plan. Built to rank and book jobs.",
    url: PAGE_PATH,
    type: "website",
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Zonic Media free kitchen remodeling website offer",
      },
    ],
  },
...
export default function KitchenRemodelingOfferPage() {
  const marqueeItems = [...MARQUEE_ITEMS, ...MARQUEE_ITEMS];

  return (
    <div className="ofr-kitchen-remodeling" id="top">
      <script
      ...
      <main id="main-content">
        ...
        <section className="hero" aria-labelledby="hero-title">
          <div className="hero-copy">
            <div className="eyebrow">
              ...
              <span>Free website offer for kitchen remodelers</span>
              <Icon name="sparkles" />
            </div>
            ...
            <p className="hero-lede">Start a qualifying Zonic Media marketing plan and we’ll build a professional, conversion-focused website for your kitchen remodeling company with no upfront development fee.</p>
            ...
            <div className="proof-row">
              ...
              <div className="proof-item proof-item--yellow">
                ...
                <span>
                  <strong>Kitchen Remodeling lead system</strong>
          ...
          <div className="concept-stage">
            ...
            <div className="browser-card">
              <div className="browser-topbar">
                ...
                <div className="address-bar">kitchenremodelingpros.com</div>
              ...
              <div className="design-canvas">
                <div className="canvas-copy">
                  <div className="skeleton-label">KITCHEN REMODELING WEBSITE</div>
                  <h2>More consultations. More kitchen projects.</h2>
                  <p>A professional kitchen remodeling website connected to the channels that bring your best prospects.</p>
                ...
                <div className="visual-stack industry-visual-stack">
                  <Image
                    src="/images/free-website/free-kitchen-remodeling/hero.webp"
                    alt="Kitchen Remodeling professional at work"
                    fill
            ...
            <div className="phone-card">
              ...
              <div className="phone-body">
                <span className="phone-kicker">KITCHEN REMODELING SITE</span>
            ...
            <div className="floating-note floating-note--bottom">
              ...
              <span>
                <strong>Built for kitchen remodeling leads</strong>
        ...
        <section id="process" className="section process-section">
          <div className="section-heading section-heading--center">
            ...
            <p>Zonic combines the kitchen remodeling website your business needs with recurring marketing built to reach qualified prospects in the markets you serve.</p>
          </div>
          ...
          <div className="process-grid">
            ...
            <article>
              ...
              <p>
                Zonic creates the agreed kitchen remodeling lead-generation website with the upfront development fee waived under your marketing engagement. Same build standard as{" "}
                <Link href="/services/kitchen-remodeling-website-design" className="offer-inlink">
                  our kitchen remodeling website design service
                </Link>
                .
              </p>
          ...
          <div className="section-cta-row">
            <a className="button" href="#contact">
              <span>Check my kitchen remodeling company</span>
              <span className="button__icon">
                <Icon name="arrow-up-right" />
              </span>
            </a>
        ...
        <section id="lead-tracking" className="section leadtrack-section">
          <div className="leadtrack-copy">
            ...
            <h2>Every kitchen remodeling lead in one place.</h2>
            <p>
              Calls, forms and chats arrive in one dashboard with the source
              attached, so you can see which kitchen remodeling jobs your marketing produced
          ...
          <div className="leadtrack-panel">
            ...
            <div className="leadtrack-row">
              <b>
                Marcus D.
                <small>Full Kitchen Remodels</small>
              </b>
        ...
        <section id="work" className="section niche-section">
          <div className="section-heading section-heading--split">
            <div>
              <span className="section-kicker">Kitchen Remodeling website service paths</span>
              <h2>One kitchen remodeling website. A clear path for every profitable remodeling service.</h2>
            </div>
          ...
          <div className="niche-banner">
            <div className="niche-banner-copy">
              ...
              <h3>We build for every kitchen remodeling service.</h3>
            ...
            <div className="niche-banner-tags">
              ...
              <span className="niche-banner-more">+ every kitchen remodeling service</span>
            </div>
            <a className="section-button section-button--light" href="#contact">
              <span>Claim my kitchen remodeling website</span>
              <i>
                <Icon name="arrow-up-right" />
              </i>
            </a>
        ...
        <section id="deliverables" className="included-section">
          <div className="section-heading section-heading--center">
            ...
            <h2>More than a kitchen remodeling website handed over and forgotten.</h2>
            <p>Your kitchen remodeling website is built as part of a connected marketing system, with the structure, tracking, and conversion tools needed to support recurring growth.</p>
          </div>
        ...
        <section id="pricing" className="section pricing-section">
          <div className="section-heading section-heading--split">
            <div>
              ...
              <h2>Pick the growth plan. Your Kitchen Remodeling website comes with it.</h2>
            </div>
        ...
        <section id="why" className="dark-section">
          ...
          <div className="dark-copy">
            ...
            <h2>The website is the foundation. Marketing creates demand for kitchen remodelers.</h2>
            <p>Your plan is selected around your kitchen remodeling market and may combine paid search, local visibility, Google Business Profile growth, tracking, and ongoing conversion improvements.</p>
            <a className="section-button section-button--light" href="#contact">
              <span>Check my kitchen remodeling company</span>
              <i>
                <Icon name="arrow-up-right" />
        ...
        <section className="section terms-section">
          <div className="terms-main">
            ...
            <p>Zonic waives the upfront kitchen remodeling website design and development fee when an eligible business starts a qualifying recurring marketing engagement. Nothing is left vague before you agree.</p>
            <a className="section-button" href="#contact">
              <span>See if my kitchen remodeling company qualifies</span>
              <i>
                <Icon name="arrow-up-right" />
              </i>
            </a>
          ...
          <div className="terms-list">
            <div>
              ...
              <span>
                ...
                <small>The kitchen remodeling website development fee, valued at $2,000. Your monthly plan is billed at full rate and is not discounted.</small>
              </span>
            </div>
            <div>
              <Icon name="check" />
        ...
        <section id="reviews" className="section review-section">
          ...
          <div className="section-cta-row">
            <a className="button" href="#contact">
              <span>Build my kitchen remodeling lead system</span>
              <span className="button__icon">
                <Icon name="arrow-up-right" />
              </span>
            </a>
        ...
        <section id="faqs" className="section faq-section">
          <div className="faq-intro">
            ...
            <a className="section-button" href="#contact">
              <span>Ask about my kitchen remodeling market</span>
              <i>
                <Icon name="arrow-up-right" />
              </i>
            </a>
        ...
        <section id="contact" className="final-cta">
          ...
          <div className="cta-content">
            ...
            <h2>Claim your professional kitchen remodeling website with no upfront development fee.</h2>
            <p>Complete the short eligibility form. Zonic will review your kitchen remodeling company, website needs, service market, and growth goals before recommending a qualifying plan.</p>
            <div className="contact-points">
              <span>
                <Icon name="check" /> Professional kitchen remodeling lead-generation website
              </span>
              <span>
      ...
      <footer className="site-footer">
        <div className="footer-main">
          <div className="footer-brand">
            ...
            <p>Kitchen Remodeling lead-generation websites connected to the marketing services that grow kitchen remodelers.</p>
          ...
          <div className="footer-nav-group">
            ...
            <a href="#work">Kitchen Remodeling services</a>
          ...
          <div className="footer-offer">
            <span>Kitchen Remodeling Website Launch Offer</span>
            <strong>$0 upfront development fee</strong>
            <p>With a qualifying marketing plan at $895/month or above on a six-month term.</p>
            <a href="#ofr-kitchen-remodeling-offer-form">
              Get my kitchen remodeling website <Icon name="arrow-right" />
            </a>
          </div>
        </div>
        ...
        <nav className="offer-siblings" aria-label="Other free website offers">
          ...
          <div>
            ...
            <Link href="/law-firm-website-design-agency-us/offer">Law Firm websites</Link>
        ...
        <div className="footer-bottom">
          <small>
            <strong>OFFER TERMS.</strong> Kitchen Remodeling website development fee, valued at $2,000, is
      ...
      <OfferPopupModal
        idPrefix="ofr-kitchen-remodeling"
        formType="free-kitchen-remodeling-website"
        heading="Get your kitchen remodeling website with no upfront fee."
        serviceLabel="Kitchen Remodeling work you want more of"
        servicePlaceholder="Select a kitchen remodeling service"
        services={[
