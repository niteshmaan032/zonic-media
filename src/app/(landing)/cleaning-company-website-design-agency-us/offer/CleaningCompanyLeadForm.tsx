...
/** Cleaning Company revenue lines — the answer routes the follow-up conversation. */
const SERVICES = [
  "Office Cleaning",
  "Janitorial Services",
  "Medical Facilities",
...
export default function CleaningCompanyLeadForm() {
  ...
  const onSubmit = async (data: FormValues) => {
    ...
    try {
      ...
      console.error("Free cleaning company website form submission failed:", error);
      setSubmitError(
  ...
  return (
    <form
      id="ofr-cleaning-company-offer-form"
    ...
    >
      ...
      <div className="form-heading">
        <span>
          <Icon name="mail" /> Free cleaning company website eligibility
        </span>
      ...
      <div className="form-grid">
        <div className="form-field">
          <label htmlFor="ofr-cleaning-company-full-name">Your name *</label>
          <input
            id="ofr-cleaning-company-full-name"
        ...
        <div className="form-field">
          <label htmlFor="ofr-cleaning-company-business-name">Cleaning company *</label>
          <input
            id="ofr-cleaning-company-business-name"
            placeholder="Company name"
            autoComplete="organization"
            aria-invalid={errors.company ? "true" : "false"}
            {...register("company", {
              required: "Cleaning company is required.",
              minLength: { value: 2, message: "At least 2 characters." },
        ...
        <div className="form-field">
          <label htmlFor="ofr-cleaning-company-phone">Phone *</label>
          <input
            id="ofr-cleaning-company-phone"
            type="tel"
        ...
        <div className="form-field">
          <label htmlFor="ofr-cleaning-company-email">Email *</label>
          <input
            id="ofr-cleaning-company-email"
            type="email"
        ...
        <div className="form-field">
          <label htmlFor="ofr-cleaning-company-website">Current website</label>
          <input
            id="ofr-cleaning-company-website"
        ...
        <div className="form-field">
          <label htmlFor="ofr-cleaning-company-service-area">Service area *</label>
          <input
            id="ofr-cleaning-company-service-area"
        ...
        <div className="form-field form-field--full">
          <label htmlFor="ofr-cleaning-company-primary-service">
            Which work do you want more of? *
          </label>
          <select
            id="ofr-cleaning-company-primary-service"
          ...
          >
            <option value="" disabled>
              Select a cleaning company service
            </option>
        ...
        <div className="form-field form-field--full">
          <label htmlFor="ofr-cleaning-company-budget">Monthly marketing budget *</label>
          <select
            id="ofr-cleaning-company-budget"
            className="form-select standalone-select"
            defaultValue=""
