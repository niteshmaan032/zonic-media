...
import CleaningCompanyFaqList, { FAQS } from "./CleaningCompanyFaqList";
import CleaningCompanyLeadForm from "./CleaningCompanyLeadForm";
import CleaningCompanyOfferHeader from "./CleaningCompanyOfferHeader";
import CleaningCompanyServiceTabs from "./CleaningCompanyServiceTabs";
import "./offer.css";

const PAGE_PATH = "/cleaning-company-website-design-agency-us/offer";
...
const breadcrumbJsonLd = buildBreadcrumbJsonLd([
  { name: "Home", url: "/" },
  { name: "Free Cleaning Company Website Offer", url: PAGE_PATH },
]);

const serviceJsonLd = {
  ...buildServiceJsonLd({
    name: "Free Cleaning Company Website Offer",
    description:
      "A conversion-focused cleaning company website with the upfront development fee waived for businesses on a qualifying Zonic Media marketing plan.",
    pageUrl: PAGE_PATH,
...
const MARQUEE_ITEMS = [
  ...
  "Janitorial Services leads",
  "Medical Facilities leads",
  "Retail & Hospitality leads",
  "Deep Cleaning leads",
  "Floor Care leads",
];
...
export const metadata: Metadata = {
  title: { absolute: "Free Cleaning Company Website for Cleaners | Zonic Media" },
  description:
    "Free cleaning company website, no upfront development fee, when you start a qualifying Zonic marketing plan. Built to rank and book jobs.",
  // Offer-intent terms, kept disjoint from the head terms the matching
  // /services page targets so the two do not compete.
  keywords: [
    "free cleaning company website",
    "cleaning company website design",
    "cleaning business website",
    "free website for cleaning business",
  ...
  openGraph: {
    title: "Free Cleaning Company Website Offer | Zonic Media",
    description:
      "Free cleaning company website, no upfront development fee, when you start a qualifying Zonic marketing plan. Built to rank and book jobs.",
    url: PAGE_PATH,
    type: "website",
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Zonic Media free cleaning company website offer",
      },
    ],
  },
...
export default function CleaningCompanyOfferPage() {
  const marqueeItems = [...MARQUEE_ITEMS, ...MARQUEE_ITEMS];

  return (
    <div className="ofr-cleaning-company" id="top">
      <script
      ...
      <main id="main-content">
        ...
        <section className="hero" aria-labelledby="hero-title">
          <div className="hero-copy">
            <div className="eyebrow">
              ...
              <span>Free website offer for cleaning companies</span>
              <Icon name="sparkles" />
            </div>
            ...
            <p className="hero-lede">Start a qualifying Zonic Media marketing plan and we’ll build a professional, conversion-focused website for your cleaning company with no upfront development fee.</p>
            ...
            <div className="proof-row">
              ...
              <div className="proof-item proof-item--yellow">
                ...
                <span>
                  <strong>Cleaning Company lead system</strong>
              ...
              <div className="proof-item proof-item--green">
                ...
                <span>
                  <strong>Contract-ready growth</strong>
                  <small>Website + cleaning marketing</small>
                </span>
              </div>
          ...
          <div className="concept-stage">
            ...
            <div className="browser-card">
              <div className="browser-topbar">
                ...
                <div className="address-bar">cleaningcompanypros.com</div>
              ...
              <div className="design-canvas">
                <div className="canvas-copy">
                  <div className="skeleton-label">CLEANING COMPANY WEBSITE</div>
                  <h2>More enquiries. More recurring cleaning accounts.</h2>
                  <p>A professional cleaning company website connected to the channels that bring your best prospects.</p>
                ...
                <div className="visual-stack industry-visual-stack">
                  <Image
                    src="/images/free-website/free-cleaning-company/hero.webp"
                    alt="Cleaning Company professional at work"
                    fill
            ...
            <div className="phone-card">
              ...
              <div className="phone-body">
                <span className="phone-kicker">CLEANING COMPANY SITE</span>
            ...
            <div className="floating-note floating-note--bottom">
              ...
              <span>
                <strong>Built for cleaning company leads</strong>
        ...
        <section id="process" className="section process-section">
          <div className="section-heading section-heading--center">
            ...
            <p>Zonic combines the cleaning company website your business needs with recurring marketing built to reach qualified prospects in the markets you serve.</p>
          </div>
          ...
          <div className="process-grid">
            <article>
              ...
              <p>We review your cleaning service mix, markets, current website, lead sources, and the channels most likely to create profitable demand.</p>
            ...
            <article>
              ...
              <p>
                Zonic creates the agreed cleaning company lead-generation website with the upfront development fee waived under your marketing engagement. Same build standard as{" "}
                <Link href="/services/commercial-cleaning-website-design" className="offer-inlink">
                  our cleaning company website design service
                </Link>
                .
              </p>
          ...
          <div className="section-cta-row">
            <a className="button" href="#contact">
              <span>Check my cleaning company company</span>
              <span className="button__icon">
                <Icon name="arrow-up-right" />
              </span>
            </a>
        ...
        <section id="lead-tracking" className="section leadtrack-section">
          <div className="leadtrack-copy">
            ...
            <h2>Every cleaning company lead in one place.</h2>
            <p>
              Calls, forms and chats arrive in one dashboard with the source
              attached, so you can see which cleaning company jobs your marketing produced
          ...
          <div className="leadtrack-panel">
            ...
            <div className="leadtrack-row">
              <b>
                Priya S.
                <small>Janitorial Services</small>
              </b>
            ...
            <div className="leadtrack-row">
              <b>
                Elena V.
                <small>Retail & Hospitality</small>
              </b>
        ...
        <section id="work" className="section niche-section">
          <div className="section-heading section-heading--split">
            <div>
              <span className="section-kicker">Cleaning Company website service paths</span>
              <h2>One cleaning company website. A clear path for every profitable cleaning service.</h2>
            </div>
          ...
          <div className="niche-banner">
            <div className="niche-banner-copy">
              ...
              <h3>We build for every cleaning company service.</h3>
            ...
            <div className="niche-banner-tags">
              ...
              <span className="niche-banner-more">+ every cleaning company service</span>
            </div>
            <a className="section-button section-button--light" href="#contact">
              <span>Claim my cleaning company website</span>
              <i>
                <Icon name="arrow-up-right" />
              </i>
            </a>
        ...
        <section id="deliverables" className="included-section">
          <div className="section-heading section-heading--center">
            ...
            <h2>More than a cleaning company website handed over and forgotten.</h2>
            <p>Your cleaning company website is built as part of a connected marketing system, with the structure, tracking, and conversion tools needed to support recurring growth.</p>
          </div>
        ...
        <section id="pricing" className="section pricing-section">
          <div className="section-heading section-heading--split">
            <div>
              ...
              <h2>Pick the growth plan. Your Cleaning Company website comes with it.</h2>
            </div>
        ...
        <section id="why" className="dark-section">
          ...
          <div className="dark-copy">
            ...
            <h2>The website is the foundation. Marketing creates demand for cleaning companies.</h2>
            <p>Your plan is selected around your cleaning company market and may combine paid search, local visibility, Google Business Profile growth, tracking, and ongoing conversion improvements.</p>
            <a className="section-button section-button--light" href="#contact">
              <span>Check my cleaning company company</span>
              <i>
                <Icon name="arrow-up-right" />
        ...
        <section className="section terms-section">
          <div className="terms-main">
            ...
            <p>Zonic waives the upfront cleaning company website design and development fee when an eligible business starts a qualifying recurring marketing engagement. Nothing is left vague before you agree.</p>
            <a className="section-button" href="#contact">
              <span>See if my cleaning company company qualifies</span>
              <i>
                <Icon name="arrow-up-right" />
              </i>
            </a>
          ...
          <div className="terms-list">
            <div>
              ...
              <span>
                ...
                <small>The cleaning company website development fee, valued at $2,000. Your monthly plan is billed at full rate and is not discounted.</small>
              </span>
            </div>
            <div>
              <Icon name="check" />
        ...
        <section id="reviews" className="section review-section">
          ...
          <div className="section-cta-row">
            <a className="button" href="#contact">
              <span>Build my cleaning company lead system</span>
              <span className="button__icon">
                <Icon name="arrow-up-right" />
              </span>
            </a>
        ...
        <section id="faqs" className="section faq-section">
          <div className="faq-intro">
            ...
            <a className="section-button" href="#contact">
              <span>Ask about my cleaning company market</span>
              <i>
                <Icon name="arrow-up-right" />
              </i>
            </a>
        ...
        <section id="contact" className="final-cta">
          ...
          <div className="cta-content">
            ...
            <h2>Claim your professional cleaning company website with no upfront development fee.</h2>
            <p>Complete the short eligibility form. Zonic will review your cleaning company, website needs, service market, and growth goals before recommending a qualifying plan.</p>
            <div className="contact-points">
              <span>
                <Icon name="check" /> Professional cleaning company lead-generation website
              </span>
              <span>
      ...
      <footer className="site-footer">
        <div className="footer-main">
          <div className="footer-brand">
            ...
            <p>Cleaning Company lead-generation websites connected to the marketing services that grow cleaning companies.</p>
          ...
          <div className="footer-nav-group">
            ...
            <a href="#work">Cleaning Company services</a>
          ...
          <div className="footer-offer">
            <span>Cleaning Company Website Launch Offer</span>
            <strong>$0 upfront development fee</strong>
            <p>With a qualifying marketing plan at $895/month or above on a six-month term.</p>
            <a href="#ofr-cleaning-company-offer-form">
              Get my cleaning company website <Icon name="arrow-right" />
            </a>
          </div>
        </div>
        ...
        <nav className="offer-siblings" aria-label="Other free website offers">
          ...
          <div>
            ...
            <Link href="/flooring-website-design-agency-us/offer">Flooring websites</Link>
            <Link href="/garage-door-website-design-agency-us/offer">Garage Door websites</Link>
          </div>
        </nav>
        ...
        <div className="footer-bottom">
          <small>
            <strong>OFFER TERMS.</strong> Cleaning Company website development fee, valued at $2,000, is
      ...
      <OfferPopupModal
        idPrefix="ofr-cleaning-company"
        formType="free-cleaning-company-website"
        heading="Get your cleaning company website with no upfront fee."
        serviceLabel="Cleaning Company work you want more of"
        servicePlaceholder="Select a cleaning company service"
        services={[
          "Office Cleaning",
          "Janitorial Services",
          "Medical Facilities",
