...
const NAV_ITEMS = [
  ...
  { label: "Law Firm services", href: "#work" },
...
export default function LawFirmOfferHeader() {
  ...
  useEffect(() => {
    ...
    document.body.classList.add("ofr-law-firm-menu-is-open");
    return () => {
      document.removeEventListener("keydown", closeOnEscape);
      document.body.classList.remove("ofr-law-firm-menu-is-open");
    };
  }, [menuOpen]);
  ...
  return (
    <>
      <a className="ofr-law-firm-skip-link" href="#main-content">
        Skip to content
      </a>
      ...
      <header className={`nav-wrap${scrolled || menuOpen ? " is-scrolled" : ""}`}>
        ...
        <a className="nav-cta" href="#contact">
          Claim my law firm website <Icon name="arrow-up-right" />
        </a>
        ...
        <button
          ...
          aria-controls="ofr-law-firm-mobile-menu"
