...
/** Law Firm revenue lines — the answer routes the follow-up conversation. */
const SERVICES = [
  "Personal Injury",
  "Family Law",
  "Criminal Defense",
...
export default function LawFirmLeadForm() {
  ...
  const onSubmit = async (data: FormValues) => {
    ...
    try {
      ...
      console.error("Free law firm website form submission failed:", error);
      setSubmitError(
  ...
  return (
    ...
    >
      ...
      <div className="form-heading">
        <span>
          <Icon name="mail" /> Free law firm website eligibility
        </span>
      ...
      <div className="form-grid">
        <div className="form-field">
          <label htmlFor="ofr-law-firm-full-name">Your name *</label>
          <input
            id="ofr-law-firm-full-name"
        ...
        <div className="form-field">
          <label htmlFor="ofr-law-firm-business-name">Law firm *</label>
          <input
            id="ofr-law-firm-business-name"
        ...
        <div className="form-field">
          <label htmlFor="ofr-law-firm-phone">Phone *</label>
          <input
            id="ofr-law-firm-phone"
            type="tel"
        ...
        <div className="form-field">
          <label htmlFor="ofr-law-firm-email">Email *</label>
          <input
            id="ofr-law-firm-email"
            type="email"
        ...
        <div className="form-field">
          <label htmlFor="ofr-law-firm-website">Current website</label>
          <input
            id="ofr-law-firm-website"
        ...
        <div className="form-field">
          <label htmlFor="ofr-law-firm-service-area">Service area *</label>
          <input
            id="ofr-law-firm-service-area"
        ...
        <div className="form-field form-field--full">
          <label htmlFor="ofr-law-firm-primary-service">
            Which work do you want more of? *
          </label>
          <select
            id="ofr-law-firm-primary-service"
        ...
        <div className="form-field form-field--full">
          <label htmlFor="ofr-law-firm-budget">Monthly marketing budget *</label>
          <select
            id="ofr-law-firm-budget"
            className="form-select standalone-select"
            defaultValue=""
