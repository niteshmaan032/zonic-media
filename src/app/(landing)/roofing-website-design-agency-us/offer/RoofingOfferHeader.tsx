...
const NAV_ITEMS = [
  ...
  { label: "Roofing services", href: "#work" },
...
export default function RoofingOfferHeader() {
  ...
  useEffect(() => {
    ...
    document.body.classList.add("rwd-menu-is-open");

    return () => {
      document.removeEventListener("keydown", closeOnEscape);
      document.body.classList.remove("rwd-menu-is-open");
    };
  }, [menuOpen]);
  ...
  return (
    <>
      <a className="rwd-skip-link" href="#main-content">
        Skip to content
      </a>
      ...
      <header className={`nav-wrap${scrolled || menuOpen ? " is-scrolled" : ""}`}>
        ...
        <a className="nav-cta" href="#contact">
          Claim my roofing website <Icon name="arrow-up-right" />
        </a>
