...
export default function RoofingLeadForm() {
  ...
  const onSubmit = async (data: FormValues) => {
    ...
    try {
      ...
      console.error("Free roofing website form submission failed:", error);
      setSubmitError(
  ...
  return (
    ...
    >
      ...
      <div className="form-heading">
        <span>
          <Icon name="mail" /> Free roofing website eligibility
        </span>
        <h3>See If Your Roofing Company Qualifies.</h3>
        <p>
      ...
      <div className="form-grid">
        <div className="form-field">
          <label htmlFor="rwd-full-name">Your name *</label>
          <input
            id="rwd-full-name"
        ...
        <div className="form-field">
          <label htmlFor="rwd-business-name">Roofing company *</label>
          <input
            id="rwd-business-name"
            placeholder="Roofing company name"
            autoComplete="organization"
            aria-invalid={errors.company ? "true" : "false"}
            {...register("company", {
              required: "Roofing company name is required.",
              minLength: { value: 2, message: "At least 2 characters." },
        ...
        <div className="form-field">
          <label htmlFor="rwd-phone">Phone *</label>
          <input
            id="rwd-phone"
            type="tel"
        ...
        <div className="form-field">
          <label htmlFor="rwd-email">Email *</label>
          <input
            id="rwd-email"
            type="email"
        ...
        <div className="form-field">
          <label htmlFor="rwd-website">Current website</label>
          <input
            id="rwd-website"
        ...
        <div className="form-field">
          <label htmlFor="rwd-service-area">Roofing service area *</label>
          <input
            id="rwd-service-area"
        ...
        <div className="form-field form-field--full">
          <label htmlFor="rwd-primary-service">
            Which roofing work do you want more of? *
          </label>
          <select
            id="rwd-primary-service"
            className="form-select standalone-select"
            defaultValue=""
            aria-invalid={errors.primaryService ? "true" : "false"}
            {...register("primaryService", {
              required: "Please select your primary roofing service.",
            })}
          >
        ...
        <div className="form-field form-field--full">
          <label htmlFor="rwd-budget">Monthly marketing budget *</label>
          <select
            id="rwd-budget"
            className="form-select standalone-select"
            defaultValue=""
      ...
      <p className="form-note">
        Submitting starts a conversation, not a contract. The free roofing
        website requires a qualifying plan at $895/month on a 6-month term.
      </p>
