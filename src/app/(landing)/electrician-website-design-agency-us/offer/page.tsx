...
import ElectricianFaqList, { FAQS } from "./ElectricianFaqList";
import ElectricianLeadForm from "./ElectricianLeadForm";
import ElectricianOfferHeader from "./ElectricianOfferHeader";
import ElectricianServiceTabs from "./ElectricianServiceTabs";
import "./offer.css";

const PAGE_PATH = "/electrician-website-design-agency-us/offer";
...
const breadcrumbJsonLd = buildBreadcrumbJsonLd([
  { name: "Home", url: "/" },
  { name: "Free Electrician Website Offer", url: PAGE_PATH },
]);

const serviceJsonLd = {
  ...buildServiceJsonLd({
    name: "Free Electrician Website Offer",
    description:
      "A conversion-focused electrician website with the upfront development fee waived for businesses on a qualifying Zonic Media marketing plan.",
    pageUrl: PAGE_PATH,
...
const MARQUEE_ITEMS = [
  ...
  "Panel Upgrades leads",
  "EV Chargers leads",
  "Whole-Home Rewiring leads",
  "Lighting Installation leads",
  "Commercial Electrical leads",
];
...
export const metadata: Metadata = {
  title: { absolute: "Free Electrician Website for Electrical Contractors | Zonic" },
  description:
    "Free electrician website, no upfront development fee, when you start a qualifying Zonic marketing plan. Emergency, EV charger and panel-upgrade pages included.",
  ...
  openGraph: {
    title: "Free Electrician Website Offer | Zonic Media",
    description:
      "Free electrician website, no upfront development fee, when you start a qualifying Zonic marketing plan. Emergency, EV charger and panel-upgrade pages included.",
    url: PAGE_PATH,
    type: "website",
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Zonic Media free electrician website offer",
      },
    ],
  },
...
export default function ElectricianOfferPage() {
  const marqueeItems = [...MARQUEE_ITEMS, ...MARQUEE_ITEMS];

  return (
    <div className="ofr-electrician" id="top">
      <script
      ...
      <main id="main-content">
        ...
        <section className="hero" aria-labelledby="hero-title">
          <div className="hero-copy">
            <div className="eyebrow">
              ...
              <span>Free website offer for electricians</span>
              <Icon name="sparkles" />
            </div>
            ...
            <p className="hero-lede">Start a qualifying Zonic Media marketing plan and we’ll build a professional, conversion-focused website for your electrician company with no upfront development fee.</p>
            ...
            <div className="proof-row">
              ...
              <div className="proof-item proof-item--yellow">
                ...
                <span>
                  <strong>Electrician lead system</strong>
              ...
              <div className="proof-item proof-item--green">
                ...
                <span>
                  <strong>Call-ready growth</strong>
                  <small>Website + electrical marketing</small>
                </span>
              </div>
          ...
          <div className="concept-stage">
            ...
            <div className="browser-card">
              <div className="browser-topbar">
                ...
                <div className="address-bar">electricianpros.com</div>
              ...
              <div className="design-canvas">
                <div className="canvas-copy">
                  <div className="skeleton-label">ELECTRICIAN WEBSITE</div>
                  <h2>More calls. More booked electrical jobs.</h2>
                  <p>A professional electrician website connected to the channels that bring your best prospects.</p>
                ...
                <div className="visual-stack industry-visual-stack">
                  <Image
                    src="/images/free-website/free-electrician/hero.webp"
                    alt="Electrician professional at work"
                    fill
            ...
            <div className="phone-card">
              ...
              <div className="phone-body">
                <span className="phone-kicker">ELECTRICIAN SITE</span>
            ...
            <div className="floating-note floating-note--bottom">
              ...
              <span>
                <strong>Built for electrician leads</strong>
        ...
        <section id="process" className="section process-section">
          <div className="section-heading section-heading--center">
            ...
            <p>Zonic combines the electrician website your business needs with recurring marketing built to reach qualified prospects in the markets you serve.</p>
          </div>
          ...
          <div className="process-grid">
            <article>
              ...
              <p>We review your electrical service mix, markets, current website, lead sources, and the channels most likely to create profitable demand.</p>
            ...
            <article>
              ...
              <p>
                Zonic creates the agreed electrician lead-generation website with the upfront development fee waived under your marketing engagement. Same build standard as{" "}
                <Link href="/services/electrical-website-design" className="offer-inlink">
                  our electrician website design service
                </Link>
                .
              </p>
          ...
          <div className="section-cta-row">
            <a className="button" href="#contact">
              <span>Check my electrician company</span>
              <span className="button__icon">
                <Icon name="arrow-up-right" />
              </span>
            </a>
        ...
        <section id="lead-tracking" className="section leadtrack-section">
          <div className="leadtrack-copy">
            ...
            <h2>Every electrician lead in one place.</h2>
            <p>
              Calls, forms and chats arrive in one dashboard with the source
              attached, so you can see which electrician jobs your marketing produced
          ...
          <div className="leadtrack-panel">
            ...
            <div className="leadtrack-row">
              <b>
                Marcus D.
                <small>Emergency Electrical</small>
              </b>
            ...
            <div className="leadtrack-row">
              <b>
                Elena V.
                <small>Whole-Home Rewiring</small>
              </b>
        ...
        <section id="work" className="section niche-section">
          <div className="section-heading section-heading--split">
            <div>
              <span className="section-kicker">Electrician website service paths</span>
              <h2>One electrician website. A clear path for every profitable electrical service.</h2>
            </div>
          ...
          <div className="niche-banner">
            <div className="niche-banner-copy">
              ...
              <h3>We build for every electrician service.</h3>
            ...
            <div className="niche-banner-tags">
              ...
              <span className="niche-banner-more">+ every electrician service</span>
            </div>
            <a className="section-button section-button--light" href="#contact">
              <span>Claim my electrician website</span>
              <i>
                <Icon name="arrow-up-right" />
              </i>
            </a>
        ...
        <section id="deliverables" className="included-section">
          <div className="section-heading section-heading--center">
            ...
            <h2>More than a electrician website handed over and forgotten.</h2>
            <p>Your electrician website is built as part of a connected marketing system, with the structure, tracking, and conversion tools needed to support recurring growth.</p>
          </div>
        ...
        <section id="pricing" className="section pricing-section">
          <div className="section-heading section-heading--split">
            <div>
              ...
              <h2>Pick the growth plan. Your Electrician website comes with it.</h2>
            </div>
        ...
        <section id="why" className="dark-section">
          ...
          <div className="dark-copy">
            ...
            <h2>The website is the foundation. Marketing creates demand for electrical contractors.</h2>
            <p>Your plan is selected around your electrician market and may combine paid search, local visibility, Google Business Profile growth, tracking, and ongoing conversion improvements.</p>
            <a className="section-button section-button--light" href="#contact">
              <span>Check my electrician company</span>
              <i>
                <Icon name="arrow-up-right" />
        ...
        <section className="section terms-section">
          <div className="terms-main">
            ...
            <p>Zonic waives the upfront electrician website design and development fee when an eligible business starts a qualifying recurring marketing engagement. Nothing is left vague before you agree.</p>
            <a className="section-button" href="#contact">
              <span>See if my electrician company qualifies</span>
              <i>
                <Icon name="arrow-up-right" />
              </i>
            </a>
          ...
          <div className="terms-list">
            <div>
              ...
              <span>
                ...
                <small>The electrician website development fee, valued at $2,000. Your monthly plan is billed at full rate and is not discounted.</small>
              </span>
            </div>
            <div>
              <Icon name="check" />
        ...
        <section id="reviews" className="section review-section">
          ...
          <div className="section-cta-row">
            <a className="button" href="#contact">
              <span>Build my electrician lead system</span>
              <span className="button__icon">
                <Icon name="arrow-up-right" />
              </span>
            </a>
        ...
        <section id="faqs" className="section faq-section">
          <div className="faq-intro">
            ...
            <a className="section-button" href="#contact">
              <span>Ask about my electrician market</span>
              <i>
                <Icon name="arrow-up-right" />
              </i>
            </a>
        ...
        <section id="contact" className="final-cta">
          ...
          <div className="cta-content">
            ...
            <h2>Claim your professional electrician website with no upfront development fee.</h2>
            <p>Complete the short eligibility form. Zonic will review your electrician company, website needs, service market, and growth goals before recommending a qualifying plan.</p>
            <div className="contact-points">
              <span>
                <Icon name="check" /> Professional electrician lead-generation website
              </span>
              <span>
      ...
      <footer className="site-footer">
        <div className="footer-main">
          <div className="footer-brand">
            ...
            <p>Electrician lead-generation websites connected to the marketing services that grow electrical contractors.</p>
          ...
          <div className="footer-nav-group">
            ...
            <a href="#work">Electrician services</a>
          ...
          <div className="footer-offer">
            <span>Electrician Website Launch Offer</span>
            <strong>$0 upfront development fee</strong>
            <p>With a qualifying marketing plan at $895/month or above on a six-month term.</p>
            <a href="#ofr-electrician-offer-form">
              Get my electrician website <Icon name="arrow-right" />
            </a>
          </div>
        </div>
        ...
        <div className="footer-bottom">
          <small>
            <strong>OFFER TERMS.</strong> Electrician website development fee, valued at $2,000, is
      ...
      <OfferPopupModal
        idPrefix="ofr-electrician"
        formType="free-electrician-website"
        heading="Get your electrician website with no upfront fee."
        serviceLabel="Electrician work you want more of"
        servicePlaceholder="Select a electrician service"
        services={[
