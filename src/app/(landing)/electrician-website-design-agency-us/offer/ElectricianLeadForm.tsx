...
/** Electrician revenue lines — the answer routes the follow-up conversation. */
const SERVICES = [
...
export default function ElectricianLeadForm() {
  ...
  const onSubmit = async (data: FormValues) => {
    ...
    try {
      ...
      console.error("Free electrician website form submission failed:", error);
      setSubmitError(
  ...
  return (
    ...
    >
      ...
      <div className="form-heading">
        <span>
          <Icon name="mail" /> Free electrician website eligibility
        </span>
      ...
      <div className="form-grid">
        <div className="form-field">
          <label htmlFor="ofr-electrician-full-name">Your name *</label>
          <input
            id="ofr-electrician-full-name"
        ...
        <div className="form-field">
          <label htmlFor="ofr-electrician-business-name">Electrical company *</label>
          <input
            id="ofr-electrician-business-name"
            placeholder="Company name"
            autoComplete="organization"
            aria-invalid={errors.company ? "true" : "false"}
            {...register("company", {
              required: "Electrical company is required.",
              minLength: { value: 2, message: "At least 2 characters." },
        ...
        <div className="form-field">
          <label htmlFor="ofr-electrician-phone">Phone *</label>
          <input
            id="ofr-electrician-phone"
            type="tel"
        ...
        <div className="form-field">
          <label htmlFor="ofr-electrician-email">Email *</label>
          <input
            id="ofr-electrician-email"
            type="email"
        ...
        <div className="form-field">
          <label htmlFor="ofr-electrician-website">Current website</label>
          <input
            id="ofr-electrician-website"
        ...
        <div className="form-field">
          <label htmlFor="ofr-electrician-service-area">Service area *</label>
          <input
            id="ofr-electrician-service-area"
        ...
        <div className="form-field form-field--full">
          <label htmlFor="ofr-electrician-primary-service">
            Which work do you want more of? *
          </label>
          <select
            id="ofr-electrician-primary-service"
        ...
        <div className="form-field form-field--full">
          <label htmlFor="ofr-electrician-budget">Monthly marketing budget *</label>
          <select
            id="ofr-electrician-budget"
            className="form-select standalone-select"
            defaultValue=""
