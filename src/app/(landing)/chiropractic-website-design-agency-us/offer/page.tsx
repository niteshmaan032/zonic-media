...
import ChiropracticFaqList, { FAQS } from "./ChiropracticFaqList";
import ChiropracticLeadForm from "./ChiropracticLeadForm";
import ChiropracticOfferHeader from "./ChiropracticOfferHeader";
import ChiropracticServiceTabs from "./ChiropracticServiceTabs";
import "./offer.css";

const PAGE_PATH = "/chiropractic-website-design-agency-us/offer";
...
const breadcrumbJsonLd = buildBreadcrumbJsonLd([
  { name: "Home", url: "/" },
  { name: "Free Chiropractic Website Offer", url: PAGE_PATH },
]);

const serviceJsonLd = {
  ...buildServiceJsonLd({
    name: "Free Chiropractic Website Offer",
    description:
      "A conversion-focused chiropractic website with the upfront development fee waived for businesses on a qualifying Zonic Media marketing plan.",
    pageUrl: PAGE_PATH,
    serviceType: "Chiropractic Website Design",
...
const MARQUEE_ITEMS = [
  "Back Pain Care leads",
  "Neck Pain Care leads",
  "Sports Injuries leads",
  "Auto Accident Care leads",
  "Wellness Care leads",
  "New Patient Visits leads",
];
...
export const metadata: Metadata = {
  title: { absolute: "Free Chiropractic Website for Chiropractors | Zonic Media" },
  description:
    "Free chiropractic practice website, no upfront development fee, when you start a qualifying Zonic marketing plan. Built to rank and book jobs.",
  ...
  keywords: [
    ...
    "free website for chiropractors",
  ...
  openGraph: {
    title: "Free Chiropractic Website Offer | Zonic Media",
    description:
      "Free chiropractic practice website, no upfront development fee, when you start a qualifying Zonic marketing plan. Built to rank and book jobs.",
    url: PAGE_PATH,
    type: "website",
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Zonic Media free chiropractic website offer",
      },
    ],
  },
...
export default function ChiropracticOfferPage() {
  const marqueeItems = [...MARQUEE_ITEMS, ...MARQUEE_ITEMS];

  return (
    <div className="ofr-chiropractic" id="top">
      <script
      ...
      <main id="main-content">
        ...
        <section className="hero" aria-labelledby="hero-title">
          <div className="hero-copy">
            <div className="eyebrow">
              ...
              <span>Free website offer for chiropractic clinics</span>
              <Icon name="sparkles" />
            </div>
            ...
            <p className="hero-lede">Start a qualifying Zonic Media marketing plan and we’ll build a professional, conversion-focused website for your chiropractic clinic with no upfront development fee.</p>
            ...
            <div className="proof-row">
              ...
              <div className="proof-item proof-item--yellow">
                ...
                <span>
                  <strong>Chiropractic lead system</strong>
              ...
              <div className="proof-item proof-item--green">
                ...
                <span>
                  <strong>Patient-ready growth</strong>
                  <small>Website + clinic marketing</small>
                </span>
              </div>
          ...
          <div className="concept-stage">
            ...
            <div className="browser-card">
              <div className="browser-topbar">
                ...
                <div className="address-bar">chiropracticpros.com</div>
              ...
              <div className="design-canvas">
                <div className="canvas-copy">
                  <div className="skeleton-label">CHIROPRACTIC WEBSITE</div>
                  <h2>More patients. More care-plan starts.</h2>
                  <p>A professional chiropractic website connected to the channels that bring your best prospects.</p>
                ...
                <div className="visual-stack industry-visual-stack">
                  <Image
                    src="/images/free-website/free-chiropractic/hero.webp"
                    alt="Chiropractic professional at work"
                    fill
            ...
            <div className="phone-card">
              ...
              <div className="phone-body">
                <span className="phone-kicker">CHIROPRACTIC SITE</span>
            ...
            <div className="floating-note floating-note--bottom">
              ...
              <span>
                <strong>Built for chiropractic leads</strong>
        ...
        <section id="process" className="section process-section">
          <div className="section-heading section-heading--center">
            ...
            <p>Zonic combines the chiropractic website your business needs with recurring marketing built to reach qualified prospects in the markets you serve.</p>
          </div>
          ...
          <div className="process-grid">
            <article>
              ...
              <p>We review your care pathway mix, markets, current website, lead sources, and the channels most likely to create profitable demand.</p>
            ...
            <article>
              ...
              <p>
                Zonic creates the agreed chiropractic lead-generation website with the upfront development fee waived under your marketing engagement. Same build standard as{" "}
          ...
          <div className="section-cta-row">
            <a className="button" href="#contact">
              <span>Check my chiropractic company</span>
              <span className="button__icon">
                <Icon name="arrow-up-right" />
              </span>
            </a>
        ...
        <section id="lead-tracking" className="section leadtrack-section">
          <div className="leadtrack-copy">
            ...
            <h2>Every chiropractic lead in one place.</h2>
            <p>
              Calls, forms and chats arrive in one dashboard with the source
              attached, so you can see which chiropractic jobs your marketing produced
          ...
          <div className="leadtrack-panel">
            ...
            <div className="leadtrack-row">
              <b>
                Elena V.
                <small>Auto Accident Care</small>
              </b>
        ...
        <section id="work" className="section niche-section">
          <div className="section-heading section-heading--split">
            <div>
              <span className="section-kicker">Chiropractic website service paths</span>
              <h2>One chiropractic website. A clear path for every profitable care pathway.</h2>
            </div>
          ...
          <div className="niche-banner">
            <div className="niche-banner-copy">
              ...
              <h3>We build for every chiropractic service.</h3>
            ...
            <div className="niche-banner-tags">
              ...
              <span className="niche-banner-more">+ every chiropractic service</span>
            </div>
            <a className="section-button section-button--light" href="#contact">
              <span>Claim my chiropractic website</span>
              <i>
                <Icon name="arrow-up-right" />
              </i>
            </a>
        ...
        <section id="deliverables" className="included-section">
          <div className="section-heading section-heading--center">
            ...
            <h2>More than a chiropractic website handed over and forgotten.</h2>
            <p>Your chiropractic website is built as part of a connected marketing system, with the structure, tracking, and conversion tools needed to support recurring growth.</p>
          </div>
        ...
        <section id="pricing" className="section pricing-section">
          <div className="section-heading section-heading--split">
            <div>
              ...
              <h2>Pick the growth plan. Your Chiropractic website comes with it.</h2>
            </div>
        ...
        <section id="why" className="dark-section">
          ...
          <div className="dark-copy">
            ...
            <h2>The website is the foundation. Marketing creates demand for chiropractic practices.</h2>
            <p>Your plan is selected around your chiropractic market and may combine paid search, local visibility, Google Business Profile growth, tracking, and ongoing conversion improvements.</p>
            <a className="section-button section-button--light" href="#contact">
              <span>Check my chiropractic company</span>
              <i>
                <Icon name="arrow-up-right" />
        ...
        <section className="section terms-section">
          <div className="terms-main">
            ...
            <p>Zonic waives the upfront chiropractic website design and development fee when an eligible business starts a qualifying recurring marketing engagement. Nothing is left vague before you agree.</p>
            <a className="section-button" href="#contact">
              <span>See if my chiropractic company qualifies</span>
              <i>
                <Icon name="arrow-up-right" />
              </i>
            </a>
          ...
          <div className="terms-list">
            <div>
              ...
              <span>
                ...
                <small>The chiropractic website development fee, valued at $2,000. Your monthly plan is billed at full rate and is not discounted.</small>
              </span>
            </div>
            <div>
              <Icon name="check" />
        ...
        <section id="reviews" className="section review-section">
          ...
          <div className="section-cta-row">
            <a className="button" href="#contact">
              <span>Build my chiropractic lead system</span>
              <span className="button__icon">
                <Icon name="arrow-up-right" />
              </span>
            </a>
        ...
        <section id="faqs" className="section faq-section">
          <div className="faq-intro">
            ...
            <a className="section-button" href="#contact">
              <span>Ask about my chiropractic market</span>
              <i>
                <Icon name="arrow-up-right" />
              </i>
            </a>
        ...
        <section id="contact" className="final-cta">
          ...
          <div className="cta-content">
            ...
            <h2>Claim your professional chiropractic website with no upfront development fee.</h2>
            <p>Complete the short eligibility form. Zonic will review your chiropractic clinic, website needs, service market, and growth goals before recommending a qualifying plan.</p>
            <div className="contact-points">
              <span>
                <Icon name="check" /> Professional chiropractic lead-generation website
              </span>
              <span>
      ...
      <footer className="site-footer">
        <div className="footer-main">
          <div className="footer-brand">
            ...
            <p>Chiropractic lead-generation websites connected to the marketing services that grow chiropractic practices.</p>
          ...
          <div className="footer-nav-group">
            ...
            <a href="#work">Chiropractic services</a>
          ...
          <div className="footer-offer">
            <span>Chiropractic Website Launch Offer</span>
            <strong>$0 upfront development fee</strong>
            <p>With a qualifying marketing plan at $895/month or above on a six-month term.</p>
            <a href="#ofr-chiropractic-offer-form">
              Get my chiropractic website <Icon name="arrow-right" />
            </a>
          </div>
        </div>
        ...
        <div className="footer-bottom">
          <small>
            <strong>OFFER TERMS.</strong> Chiropractic website development fee, valued at $2,000, is
      ...
      <OfferPopupModal
        idPrefix="ofr-chiropractic"
        formType="free-chiropractic-website"
        heading="Get your chiropractic website with no upfront fee."
        serviceLabel="Chiropractic work you want more of"
        servicePlaceholder="Select a chiropractic service"
        services={[
          "Back Pain Care",
          "Neck Pain Care",
          "Sports Injuries",
