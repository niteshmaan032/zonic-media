...
/** Chiropractic revenue lines — the answer routes the follow-up conversation. */
const SERVICES = [
  "Back Pain Care",
  "Neck Pain Care",
  "Sports Injuries",
...
export default function ChiropracticLeadForm() {
  ...
  const onSubmit = async (data: FormValues) => {
    ...
    try {
      ...
      console.error("Free chiropractic website form submission failed:", error);
      setSubmitError(
  ...
  return (
    <form
      id="ofr-chiropractic-offer-form"
    ...
    >
      ...
      <div className="form-heading">
        <span>
          <Icon name="mail" /> Free chiropractic website eligibility
        </span>
      ...
      <div className="form-grid">
        <div className="form-field">
          <label htmlFor="ofr-chiropractic-full-name">Your name *</label>
          <input
            id="ofr-chiropractic-full-name"
        ...
        <div className="form-field">
          <label htmlFor="ofr-chiropractic-business-name">Clinic name *</label>
          <input
            id="ofr-chiropractic-business-name"
        ...
        <div className="form-field">
          <label htmlFor="ofr-chiropractic-phone">Phone *</label>
          <input
            id="ofr-chiropractic-phone"
            type="tel"
        ...
        <div className="form-field">
          <label htmlFor="ofr-chiropractic-email">Email *</label>
          <input
            id="ofr-chiropractic-email"
            type="email"
        ...
        <div className="form-field">
          <label htmlFor="ofr-chiropractic-website">Current website</label>
          <input
            id="ofr-chiropractic-website"
        ...
        <div className="form-field">
          <label htmlFor="ofr-chiropractic-service-area">Service area *</label>
          <input
            id="ofr-chiropractic-service-area"
        ...
        <div className="form-field form-field--full">
          <label htmlFor="ofr-chiropractic-primary-service">
            Which work do you want more of? *
          </label>
          <select
            id="ofr-chiropractic-primary-service"
        ...
        <div className="form-field form-field--full">
          <label htmlFor="ofr-chiropractic-budget">Monthly marketing budget *</label>
          <select
            id="ofr-chiropractic-budget"
            className="form-select standalone-select"
            defaultValue=""
