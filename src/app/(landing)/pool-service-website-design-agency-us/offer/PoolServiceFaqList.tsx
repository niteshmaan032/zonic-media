...
export const FAQS = [
  {
    ...
    answer:
      "The upfront pool service website design and development fee — $2,000 for a standard build — is waived when you start an eligible recurring marketing plan at $895/month or above on a six-month term. Your written proposal defines the exact page count, functionality, and revision limits before work begins.",
  },
  {
  ...
  {
    question: "What is included in the pool service website?",
    answer:
...
export default function PoolServiceFaqList() {
  return (
    <div className="faq-list">
      {FAQS.map((faq, index) => (
        <details key={faq.question} name="ofr-pool-service-faq" open={index === 0}>
          <summary>
