...
/** Pool Service revenue lines — the answer routes the follow-up conversation. */
const SERVICES = [
  "Weekly Pool Service",
  "Pool Repair",
  "Equipment Upgrades",
...
export default function PoolServiceLeadForm() {
  ...
  const onSubmit = async (data: FormValues) => {
    ...
    try {
      ...
      console.error("Free pool service website form submission failed:", error);
      setSubmitError(
  ...
  return (
    <form
      id="ofr-pool-service-offer-form"
    ...
    >
      ...
      <div className="form-heading">
        <span>
          <Icon name="mail" /> Free pool service website eligibility
        </span>
      ...
      <div className="form-grid">
        <div className="form-field">
          <label htmlFor="ofr-pool-service-full-name">Your name *</label>
          <input
            id="ofr-pool-service-full-name"
        ...
        <div className="form-field">
          <label htmlFor="ofr-pool-service-business-name">Pool company *</label>
          <input
            id="ofr-pool-service-business-name"
            placeholder="Company name"
            autoComplete="organization"
            aria-invalid={errors.company ? "true" : "false"}
            {...register("company", {
              required: "Pool company is required.",
              minLength: { value: 2, message: "At least 2 characters." },
        ...
        <div className="form-field">
          <label htmlFor="ofr-pool-service-phone">Phone *</label>
          <input
            id="ofr-pool-service-phone"
            type="tel"
        ...
        <div className="form-field">
          <label htmlFor="ofr-pool-service-email">Email *</label>
          <input
            id="ofr-pool-service-email"
            type="email"
        ...
        <div className="form-field">
          <label htmlFor="ofr-pool-service-website">Current website</label>
          <input
            id="ofr-pool-service-website"
        ...
        <div className="form-field">
          <label htmlFor="ofr-pool-service-service-area">Service area *</label>
          <input
            id="ofr-pool-service-service-area"
        ...
        <div className="form-field form-field--full">
          <label htmlFor="ofr-pool-service-primary-service">
            Which work do you want more of? *
          </label>
          <select
            id="ofr-pool-service-primary-service"
        ...
        <div className="form-field form-field--full">
          <label htmlFor="ofr-pool-service-budget">Monthly marketing budget *</label>
          <select
            id="ofr-pool-service-budget"
            className="form-select standalone-select"
            defaultValue=""
