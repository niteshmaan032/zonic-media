...
/** Home Inspector revenue lines — the answer routes the follow-up conversation. */
const SERVICES = [
  "Buyer Inspections",
...
export default function HomeInspectorLeadForm() {
  ...
  const onSubmit = async (data: FormValues) => {
    ...
    try {
      ...
      console.error("Free home inspector website form submission failed:", error);
      setSubmitError(
  ...
  return (
    <form
      id="ofr-home-inspector-offer-form"
    ...
    >
      ...
      <div className="form-heading">
        <span>
          <Icon name="mail" /> Free home inspector website eligibility
        </span>
      ...
      <div className="form-grid">
        <div className="form-field">
          <label htmlFor="ofr-home-inspector-full-name">Your name *</label>
          <input
            id="ofr-home-inspector-full-name"
        ...
        <div className="form-field">
          <label htmlFor="ofr-home-inspector-business-name">Inspection company *</label>
          <input
            id="ofr-home-inspector-business-name"
        ...
        <div className="form-field">
          <label htmlFor="ofr-home-inspector-phone">Phone *</label>
          <input
            id="ofr-home-inspector-phone"
            type="tel"
        ...
        <div className="form-field">
          <label htmlFor="ofr-home-inspector-email">Email *</label>
          <input
            id="ofr-home-inspector-email"
            type="email"
        ...
        <div className="form-field">
          <label htmlFor="ofr-home-inspector-website">Current website</label>
          <input
            id="ofr-home-inspector-website"
        ...
        <div className="form-field">
          <label htmlFor="ofr-home-inspector-service-area">Service area *</label>
          <input
            id="ofr-home-inspector-service-area"
        ...
        <div className="form-field form-field--full">
          <label htmlFor="ofr-home-inspector-primary-service">
            Which work do you want more of? *
          </label>
          <select
            id="ofr-home-inspector-primary-service"
          ...
          >
            <option value="" disabled>
              Select a home inspector service
            </option>
        ...
        <div className="form-field form-field--full">
          <label htmlFor="ofr-home-inspector-budget">Monthly marketing budget *</label>
          <select
            id="ofr-home-inspector-budget"
            className="form-select standalone-select"
            defaultValue=""
