...
export default function FreeWebsiteDesignHeader() {
  ...
  useEffect(() => {
    ...
    document.body.classList.add("fwd-menu-is-open");

    return () => {
      document.removeEventListener("keydown", closeOnEscape);
      document.body.classList.remove("fwd-menu-is-open");
    };
  }, [menuOpen]);
  ...
  return (
    <>
      <a className="fwd-skip-link" href="#main-content">
        Skip to content
      </a>
      ...
      <header className={`nav-wrap${scrolled || menuOpen ? " is-scrolled" : ""}`}>
        ...
        <a className="nav-cta" href="#contact">
          Claim my free website <Icon name="arrow-up-right" />
        </a>
