...
export default function PlumbingLeadForm() {
  ...
  const onSubmit = async (data: FormValues) => {
    ...
    try {
      ...
      console.error("Free plumbing website form submission failed:", error);
      setSubmitError(
  ...
  return (
    ...
    >
      ...
      <div className="form-heading">
        <span>
          <Icon name="mail" /> Free plumbing website eligibility
        </span>
        <h3>See If Your Plumbing Company Qualifies.</h3>
        <p>
      ...
      <div className="form-grid">
        <div className="form-field">
          <label htmlFor="pwd-full-name">Your name *</label>
          <input
            id="pwd-full-name"
        ...
        <div className="form-field">
          <label htmlFor="pwd-business-name">Plumbing company *</label>
          <input
            id="pwd-business-name"
            placeholder="Plumbing company name"
            autoComplete="organization"
            aria-invalid={errors.company ? "true" : "false"}
            {...register("company", {
              required: "Plumbing company name is required.",
              minLength: { value: 2, message: "At least 2 characters." },
        ...
        <div className="form-field">
          <label htmlFor="pwd-phone">Phone *</label>
          <input
            id="pwd-phone"
            type="tel"
        ...
        <div className="form-field">
          <label htmlFor="pwd-website">Current website</label>
          <input
            id="pwd-website"
        ...
        <div className="form-field">
          <label htmlFor="pwd-service-area">Plumbing service area *</label>
          <input
            id="pwd-service-area"
        ...
        <div className="form-field form-field--full">
          <label htmlFor="pwd-primary-service">Which plumbing work do you want more of? *</label>
          <select
            id="pwd-primary-service"
            className="form-select standalone-select"
            defaultValue=""
            aria-invalid={errors.primaryService ? "true" : "false"}
            {...register("primaryService", {
              required: "Please select your primary plumbing service.",
            })}
          >
            <option value="" disabled>
              Select a plumbing service
            </option>
        ...
        <div className="form-field form-field--full">
          <label htmlFor="pwd-budget">Monthly marketing budget *</label>
          <select
            id="pwd-budget"
            className="form-select standalone-select"
            defaultValue=""
      ...
      <p className="form-note">
        Submitting starts a conversation, not a contract. The free plumbing website requires a qualifying plan at $895/month on a 6-month term.
      </p>
