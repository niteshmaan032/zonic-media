...
export default function AutoRepairLeadForm() {
  ...
  const onSubmit = async (data: FormValues) => {
    ...
    try {
      ...
      console.error("Free auto repair website form submission failed:", error);
      setSubmitError(
  ...
  return (
    ...
    >
      ...
      <div className="form-heading">
        <span>
          <Icon name="mail" /> Free auto repair website eligibility
        </span>
      ...
      <div className="form-grid">
        <div className="form-field">
          <label htmlFor="ofr-auto-repair-full-name">Your name *</label>
          <input
            id="ofr-auto-repair-full-name"
        ...
        <div className="form-field">
          <label htmlFor="ofr-auto-repair-business-name">Auto repair shop *</label>
          <input
            id="ofr-auto-repair-business-name"
            placeholder="Shop name"
            autoComplete="organization"
            aria-invalid={errors.company ? "true" : "false"}
            {...register("company", {
              required: "Auto repair shop is required.",
              minLength: { value: 2, message: "At least 2 characters." },
        ...
        <div className="form-field">
          <label htmlFor="ofr-auto-repair-phone">Phone *</label>
          <input
            id="ofr-auto-repair-phone"
            type="tel"
        ...
        <div className="form-field">
          <label htmlFor="ofr-auto-repair-email">Email *</label>
          <input
            id="ofr-auto-repair-email"
            type="email"
        ...
        <div className="form-field">
          <label htmlFor="ofr-auto-repair-website">Current website</label>
          <input
            id="ofr-auto-repair-website"
        ...
        <div className="form-field">
          <label htmlFor="ofr-auto-repair-service-area">Service area *</label>
          <input
            id="ofr-auto-repair-service-area"
        ...
        <div className="form-field form-field--full">
          <label htmlFor="ofr-auto-repair-primary-service">
            Which work do you want more of? *
          </label>
          <select
            id="ofr-auto-repair-primary-service"
        ...
        <div className="form-field form-field--full">
          <label htmlFor="ofr-auto-repair-budget">Monthly marketing budget *</label>
          <select
            id="ofr-auto-repair-budget"
            className="form-select standalone-select"
            defaultValue=""
