...
/** HVAC revenue lines — the answer routes the follow-up conversation. */
const HVAC_SERVICES = [
  "AC Repair",
  ...
  const onSubmit = async (data: FormValues) => {
    ...
    try {
      ...
      const messageParts = [
        ...
        `Primary HVAC service: ${data.primaryService}`,
        `Current website: ${data.website || "none provided"}`,
        `HVAC service area: ${data.serviceArea}`,
      ...
      console.error("Free HVAC website form submission failed:", error);
      setSubmitError(
  ...
  return (
    ...
    >
      ...
      <div className="form-heading">
        <span>
          <Icon name="mail" /> Free HVAC website eligibility
        </span>
        <h3>See If Your HVAC Company Qualifies.</h3>
        <p>
      ...
      <div className="form-grid">
        <div className="form-field">
          <label htmlFor="hwd-full-name">Your name *</label>
          <input
            id="hwd-full-name"
        ...
        <div className="form-field">
          <label htmlFor="hwd-business-name">HVAC company *</label>
          <input
            id="hwd-business-name"
            placeholder="HVAC company name"
            autoComplete="organization"
            aria-invalid={errors.company ? "true" : "false"}
            {...register("company", {
              required: "HVAC company name is required.",
              minLength: { value: 2, message: "At least 2 characters." },
        ...
        <div className="form-field">
          <label htmlFor="hwd-phone">Phone *</label>
          <input
            id="hwd-phone"
            type="tel"
        ...
        <div className="form-field">
          <label htmlFor="hwd-email">Email *</label>
          <input
            id="hwd-email"
            type="email"
        ...
        <div className="form-field">
          <label htmlFor="hwd-website">Current website</label>
          <input
            id="hwd-website"
        ...
        <div className="form-field">
          <label htmlFor="hwd-service-area">HVAC service area *</label>
          <input
            id="hwd-service-area"
        ...
        <div className="form-field form-field--full">
          <label htmlFor="hwd-primary-service">Which HVAC work do you want more of? *</label>
          <select
            id="hwd-primary-service"
            className="form-select standalone-select"
            defaultValue=""
            aria-invalid={errors.primaryService ? "true" : "false"}
            {...register("primaryService", {
              required: "Please select your primary HVAC service.",
            })}
          >
            <option value="" disabled>
              Select an HVAC service
            </option>
        ...
        <div className="form-field form-field--full">
          <label htmlFor="hwd-budget">Monthly marketing budget *</label>
          <select
            id="hwd-budget"
            className="form-select standalone-select"
            defaultValue=""
      ...
      <p className="form-note">
        Submitting starts a conversation, not a contract. The free HVAC website requires a qualifying plan at $895/month on a 6-month term.
      </p>
