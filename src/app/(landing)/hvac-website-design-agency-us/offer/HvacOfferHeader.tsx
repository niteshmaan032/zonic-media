...
export default function HvacOfferHeader() {
  ...
  useEffect(() => {
    ...
    document.body.classList.add("hwd-menu-is-open");

    return () => {
      document.removeEventListener("keydown", closeOnEscape);
      document.body.classList.remove("hwd-menu-is-open");
    };
  }, [menuOpen]);
  ...
  return (
    <>
      <a className="hwd-skip-link" href="#main-content">
        Skip to content
      </a>
      ...
      <header className={`nav-wrap${scrolled || menuOpen ? " is-scrolled" : ""}`}>
        ...
        <a className="nav-cta" href="#contact">
          Claim my HVAC website <Icon name="arrow-up-right" />
        </a>
