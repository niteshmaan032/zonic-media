...
const ICON_PATHS = {
  ...
  // Cooling / AC tab
  snowflake:
    '<path d="M12 2v20M4.2 7 19.8 17M19.8 7 4.2 17"/><path d="m9 4 3 2 3-2M9 20l3-2 3 2M4.4 9.6l.3 3.5-3 1.6M19.6 14.4l-.3-3.5 3-1.6M4.4 14.4l.3-3.5-3-1.6M19.6 9.6l-.3 3.5 3 1.6"/>',
