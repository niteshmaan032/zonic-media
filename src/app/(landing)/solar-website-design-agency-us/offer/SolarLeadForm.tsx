...
/** Solar revenue lines — the answer routes the follow-up conversation. */
const SERVICES = [
  "Residential Solar",
  "Commercial Solar",
  "Battery Storage",
...
export default function SolarLeadForm() {
  ...
  const onSubmit = async (data: FormValues) => {
    ...
    try {
      ...
      console.error("Free solar website form submission failed:", error);
      setSubmitError(
  ...
  return (
    ...
    >
      ...
      <div className="form-heading">
        <span>
          <Icon name="mail" /> Free solar website eligibility
        </span>
      ...
      <div className="form-grid">
        <div className="form-field">
          <label htmlFor="ofr-solar-full-name">Your name *</label>
          <input
            id="ofr-solar-full-name"
        ...
        <div className="form-field">
          <label htmlFor="ofr-solar-business-name">Solar company *</label>
          <input
            id="ofr-solar-business-name"
            placeholder="Company name"
            autoComplete="organization"
            aria-invalid={errors.company ? "true" : "false"}
            {...register("company", {
              required: "Solar company is required.",
              minLength: { value: 2, message: "At least 2 characters." },
        ...
        <div className="form-field">
          <label htmlFor="ofr-solar-phone">Phone *</label>
          <input
            id="ofr-solar-phone"
            type="tel"
        ...
        <div className="form-field">
          <label htmlFor="ofr-solar-email">Email *</label>
          <input
            id="ofr-solar-email"
            type="email"
        ...
        <div className="form-field">
          <label htmlFor="ofr-solar-website">Current website</label>
          <input
            id="ofr-solar-website"
        ...
        <div className="form-field">
          <label htmlFor="ofr-solar-service-area">Service area *</label>
          <input
            id="ofr-solar-service-area"
        ...
        <div className="form-field form-field--full">
          <label htmlFor="ofr-solar-primary-service">
            Which work do you want more of? *
          </label>
          <select
            id="ofr-solar-primary-service"
        ...
        <div className="form-field form-field--full">
          <label htmlFor="ofr-solar-budget">Monthly marketing budget *</label>
          <select
            id="ofr-solar-budget"
            className="form-select standalone-select"
            defaultValue=""
