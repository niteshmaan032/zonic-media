...
const NAV_ITEMS = [
  ...
  { label: "Solar services", href: "#work" },
...
export default function SolarOfferHeader() {
  ...
  useEffect(() => {
    ...
    document.body.classList.add("ofr-solar-menu-is-open");
    return () => {
      document.removeEventListener("keydown", closeOnEscape);
      document.body.classList.remove("ofr-solar-menu-is-open");
    };
  }, [menuOpen]);
  ...
  return (
    <>
      <a className="ofr-solar-skip-link" href="#main-content">
        Skip to content
      </a>
      ...
      <header className={`nav-wrap${scrolled || menuOpen ? " is-scrolled" : ""}`}>
        ...
        <a className="nav-cta" href="#contact">
          Claim my solar website <Icon name="arrow-up-right" />
        </a>
        ...
        <button
          ...
          aria-controls="ofr-solar-mobile-menu"
