...
import PaintingContractorFaqList, { FAQS } from "./PaintingContractorFaqList";
import PaintingContractorLeadForm from "./PaintingContractorLeadForm";
import PaintingContractorOfferHeader from "./PaintingContractorOfferHeader";
import PaintingContractorServiceTabs from "./PaintingContractorServiceTabs";
import "./offer.css";

const PAGE_PATH = "/painting-contractor-website-design-agency-us/offer";
...
const breadcrumbJsonLd = buildBreadcrumbJsonLd([
  { name: "Home", url: "/" },
  { name: "Free Painting Contractor Website Offer", url: PAGE_PATH },
]);

const serviceJsonLd = {
  ...buildServiceJsonLd({
    name: "Free Painting Contractor Website Offer",
    description:
      "A conversion-focused painting contractor website with the upfront development fee waived for businesses on a qualifying Zonic Media marketing plan.",
    pageUrl: PAGE_PATH,
...
const MARQUEE_ITEMS = [
  ...
  "Deck & Fence Staining leads",
  "Color Consultation leads",
];
...
export const metadata: Metadata = {
  title: { absolute: "Free Painting Contractor Website for Painters | Zonic Media" },
  description:
    "Free painting contractor website, no upfront development fee, when you start a qualifying Zonic marketing plan. Galleries and quote flows that book paint jobs.",
  ...
  keywords: [
    ...
    "painter web design",
    "painting marketing plan",
    "house painter website",
    "painting company websites",
  ],
  alternates: { canonical: PAGE_PATH },
  openGraph: {
    title: "Free Painting Contractor Website Offer | Zonic Media",
    description:
      "Free painting contractor website, no upfront development fee, when you start a qualifying Zonic marketing plan. Galleries and quote flows that book paint jobs.",
    url: PAGE_PATH,
    type: "website",
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Zonic Media free painting contractor website offer",
      },
    ],
  },
...
export default function PaintingContractorOfferPage() {
  const marqueeItems = [...MARQUEE_ITEMS, ...MARQUEE_ITEMS];

  return (
    <div className="ofr-painting-contractor" id="top">
      <script
      ...
      <main id="main-content">
        ...
        <section className="hero" aria-labelledby="hero-title">
          <div className="hero-copy">
            <div className="eyebrow">
              ...
              <span>Free website offer for painting contractors</span>
              <Icon name="sparkles" />
            </div>
            ...
            <p className="hero-lede">Start a qualifying Zonic Media marketing plan and we’ll build a professional, conversion-focused website for your painting company with no upfront development fee.</p>
            ...
            <div className="proof-row">
              ...
              <div className="proof-item proof-item--yellow">
                ...
                <span>
                  <strong>Painting Contractor lead system</strong>
              ...
              <div className="proof-item proof-item--green">
                ...
                <span>
                  <strong>Estimate-ready growth</strong>
                  <small>Website + painting marketing</small>
                </span>
              </div>
          ...
          <div className="concept-stage">
            ...
            <div className="browser-card">
              <div className="browser-topbar">
                ...
                <div className="address-bar">paintingcontractorpros.com</div>
              ...
              <div className="design-canvas">
                <div className="canvas-copy">
                  <div className="skeleton-label">PAINTING CONTRACTOR WEBSITE</div>
                  <h2>More estimates. More painting projects.</h2>
                  <p>A professional painting contractor website connected to the channels that bring your best prospects.</p>
                ...
                <div className="visual-stack industry-visual-stack">
                  <Image
                    src="/images/free-website/free-painting-contractor/hero.webp"
                    alt="Painting Contractor professional at work"
                    fill
            ...
            <div className="phone-card">
              ...
              <div className="phone-body">
                <span className="phone-kicker">PAINTING CONTRACTOR SITE</span>
            ...
            <div className="floating-note floating-note--bottom">
              ...
              <span>
                <strong>Built for painting contractor leads</strong>
        ...
        <section id="process" className="section process-section">
          <div className="section-heading section-heading--center">
            ...
            <p>Zonic combines the painting contractor website your business needs with recurring marketing built to reach qualified prospects in the markets you serve.</p>
          </div>
          ...
          <div className="process-grid">
            <article>
              ...
              <p>We review your painting service mix, markets, current website, lead sources, and the channels most likely to create profitable demand.</p>
            ...
            <article>
              ...
              <p>
                Zonic creates the agreed painting contractor lead-generation website with the upfront development fee waived under your marketing engagement. Same build standard as{" "}
                <Link href="/services/painting-contractor-website-design" className="offer-inlink">
                  our painting contractor website design service
                </Link>
                .
              </p>
          ...
          <div className="section-cta-row">
            <a className="button" href="#contact">
              <span>Check my painting contractor company</span>
              <span className="button__icon">
                <Icon name="arrow-up-right" />
              </span>
            </a>
        ...
        <section id="lead-tracking" className="section leadtrack-section">
          <div className="leadtrack-copy">
            ...
            <h2>Every painting contractor lead in one place.</h2>
            <p>
              Calls, forms and chats arrive in one dashboard with the source
              attached, so you can see which painting contractor jobs your marketing produced
          ...
          <div className="leadtrack-panel">
            ...
            <div className="leadtrack-row">
              <b>
                Elena V.
                <small>Commercial Painting</small>
              </b>
        ...
        <section id="work" className="section niche-section">
          <div className="section-heading section-heading--split">
            <div>
              <span className="section-kicker">Painting Contractor website service paths</span>
              <h2>One painting contractor website. A clear path for every profitable painting service.</h2>
            </div>
          ...
          <div className="niche-banner">
            <div className="niche-banner-copy">
              ...
              <h3>We build for every painting contractor service.</h3>
            ...
            <div className="niche-banner-tags">
              ...
              <span className="niche-banner-more">+ every painting contractor service</span>
            </div>
            <a className="section-button section-button--light" href="#contact">
              <span>Claim my painting contractor website</span>
              <i>
                <Icon name="arrow-up-right" />
              </i>
            </a>
        ...
        <section id="deliverables" className="included-section">
          <div className="section-heading section-heading--center">
            ...
            <h2>More than a painting contractor website handed over and forgotten.</h2>
            <p>Your painting contractor website is built as part of a connected marketing system, with the structure, tracking, and conversion tools needed to support recurring growth.</p>
          </div>
        ...
        <section id="pricing" className="section pricing-section">
          <div className="section-heading section-heading--split">
            <div>
              ...
              <h2>Pick the growth plan. Your Painting Contractor website comes with it.</h2>
            </div>
        ...
        <section id="why" className="dark-section">
          ...
          <div className="dark-copy">
            ...
            <h2>The website is the foundation. Marketing creates demand for painting contractors.</h2>
            <p>Your plan is selected around your painting contractor market and may combine paid search, local visibility, Google Business Profile growth, tracking, and ongoing conversion improvements.</p>
            <a className="section-button section-button--light" href="#contact">
              <span>Check my painting contractor company</span>
              <i>
                <Icon name="arrow-up-right" />
        ...
        <section className="section terms-section">
          <div className="terms-main">
            ...
            <p>Zonic waives the upfront painting contractor website design and development fee when an eligible business starts a qualifying recurring marketing engagement. Nothing is left vague before you agree.</p>
            <a className="section-button" href="#contact">
              <span>See if my painting contractor company qualifies</span>
              <i>
                <Icon name="arrow-up-right" />
              </i>
            </a>
          ...
          <div className="terms-list">
            <div>
              ...
              <span>
                ...
                <small>The painting contractor website development fee, valued at $2,000. Your monthly plan is billed at full rate and is not discounted.</small>
              </span>
            </div>
            <div>
              <Icon name="check" />
        ...
        <section id="reviews" className="section review-section">
          ...
          <div className="section-cta-row">
            <a className="button" href="#contact">
              <span>Build my painting contractor lead system</span>
              <span className="button__icon">
                <Icon name="arrow-up-right" />
              </span>
            </a>
        ...
        <section id="faqs" className="section faq-section">
          <div className="faq-intro">
            ...
            <a className="section-button" href="#contact">
              <span>Ask about my painting contractor market</span>
              <i>
                <Icon name="arrow-up-right" />
              </i>
            </a>
        ...
        <section id="contact" className="final-cta">
          ...
          <div className="cta-content">
            ...
            <h2>Claim your professional painting contractor website with no upfront development fee.</h2>
            <p>Complete the short eligibility form. Zonic will review your painting company, website needs, service market, and growth goals before recommending a qualifying plan.</p>
            <div className="contact-points">
              <span>
                <Icon name="check" /> Professional painting contractor lead-generation website
              </span>
              <span>
      ...
      <footer className="site-footer">
        <div className="footer-main">
          <div className="footer-brand">
            ...
            <p>Painting Contractor lead-generation websites connected to the marketing services that grow painting contractors.</p>
          ...
          <div className="footer-nav-group">
            ...
            <a href="#work">Painting Contractor services</a>
          ...
          <div className="footer-offer">
            <span>Painting Contractor Website Launch Offer</span>
            <strong>$0 upfront development fee</strong>
            <p>With a qualifying marketing plan at $895/month or above on a six-month term.</p>
            <a href="#ofr-painting-contractor-offer-form">
              Get my painting contractor website <Icon name="arrow-right" />
            </a>
          </div>
        </div>
        ...
        <div className="footer-bottom">
          <small>
            <strong>OFFER TERMS.</strong> Painting Contractor website development fee, valued at $2,000, is
      ...
      <OfferPopupModal
        idPrefix="ofr-painting-contractor"
        formType="free-painting-contractor-website"
        heading="Get your painting contractor website with no upfront fee."
        serviceLabel="Painting Contractor work you want more of"
        servicePlaceholder="Select a painting contractor service"
        services={[
          "Interior Painting",
          "Exterior Painting",
          "Cabinet Painting",
