...
/** Painting Contractor revenue lines — the answer routes the follow-up conversation. */
const SERVICES = [
  "Interior Painting",
  "Exterior Painting",
  "Cabinet Painting",
...
export default function PaintingContractorLeadForm() {
  ...
  const onSubmit = async (data: FormValues) => {
    ...
    try {
      ...
      console.error("Free painting contractor website form submission failed:", error);
      setSubmitError(
  ...
  return (
    <form
      id="ofr-painting-contractor-offer-form"
    ...
    >
      ...
      <div className="form-heading">
        <span>
          <Icon name="mail" /> Free painting contractor website eligibility
        </span>
      ...
      <div className="form-grid">
        <div className="form-field">
          <label htmlFor="ofr-painting-contractor-full-name">Your name *</label>
          <input
            id="ofr-painting-contractor-full-name"
        ...
        <div className="form-field">
          <label htmlFor="ofr-painting-contractor-business-name">Painting company *</label>
          <input
            id="ofr-painting-contractor-business-name"
            placeholder="Company name"
            autoComplete="organization"
            aria-invalid={errors.company ? "true" : "false"}
            {...register("company", {
              required: "Painting company is required.",
              minLength: { value: 2, message: "At least 2 characters." },
        ...
        <div className="form-field">
          <label htmlFor="ofr-painting-contractor-phone">Phone *</label>
          <input
            id="ofr-painting-contractor-phone"
            type="tel"
        ...
        <div className="form-field">
          <label htmlFor="ofr-painting-contractor-email">Email *</label>
          <input
            id="ofr-painting-contractor-email"
            type="email"
        ...
        <div className="form-field">
          <label htmlFor="ofr-painting-contractor-website">Current website</label>
          <input
            id="ofr-painting-contractor-website"
        ...
        <div className="form-field">
          <label htmlFor="ofr-painting-contractor-service-area">Service area *</label>
          <input
            id="ofr-painting-contractor-service-area"
        ...
        <div className="form-field form-field--full">
          <label htmlFor="ofr-painting-contractor-primary-service">
            Which work do you want more of? *
          </label>
          <select
            id="ofr-painting-contractor-primary-service"
          ...
          >
            <option value="" disabled>
              Select a painting contractor service
            </option>
        ...
        <div className="form-field form-field--full">
          <label htmlFor="ofr-painting-contractor-budget">Monthly marketing budget *</label>
          <select
            id="ofr-painting-contractor-budget"
            className="form-select standalone-select"
            defaultValue=""
