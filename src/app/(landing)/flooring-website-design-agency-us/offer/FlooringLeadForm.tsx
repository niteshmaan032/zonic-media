...
/** Flooring revenue lines — the answer routes the follow-up conversation. */
const SERVICES = [
  "Hardwood Flooring",
  "Luxury Vinyl",
  "Tile Flooring",
...
export default function FlooringLeadForm() {
  ...
  const onSubmit = async (data: FormValues) => {
    ...
    try {
      ...
      console.error("Free flooring website form submission failed:", error);
      setSubmitError(
  ...
  return (
    ...
    >
      ...
      <div className="form-heading">
        <span>
          <Icon name="mail" /> Free flooring website eligibility
        </span>
      ...
      <div className="form-grid">
        <div className="form-field">
          <label htmlFor="ofr-flooring-full-name">Your name *</label>
          <input
            id="ofr-flooring-full-name"
        ...
        <div className="form-field">
          <label htmlFor="ofr-flooring-business-name">Flooring company *</label>
          <input
            id="ofr-flooring-business-name"
            placeholder="Company name"
            autoComplete="organization"
            aria-invalid={errors.company ? "true" : "false"}
            {...register("company", {
              required: "Flooring company is required.",
              minLength: { value: 2, message: "At least 2 characters." },
        ...
        <div className="form-field">
          <label htmlFor="ofr-flooring-phone">Phone *</label>
          <input
            id="ofr-flooring-phone"
            type="tel"
        ...
        <div className="form-field">
          <label htmlFor="ofr-flooring-email">Email *</label>
          <input
            id="ofr-flooring-email"
            type="email"
        ...
        <div className="form-field">
          <label htmlFor="ofr-flooring-website">Current website</label>
          <input
            id="ofr-flooring-website"
        ...
        <div className="form-field">
          <label htmlFor="ofr-flooring-service-area">Service area *</label>
          <input
            id="ofr-flooring-service-area"
        ...
        <div className="form-field form-field--full">
          <label htmlFor="ofr-flooring-primary-service">
            Which work do you want more of? *
          </label>
          <select
            id="ofr-flooring-primary-service"
        ...
        <div className="form-field form-field--full">
          <label htmlFor="ofr-flooring-budget">Monthly marketing budget *</label>
          <select
            id="ofr-flooring-budget"
            className="form-select standalone-select"
            defaultValue=""
