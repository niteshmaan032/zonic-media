...
const NAV_ITEMS = [
  ...
  { label: "Flooring services", href: "#work" },
...
export default function FlooringOfferHeader() {
  ...
  useEffect(() => {
    ...
    document.body.classList.add("ofr-flooring-menu-is-open");
    return () => {
      document.removeEventListener("keydown", closeOnEscape);
      document.body.classList.remove("ofr-flooring-menu-is-open");
    };
  }, [menuOpen]);
  ...
  return (
    <>
      <a className="ofr-flooring-skip-link" href="#main-content">
        Skip to content
      </a>
      ...
      <header className={`nav-wrap${scrolled || menuOpen ? " is-scrolled" : ""}`}>
        ...
        <a className="nav-cta" href="#contact">
          Claim my flooring website <Icon name="arrow-up-right" />
        </a>
        ...
        <button
          ...
          aria-controls="ofr-flooring-mobile-menu"
