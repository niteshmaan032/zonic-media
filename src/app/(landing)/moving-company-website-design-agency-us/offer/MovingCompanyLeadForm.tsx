...
/** Moving Company revenue lines — the answer routes the follow-up conversation. */
const SERVICES = [
  "Local Moving",
...
export default function MovingCompanyLeadForm() {
  ...
  const onSubmit = async (data: FormValues) => {
    ...
    try {
      ...
      console.error("Free moving company website form submission failed:", error);
      setSubmitError(
  ...
  return (
    <form
      id="ofr-moving-company-offer-form"
    ...
    >
      ...
      <div className="form-heading">
        <span>
          <Icon name="mail" /> Free moving company website eligibility
        </span>
      ...
      <div className="form-grid">
        <div className="form-field">
          <label htmlFor="ofr-moving-company-full-name">Your name *</label>
          <input
            id="ofr-moving-company-full-name"
        ...
        <div className="form-field">
          <label htmlFor="ofr-moving-company-business-name">Moving company *</label>
          <input
            id="ofr-moving-company-business-name"
            placeholder="Company name"
            autoComplete="organization"
            aria-invalid={errors.company ? "true" : "false"}
            {...register("company", {
              required: "Moving company is required.",
              minLength: { value: 2, message: "At least 2 characters." },
        ...
        <div className="form-field">
          <label htmlFor="ofr-moving-company-phone">Phone *</label>
          <input
            id="ofr-moving-company-phone"
            type="tel"
        ...
        <div className="form-field">
          <label htmlFor="ofr-moving-company-email">Email *</label>
          <input
            id="ofr-moving-company-email"
            type="email"
        ...
        <div className="form-field">
          <label htmlFor="ofr-moving-company-website">Current website</label>
          <input
            id="ofr-moving-company-website"
        ...
        <div className="form-field">
          <label htmlFor="ofr-moving-company-service-area">Service area *</label>
          <input
            id="ofr-moving-company-service-area"
        ...
        <div className="form-field form-field--full">
          <label htmlFor="ofr-moving-company-primary-service">
            Which work do you want more of? *
          </label>
          <select
            id="ofr-moving-company-primary-service"
          ...
          >
            <option value="" disabled>
              Select a moving company service
            </option>
        ...
        <div className="form-field form-field--full">
          <label htmlFor="ofr-moving-company-budget">Monthly marketing budget *</label>
          <select
            id="ofr-moving-company-budget"
            className="form-select standalone-select"
            defaultValue=""
